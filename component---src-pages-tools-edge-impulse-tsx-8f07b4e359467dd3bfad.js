...
var EdgeImpulseClient = /*#__PURE__*/function (_JDClient) {
  ...
  _proto.handleReport = function handleReport(row) {
    ...
    if (this.samplingState == SAMPLING) {
      var ds = this.dataSet;
      ds.addRow(row);
      this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* REPORT_RECEIVE */ "Wc"]); // debounced progress update
...
//# sourceMappingURL=component---src-pages-tools-edge-impulse-tsx-8f07b4e359467dd3bfad.js.map