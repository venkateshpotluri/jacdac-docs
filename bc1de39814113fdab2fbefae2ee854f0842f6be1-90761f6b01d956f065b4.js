...
function useReadingAuxilliaryValue(register, identifier) {
  if (identifier === void 0) {
    identifier = constants["Ue" /* SystemReg */].ReadingError | constants["Ue" /* SystemReg */].ReadingResolution | constants["Ue" /* SystemReg */].MaxReading | constants["Ue" /* SystemReg */].MinReading | constants["Ue" /* SystemReg */].StreamingInterval | constants["Ue" /* SystemReg */].StreamingPreferredInterval;
  }

  var service = register.service,
      code = register.code;
  var reading = code === constants["Ue" /* SystemReg */].Reading || code === constants["Ue" /* SystemReg */].Value;
...
function RegisterInput(props) {
  ...
  var minReading = useReadingAuxilliaryValue(register, constants["Ue" /* SystemReg */].MinReading);
  var maxReading = useReadingAuxilliaryValue(register, constants["Ue" /* SystemReg */].MaxReading);
  var readingError = useReadingAuxilliaryValue(register, constants["Ue" /* SystemReg */].ReadingError);
  var resolution = useReadingAuxilliaryValue(register, constants["Ue" /* SystemReg */].ReadingResolution);
  Object(react["useEffect"])(function () {
...
//# sourceMappingURL=bc1de39814113fdab2fbefae2ee854f0842f6be1-90761f6b01d956f065b4.js.map