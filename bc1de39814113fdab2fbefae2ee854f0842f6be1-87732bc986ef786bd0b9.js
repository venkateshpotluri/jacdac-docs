...
function useReadingAuxilliaryValue(register, identifier) {
  if (identifier === void 0) {
    identifier = constants["bf" /* SystemReg */].ReadingError | constants["bf" /* SystemReg */].ReadingResolution | constants["bf" /* SystemReg */].MaxReading | constants["bf" /* SystemReg */].MinReading | constants["bf" /* SystemReg */].StreamingInterval | constants["bf" /* SystemReg */].StreamingPreferredInterval;
  }

  var service = register.service,
      code = register.code;
  var reading = code === constants["bf" /* SystemReg */].Reading || code === constants["bf" /* SystemReg */].Value;
...
function RegisterInput(props) {
  ...
  var minReading = useReadingAuxilliaryValue(register, constants["bf" /* SystemReg */].MinReading);
  var maxReading = useReadingAuxilliaryValue(register, constants["bf" /* SystemReg */].MaxReading);
  var readingError = useReadingAuxilliaryValue(register, constants["bf" /* SystemReg */].ReadingError);
  var resolution = useReadingAuxilliaryValue(register, constants["bf" /* SystemReg */].ReadingResolution);
  Object(react["useEffect"])(function () {
...
//# sourceMappingURL=bc1de39814113fdab2fbefae2ee854f0842f6be1-87732bc986ef786bd0b9.js.map