...
function ServiceRegisters(props) {
  ...
  return /*#__PURE__*/react_default.a.createElement(AutoGrid, {
    ...
    return /*#__PURE__*/react_default.a.createElement(RegisterInput["a" /* default */], {
      ...
      showTrend: showTrends && register.code === constants["cf" /* SystemReg */].Reading
    });
  }));
}
...
function packArguments(info, args) {
  ...
  for (var i = 0; i < info.fields.length; ++argIdx, ++i) {
    ...
    var arg = typeof arg1 == "boolean" ? arg1 ? 1 : 0 : typeof arg1 == "string" ? Object(utils["Q" /* stringToUint8Array */])(Object(utils["V" /* toUTF8 */])(arg1)) : arg1;
...
//# sourceMappingURL=de590f55fa2f17e49ed8680dc5a022fe834f3017-0b89deb650e763885755.js.map