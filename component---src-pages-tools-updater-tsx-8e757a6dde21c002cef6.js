...
function useFirmwareRepos(showAllRepos) {
  ...
  var bootloaders = devices.filter(function (device) {
    return device === null || device === void 0 ? void 0 : device.hasService(constants["Bd" /* SRV_BOOTLOADER */]);
  });
  var registers = devices.filter(function (device) {
    return !(device !== null && device !== void 0 && device.hasService(constants["Bd" /* SRV_BOOTLOADER */]));
  }) // not a bootloader
  .map(function (device) {
    var _device$service;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 16:
              ...
              boot = bootloader.services({
                serviceClass: constants["Bd" /* SRV_BOOTLOADER */]
              })[0];
...
function UpdateDeviceList() {
  ...
  var devices = Object(useDevices["a" /* default */])({
    ...
    return safeBoot || !dev.hasService(constants["Bd" /* SRV_BOOTLOADER */]);
  });
...
function DeviceCard(props) {
  ...
  var services = Object(useChange["a" /* default */])(device, function () {
    return device.services().filter(function (service) {
      return service.serviceClass != constants["Id" /* SRV_CTRL */] && service.serviceClass != constants["Vd" /* SRV_LOGGER */];
    });
  });
...
//# sourceMappingURL=component---src-pages-tools-updater-tsx-8e757a6dde21c002cef6.js.map