...
function DashboardReflectedLight(props) {
  ...
  var brighessRegister = service.register(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_8__[/* ReflectedLightReg */ "id"].Brightness);

  var _useRegisterUnpackedV = Object(_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_1__[/* useRegisterUnpackedValue */ "c"])(brighessRegister, props),
      brightness = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_1__[/* useRegisterUnpackedValue */ "c"])(service.register(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_8__[/* ReflectedLightReg */ "id"].Variant), props),
  ...
  var buttonProps = Object(_hooks_useSvgButtonProps__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])("line detector", server && handleDown);
  var actualBrightness = Object(_hooks_useThrottledValue__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(brightness || 0, maxValue << 2);
  var w = 64;
  var h = 64;
  var m = 4;
  var sw = sensorVariant === _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_8__[/* ReflectedLightVariant */ "jd"].InfraredAnalog ? 32 : 16;
  var dx = w >> 1;
...
//# sourceMappingURL=121-1949f6edc48d6febd621.js.map