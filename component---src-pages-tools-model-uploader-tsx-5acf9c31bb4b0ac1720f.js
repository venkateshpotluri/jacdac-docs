...
function DeviceLostAlert(props) {
  ...
  var lost = Object(_jacdac_useEventRaised__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])([_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__[/* LOST */ "Kb"], _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__[/* FOUND */ "ob"]], device, function (dev) {
...
function getMLModelFormatName(model) {
  var map = Object(spec["D" /* serviceSpecificationFromClassIdentifier */])(constants["Od" /* SRV_MODEL_RUNNER */]).enums["ModelFormat"].members;
...
var modelrunner_ModelRunnerClient = /*#__PURE__*/function (_JDServiceClient) {
    ...
    var _isModelSupported = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee(model) {
      ...
      return regenerator_default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              reg = this.service.register(constants["ac" /* ModelRunnerReg */].Format);
              _context.next = 3;
              return reg.refresh();
  ...
  _proto.subscribeResults = function subscribeResults(handler) {
    var reg = this.service.register(constants["ac" /* ModelRunnerReg */].Outputs);
    return reg.subscribe(constants["Qc" /* REPORT_RECEIVE */], function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.service.sendCmdAwaitResponseAsync(packet["a" /* default */].jdpacked(constants["Zb" /* ModelRunnerCmd */].SetModel, "u32", [model.length]), 3000);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return this.service.register(constants["ac" /* ModelRunnerReg */].AutoInvokeEvery).sendSetPackedAsync("u16", [everySamples]);
      ...
      return regenerator_default.a.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              info = {
                "modelSize": this.getReg(constants["ac" /* ModelRunnerReg */].ModelSize, function (r) {
                  return r.intValue;
                }),
                "arenaSize": this.getReg(constants["ac" /* ModelRunnerReg */].AllocatedArenaSize, function (r) {
                  return r.intValue;
                }),
                "inputShape": this.getReg(constants["ac" /* ModelRunnerReg */].InputShape, function (r) {
                  return Object(buffer["b" /* bufferToArray */])(r.data, buffer["a" /* NumberFormat */].UInt16LE);
                }),
                "outputShape": this.getReg(constants["ac" /* ModelRunnerReg */].OutputShape, function (r) {
                  return Object(buffer["b" /* bufferToArray */])(r.data, buffer["a" /* NumberFormat */].UInt16LE);
                }),
                "lastError": this.getReg(constants["ac" /* ModelRunnerReg */].LastError, function (r) {
...
var ImportButton = /*#__PURE__*/Object(react["lazy"])(function () {
  return Promise.all(/* import() */[__webpack_require__.e(13), __webpack_require__.e(26)]).then(__webpack_require__.bind(null, "/MSm"));
});
function ModelContent(props) {
  var service = props.service;
  var modelSize = Object(useRegisterValue["c" /* useRegisterIntValue */])(service.register(constants["ac" /* ModelRunnerReg */].ModelSize));
  var lastError = Object(useRegisterValue["d" /* useRegisterStringValue */])(service.register(constants["ac" /* ModelRunnerReg */].LastError));
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, lastError && /*#__PURE__*/react_default.a.createElement(Alert["a" /* default */], {
    ...
    register: service.register(constants["ac" /* ModelRunnerReg */].AutoInvokeEvery)
  }), /*#__PURE__*/react_default.a.createElement(RegisterTrend["a" /* default */], {
    showName: true,
    register: service.register(constants["ac" /* ModelRunnerReg */].Outputs),
    mini: true
  }));
}
...
function ModelUploader() {
  ...
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement("h1", null, "Model uploader"), /*#__PURE__*/react_default.a.createElement("p", null, "Upload Machine Learning Models (like TensorFlow Lite) into your ", /*#__PURE__*/react_default.a.createElement(Link, {
    ...
    serviceClass: constants["Od" /* SRV_MODEL_RUNNER */]
    ...
    actions: function actions(service) {
      ...
      return /*#__PURE__*/react_default.a.createElement(ModelActions, {
        ...
        sensorAggregatorService: service === null || service === void 0 ? void 0 : (_service$device$servi = service.device.services({
          serviceClass: constants["ce" /* SRV_SENSOR_AGGREGATOR */]
...
//# sourceMappingURL=component---src-pages-tools-model-uploader-tsx-5acf9c31bb4b0ac1720f.js.map