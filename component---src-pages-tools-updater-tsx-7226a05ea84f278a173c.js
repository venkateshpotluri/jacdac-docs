...
function useFirmwareRepos(showAllRepos) {
  ...
  var bootloaders = devices.filter(function (device) {
    return device === null || device === void 0 ? void 0 : device.hasService(constants["wd" /* SRV_BOOTLOADER */]);
  });
  var registers = devices.filter(function (device) {
    return !(device !== null && device !== void 0 && device.hasService(constants["wd" /* SRV_BOOTLOADER */]));
  }) // not a bootloader
  .map(function (device) {
    var _device$service;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 16:
              ...
              boot = bootloader.services({
                serviceClass: constants["wd" /* SRV_BOOTLOADER */]
              })[0];
...
function UpdateDeviceList() {
  ...
  var devices = Object(useDevices["a" /* default */])({
    ...
    return safeBoot || !dev.hasService(constants["wd" /* SRV_BOOTLOADER */]);
  });
  ...
  Object(react["useEffect"])(function () {
    return bus.subscribe([constants["T" /* DEVICE_CHANGE */], constants["mb" /* FIRMWARE_BLOBS_CHANGE */]], function () {
      return scan();
    });
  }, []);
  return /*#__PURE__*/react_default.a.createElement(Grid["a" /* default */], {
...
function DeviceCard(props) {
  ...
  var services = Object(useChange["a" /* default */])(device, function () {
    return device.services().filter(function (service) {
      return service.serviceClass != constants["Dd" /* SRV_CTRL */] && service.serviceClass != constants["Qd" /* SRV_LOGGER */];
    });
  });
...
//# sourceMappingURL=component---src-pages-tools-updater-tsx-7226a05ea84f278a173c.js.map