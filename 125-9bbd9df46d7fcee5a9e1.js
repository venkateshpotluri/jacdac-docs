...
function TrendWidget(props) {
  ...
  Object(react["useEffect"])(function () {
    ...
    return register === null || register === void 0 ? void 0 : register.subscribe(constants["s" /* CHANGE */], function () {
      // register new value
...
function HostMicrophoneButton(props) {
  ...
  var enabledRegister = service.register(constants["He" /* SoundLevelReg */].Enabled);
  var enabled = Object(useRegisterValue["a" /* useRegisterBoolValue */])(enabledRegister);

  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["He" /* SoundLevelReg */].MinDecibels)),
      minDecibels = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["He" /* SoundLevelReg */].MaxDecibels)),
...
function DashboardSoundLevel(props) {
  var variant = props.variant,
      ...
      service = props.service;
  var soundLevelRegister = service.register(constants["He" /* SoundLevelReg */].SoundLevel);
...
//# sourceMappingURL=125-9bbd9df46d7fcee5a9e1.js.map