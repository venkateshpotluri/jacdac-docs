...
function Collector() {
  ...
  Object(react["useEffect"])(function () {
    ...
    var un = triggerEvent === null || triggerEvent === void 0 ? void 0 : triggerEvent.subscribe(constants["jb" /* EVENT */], function () {
  ...
  var startStreamingRegisters = function startStreamingRegisters() {
    ...
    var streamers = recordingRegisters === null || recordingRegisters === void 0 ? void 0 : recordingRegisters.map(function (reg) {
      return reg.subscribe(constants["Rc" /* REPORT_UPDATE */], function () {});
    });
    return function () {
...
//# sourceMappingURL=component---src-pages-tools-collector-tsx-c2bbed1196725827f07f.js.map