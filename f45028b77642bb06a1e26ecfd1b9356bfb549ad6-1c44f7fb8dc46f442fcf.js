...
function useRoleManager() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    return bus.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__[/* ROLE_MANAGER_CHANGE */ "ad"], function () {
...
function useServiceRole(service) {
  ...
  Object(react["useEffect"])(function () {
    return service === null || service === void 0 ? void 0 : service.subscribe(constants["Zc" /* ROLE_CHANGE */], function () {
...
var ignoreRegisters = [constants["Ze" /* SystemReg */].StatusCode, constants["Ze" /* SystemReg */].StreamingPreferredInterval, constants["Ze" /* SystemReg */].StreamingSamples, constants["Ze" /* SystemReg */].StreamingInterval];
var collapsedRegisters = [constants["Ze" /* SystemReg */].Reading, constants["Ze" /* SystemReg */].Value, constants["Ze" /* SystemReg */].Intensity];
...
var ignoredServices = [constants["Gd" /* SRV_CTRL */], constants["Td" /* SRV_LOGGER */]];
...
function DashboardButton(props) {
  ...
  Object(react["useEffect"])(function () {
    return pressedRegister === null || pressedRegister === void 0 ? void 0 : pressedRegister.subscribe(constants["Wc" /* REPORT_UPDATE */], function () {
...
function useActualAngle(service) {
  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ie" /* ServoReg */].Angle)),
      angle = _useRegisterUnpackedV[0]; // sec/60deg


  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ie" /* ServoReg */].ResponseSpeed)),
...
function DashboardServo(props) {
  var service = props.service,
      ...
      variant = props.variant;
  var enabledRegister = service.register(constants["Ie" /* ServoReg */].Enabled);
  ...
  var off = !enabled;
  var angleRegister = service.register(constants["Ie" /* ServoReg */].Angle);
  var angle = useActualAngle(service);

  var _useRegisterUnpackedV4 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ie" /* ServoReg */].Offset)),
...
function DashboardRotaryEncoder(props) {
  var service = props.service,
      services = props.services,
      variant = props.variant;
  var positionRegister = service.register(constants["od" /* RotaryEncoderReg */].Position);
  ...
  var clicksPerTurnRegister = service.register(constants["od" /* RotaryEncoderReg */].ClicksPerTurn);
...
function DashboardSwitch(props) {
  ...
  var on = Object(useRegisterValue["a" /* useRegisterBoolValue */])(service.register(constants["Ve" /* SwitchReg */].Active));

  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ve" /* SwitchReg */].Variant)),
  ...
  switch (switchVariant) {
    case constants["We" /* SwitchVariant */].PushButton:
      return /*#__PURE__*/react_default.a.createElement(ButtonWidget["a" /* default */], {
        checked: on,
        color: color,
        label: on ? "on" : "off",
...
var DashboardAccelerometer = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 108).then(__webpack_require__.bind(null, "BuIi"));
});
...
var serviceViews = (_serviceViews = {}, _serviceViews[constants["he" /* SRV_ROLE_MANAGER */]] = {
  component: DashboardRoleManager
}, _serviceViews[constants["Bd" /* SRV_BUZZER */]] = {
  component: DashboardBuzzer,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["Rd" /* SRV_LED_PIXEL */]] = {
  component: DashboardLEDPixel,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["ud" /* SRV_ACCELEROMETER */]] = {
  component: DashboardAccelerometer,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["ie" /* SRV_ROTARY_ENCODER */]] = {
  component: DashboardRotaryEncoder,
  bundled: true
}, _serviceViews[constants["Ad" /* SRV_BUTTON */]] = {
  component: DashboardButton,
  bundled: true
}, _serviceViews[constants["ke" /* SRV_SERVO */]] = {
  component: DashboardServo,
  bundled: true
}, _serviceViews[constants["te" /* SRV_SWITCH */]] = {
  component: DashboardSwitch,
  bundled: true
}, _serviceViews[constants["we" /* SRV_TRAFFIC_LIGHT */]] = {
  component: DashboardTrafficLight
}, _serviceViews[constants["Cd" /* SRV_CHARACTER_SCREEN */]] = {
  component: DashboardCharacterScreen,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["ce" /* SRV_RAIN_GAUGE */]] = {
  component: DashboardRainGauge
}, _serviceViews[constants["Qd" /* SRV_LED_MATRIX */]] = {
  component: DashboardLEDMatrix,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["wd" /* SRV_ARCADE_GAMEPAD */]] = {
  component: DashboardArcadeGamepad,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["Ce" /* SRV_WIND_DIRECTION */]] = {
  component: DashboardWindDirection
}, _serviceViews[constants["Ud" /* SRV_MATRIX_KEYPAD */]] = {
  component: DashboardMatrixKeypad
}, _serviceViews[constants["ee" /* SRV_REFLECTED_LIGHT */]] = {
  component: DashboardReflectedLight
}, _serviceViews[constants["Zd" /* SRV_POWER */]] = {
  component: DashboardPower
}, _serviceViews[constants["se" /* SRV_SPEECH_SYNTHESIS */]] = {
  component: DashboardSpeechSynthesis
}, _serviceViews[constants["ne" /* SRV_SOIL_MOISTURE */]] = {
  component: DashboardSoilMoisture
}, _serviceViews[constants["de" /* SRV_REAL_TIME_CLOCK */]] = {
  component: DashboardRealTimeClock
}, _serviceViews[constants["Pd" /* SRV_LED */]] = {
  component: DashboardLED
}, _serviceViews[constants["Od" /* SRV_JOYSTICK */]] = {
  component: DashboardJoystick
}, _serviceViews[constants["me" /* SRV_SEVEN_SEGMENT_DISPLAY */]] = {
  component: DashboardSevenSegmentDisplay
}, _serviceViews[constants["Wd" /* SRV_MOTION */]] = {
  component: DashboardMotion
}, _serviceViews[constants["Ae" /* SRV_WATER_LEVEL */]] = {
  component: DashboardWaterLevel
}, _serviceViews[constants["Dd" /* SRV_COLOR */]] = {
  component: DashboardColor,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["qe" /* SRV_SOUND_PLAYER */]] = {
  component: DashboardSoundPlayer,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["vd" /* SRV_ANALOG_BUTTON */]] = {
  component: DashboardAnalogButton
}, _serviceViews[constants["pe" /* SRV_SOUND_LEVEL */]] = {
  component: DashboardSoundLevel,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["ge" /* SRV_RNG */]] = {
  component: DashboardRandomNumberGenerator
}, _serviceViews[constants["Ed" /* SRV_COMPASS */]] = {
  component: DashboardCompass
}, _serviceViews[constants["Kd" /* SRV_GYROSCOPE */]] = {
  component: DashboardGyroscope,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["re" /* SRV_SOUND_SPECTRUM */]] = {
  component: DashboardSoundSpectrum,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["oe" /* SRV_SOLENOID */]] = {
...
function DefaultWidget(props) {
  ...
  if (register.specification.identifier == constants["Ze" /* SystemReg */].Value) {
    var intensityRegister = register.service.register(constants["Ze" /* SystemReg */].Intensity);
  ...
  if (register.specification.identifier === constants["Ze" /* SystemReg */].Intensity) return /*#__PURE__*/react_default.a.createElement(IntensityWidget, {
...
//# sourceMappingURL=f45028b77642bb06a1e26ecfd1b9356bfb549ad6-1c44f7fb8dc46f442fcf.js.map