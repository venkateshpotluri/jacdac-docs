(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[55,93],{
...
var EdgeImpulseClient = /*#__PURE__*/function (_JDClient) {
  ...
  _proto.handleMessage = function handleMessage(msg) {
    ...
    if (data.hello !== undefined) {
      ...
      if (!hello.hello) {
        this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* ERROR */ "mb"], hello.err);
        this.disconnect();
      } else {
  ...
  _proto.handleReport = function handleReport(row) {
    ...
    if (this.samplingState == SAMPLING) {
      var ds = this.dataSet;
      ds.addRow(row);
      this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* REPORT_RECEIVE */ "Zc"]); // debounced progress update

      if (timestamp - this._sample.lastProgressTimestamp > 100) {
        this._sample.lastProgressTimestamp = timestamp;
        this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* PROGRESS */ "Ec"], this.progress);
      }
      ...
      if (timestamp - this._sample.startTimestamp >= this._sample.length) {
        ...
        this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* PROGRESS */ "Ec"], this.progress); // and upload...
  ...
  _proto.handleError = function handleError(ev) {
    this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* ERROR */ "mb"], ev);
    this.reconnect();
  };
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            ...
            case 8:
              res = _context10.sent;
              _context10.next = 11;
              return Object(_jacdac_ts_src_jdom_utils__WEBPACK_IMPORTED_MODULE_37__[/* readBlobToUint8Array */ "L"])(res);
...
function Acquisition(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_7__["useEffect"])(function () {
    return client === null || client === void 0 ? void 0 : client.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* ERROR */ "mb"], function (e) {
      return setError(e);
    });
  }, [client]); // progress

  Object(react__WEBPACK_IMPORTED_MODULE_7__["useEffect"])(function () {
    return client === null || client === void 0 ? void 0 : client.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* PROGRESS */ "Ec"], function (p) {
...
function EdgeImpulse() {
  ...
  var aggregators = Object(_jacdac_useChange__WEBPACK_IMPORTED_MODULE_23__[/* default */ "a"])(bus, function (bus) {
    return bus.services({
      serviceClass: _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* SRV_SENSOR_AGGREGATOR */ "ne"]
    });
  });
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_7___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("h1", null, "Edge Impulse"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("p", null, "Use Jacdac to inject data and download models into", " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(gatsby_theme_material_ui__WEBPACK_IMPORTED_MODULE_20__["Link"], {
    ...
    serviceClass: _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* SRV_MODEL_RUNNER */ "Zd"],
...
//# sourceMappingURL=component---src-pages-tools-edge-impulse-tsx-b0d187a286a2cb6fbed4.js.map