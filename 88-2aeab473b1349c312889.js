...
function LightStripWidget(props) {
  ...
  var isJewel = lightVariant === constants["Tb" /* LedPixelVariant */].Jewel;
  var isRing = lightVariant === constants["Tb" /* LedPixelVariant */].Ring; // paint svg via dom
  ...
  Object(react["useEffect"])(function () {
    return host === null || host === void 0 ? void 0 : host.subscribe(constants["Wc" /* RENDER */], paint);
  }, [host]);
  var width;
  var height;
  var d = "";

  if (lightVariant === constants["Tb" /* LedPixelVariant */].Stick) {
    var dx = neoradius * 3;
    d = "M 0 " + dx;
    ...
    width = numPixels * dx;
    height = 2 * dx;
  } else if (lightVariant === constants["Tb" /* LedPixelVariant */].Strip) {
...
function LightWidget(props) {
  ...
  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Sb" /* LedPixelReg */].NumPixels), props),
      numPixels = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Sb" /* LedPixelReg */].Variant), props),
      lightVariant = _useRegisterUnpackedV2[0];

  var _useRegisterUnpackedV3 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Sb" /* LedPixelReg */].ActualBrightness), props),
      actualBrightness = _useRegisterUnpackedV3[0];

  var _useRegisterUnpackedV4 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Sb" /* LedPixelReg */].NumColumns), props),
  ...
  if (lightVariant === constants["Tb" /* LedPixelVariant */].Matrix) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              setSending(true);
              _context.next = 6;
              return service.sendCmdAsync(constants["Qb" /* LedPixelCmd */].Run, encoded);
...
//# sourceMappingURL=88-2aeab473b1349c312889.js.map