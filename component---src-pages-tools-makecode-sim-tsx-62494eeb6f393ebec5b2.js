...
function deviceSort(l, r) {
  ...
  return Object(utils["Q" /* strcmp */])(l.deviceId, r.deviceId);
} // hide the makecode device itself and power devices


var ignoredServices = [constants["Jd" /* SRV_CONTROL */], constants["Xd" /* SRV_LOGGER */], constants["pe" /* SRV_SETTINGS */], constants["le" /* SRV_ROLE_MANAGER */], constants["de" /* SRV_POWER */], constants["ee" /* SRV_PROTO_TEST */]];
...
function Carousel() {
  ...
  var extensions = Object(utils["Z" /* unique */])(Object(utils["f" /* arrayConcatMany */])(devices.map(function (device) {
...
//# sourceMappingURL=component---src-pages-tools-makecode-sim-tsx-62494eeb6f393ebec5b2.js.map