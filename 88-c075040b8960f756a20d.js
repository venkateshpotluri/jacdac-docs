  ...
  Object(createClass["a" /* default */])(JDBridge, [{
    ...
    set: function set(newBus) {
      if (newBus !== this._bus) {
        ...
        if (this._bus) {
          this.mount(this._bus.subscribe(constants["qc" /* PACKET_PROCESS */], this.handleSendPacket));
          this.mount(this._bus.subscribe(constants["uc" /* PACKET_SEND */], this.handleSendPacket));
...
//# sourceMappingURL=88-c075040b8960f756a20d.js.map