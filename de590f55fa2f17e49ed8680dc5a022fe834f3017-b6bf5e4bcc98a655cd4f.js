...
function ServiceRegisters(props) {
  ...
  return /*#__PURE__*/react_default.a.createElement(AutoGrid, {
    ...
    return /*#__PURE__*/react_default.a.createElement(RegisterInput["a" /* default */], {
      ...
      showTrend: showTrends && register.code === constants["We" /* SystemReg */].Reading
    });
  }));
}
...
function packArguments(info, args) {
  ...
  for (var i = 0; i < info.fields.length; ++argIdx, ++i) {
    ...
    if (dst >= constants["Bb" /* JD_SERIAL_MAX_PAYLOAD_SIZE */]) throw new Error("jacdac packet length too large, " + dst + " > " + constants["Bb" /* JD_SERIAL_MAX_PAYLOAD_SIZE */] + " bytes");
...
//# sourceMappingURL=de590f55fa2f17e49ed8680dc5a022fe834f3017-b6bf5e4bcc98a655cd4f.js.map