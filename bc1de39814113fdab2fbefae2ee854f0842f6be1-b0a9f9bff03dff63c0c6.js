...
function useReadingAuxilliaryValue(register, identifier) {
  if (identifier === void 0) {
    identifier = constants["We" /* SystemReg */].ReadingError | constants["We" /* SystemReg */].ReadingResolution | constants["We" /* SystemReg */].MaxReading | constants["We" /* SystemReg */].MinReading | constants["We" /* SystemReg */].StreamingInterval | constants["We" /* SystemReg */].StreamingPreferredInterval;
  }

  var service = register.service,
      code = register.code;
  var reading = code === constants["We" /* SystemReg */].Reading || code === constants["We" /* SystemReg */].Value;
...
function RegisterInput(props) {
  ...
  var minReading = useReadingAuxilliaryValue(register, constants["We" /* SystemReg */].MinReading);
  var maxReading = useReadingAuxilliaryValue(register, constants["We" /* SystemReg */].MaxReading);
  var readingError = useReadingAuxilliaryValue(register, constants["We" /* SystemReg */].ReadingError);
  var resolution = useReadingAuxilliaryValue(register, constants["We" /* SystemReg */].ReadingResolution);
  Object(react["useEffect"])(function () {
...
//# sourceMappingURL=bc1de39814113fdab2fbefae2ee854f0842f6be1-b0a9f9bff03dff63c0c6.js.map