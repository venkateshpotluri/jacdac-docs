...
function Collector() {
  ...
  Object(react["useEffect"])(function () {
    ...
    var un = triggerEvent === null || triggerEvent === void 0 ? void 0 : triggerEvent.subscribe(constants["mb" /* EVENT */], function () {
  ...
  var startStreamingRegisters = function startStreamingRegisters() {
    ...
    var streamers = recordingRegisters === null || recordingRegisters === void 0 ? void 0 : recordingRegisters.map(function (reg) {
      return reg.subscribe(constants["Xc" /* REPORT_UPDATE */], function () {});
    });
    return function () {
  ...
  var throttleUpdate = Object(utils["S" /* throttle */])(function () {
...
//# sourceMappingURL=component---src-pages-tools-collector-tsx-3fe84228e8936c0273de.js.map