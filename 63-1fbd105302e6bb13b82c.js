...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* binding */ DrawerSearchResults; });
...
var elasticlunr = __webpack_require__("ZhwA");
...
function useSearchIndex() {
  var _useStaticQuery = Object(gatsby_browser_entry["useStaticQuery"])("2744294623"),
      siteSearchIndex = _useStaticQuery.siteSearchIndex;

  var index = Object(react["useRef"])(elasticlunr["Index"].load(siteSearchIndex.index));
...
function useDrawerSearchResults() {
  ...
  var _useContext = Object(react["useContext"])(AppContext["c" /* default */]),
      _searchQuery = _useContext.searchQuery;

  var _useDebounce = Object(useDebounce["a" /* default */])(_searchQuery, 500),
      searchQuery = _useDebounce[0]; // debounce duplicate search


  var lastResult = Object(react["useRef"])(undefined);
  ...
  if (searchQuery && index) {
    ...
    var indexDocs = results.map(function (_ref) {
      var ref = _ref.ref;
      return index.documentStore.getDoc(ref);
    });
    nodes = indexDocs.map(function (id) {
      return {
        title: id.title,
        url: id.url
      };
...
function DrawerSearchResults() {
  ...
  return /*#__PURE__*/react_default.a.createElement(List["a" /* default */], null, !results.length && /*#__PURE__*/react_default.a.createElement(ListItem["a" /* default */], null, /*#__PURE__*/react_default.a.createElement(Alert["a" /* default */], {
    severity: "info"
  }, "no results found")), results.map(function (result) {
    return /*#__PURE__*/react_default.a.createElement(gatsby_theme_material_ui["Link"], {
      key: 'search' + result.url,
      to: result.url,
      "aria-label": result.title
    }, /*#__PURE__*/react_default.a.createElement(ListItem["a" /* default */], null, /*#__PURE__*/react_default.a.createElement(ListItemText["a" /* default */], {
...
//# sourceMappingURL=63-1fbd105302e6bb13b82c.js.map