...
var raingaugeservicehost_RainGaugeServiceHost = /*#__PURE__*/function (_AnalogSensorServiceH) {
  ...
  function RainGaugeServiceHost(options) {
    ...
    _this.precipitationPrecision = _this.addRegister(constants["cd" /* RainGaugeReg */].PrecipitationPrecision, [bucketSize || 0.2794]);
    _this._level = 0;
    return _this;
  }
...
var reflectedlightservicehost_ReflectedLightServiceHost = /*#__PURE__*/function (_AnalogSensorServiceH) {
  ...
  function ReflectedLightServiceHost(options) {
    ...
    _this.variant = _this.addRegister(constants["gd" /* ReflectedLightReg */].Variant, [variant || constants["hd" /* ReflectedLightVariant */].InfraredDigital]);
    return _this;
  }
...
var randomnumbergeneratorservicehost_RandomNumberGeneratorServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function RandomNumberGeneratorServiceHost() {
    ...
    _this = _SensorServiceHost.call(this, constants["he" /* SRV_RNG */], {
      variant: constants["ld" /* RngVariant */].WebCrypto,
...
var _hosts = [{
  ...
  services: function services() {
    return [new reflectedlightservicehost_ReflectedLightServiceHost({
      variant: constants["hd" /* ReflectedLightVariant */].InfraredAnalog
    })];
  }
}, {
  ...
  services: function services() {
    return [new servicehost["a" /* default */](constants["ge" /* SRV_RELAY */], {
      intensityValues: [false],
      variant: constants["jd" /* RelayVariant */].Electromechanical,
      registerValues: [{
        code: constants["id" /* RelayReg */].MaxSwitchingCurrent,
        values: [10]
      }]
    })];
  }
  ...
  services: function services() {
    return Array(4).fill(0).map(function () {
      return new servicehost["a" /* default */](constants["ge" /* SRV_RELAY */], {
        intensityValues: [false],
        variant: constants["jd" /* RelayVariant */].SolidState,
        registerValues: [{
          code: constants["id" /* RelayReg */].MaxSwitchingCurrent,
          values: [5]
        }]
