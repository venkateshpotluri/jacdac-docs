...
function AzureDeviceTwinDesigner() {
  ...
  var handleAddService = function handleAddService(service) {
    ...
    twin.components.push({
      name: Object(_jacdac_ts_src_jdom_utils__WEBPACK_IMPORTED_MODULE_3__[/* uniqueName */ "Z"])(names, service.shortId),
      service: service
    });
    update();
  };
...
//# sourceMappingURL=component---src-pages-tools-azure-device-twin-designer-tsx-ffc8b9e9a2fb28414f6d.js.map