...
var ProtocolTestServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function ProtocolTestServiceHost() {
    ...
    _this = _ServiceHost.call(this, _jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* SRV_PROTO_TEST */ "Xd"]) || this;
...
var LEDMatrixServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function LEDMatrixServiceHost(columns, rows) {
    ...
    _this = _ServiceHost.call(this, _jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* SRV_LED_MATRIX */ "Nd"], {
    ...
    _this.addRegister(_jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* SensorReg */ "Ee"].StreamingPreferredInterval, [50]);
...
var LEDServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function LEDServiceHost(options) {
    ...
    _this2 = _ServiceHost.call(this, _jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* SRV_LED */ "Md"]) || this;
...
var BuzzerServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function BuzzerServiceHost() {
    ...
    _this = _ServiceHost.call(this, _jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* SRV_BUZZER */ "yd"]) || this;
...
var buttonservicehost_ButtonServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function ButtonServiceHost(instanceName) {
    ...
    _this = _SensorServiceHost.call(this, constants["xd" /* SRV_BUTTON */], {
...
var characterscreenservicehost_CharacterScreenServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function CharacterScreenServiceHost(options) {
    ...
    _this = _ServiceHost.call(this, constants["zd" /* SRV_CHARACTER_SCREEN */]) || this;
...
var humidityservicehost_HumidityServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function HumidityServiceHost() {
    return _SensorServiceHost.call(this, constants["Jd" /* SRV_HUMIDITY */], {
      readingValues: [40],
      readingError: [0.1],
...
var joystickservicehost_JoystickSensorServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function JoystickSensorServiceHost(variant, digital) {
    ...
    _this = _SensorServiceHost.call(this, constants["Ld" /* SRV_JOYSTICK */], {
      readingValues: [0, 0]
    }) || this;
...
var ledpixelservicehost_LedPixelServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function LedPixelServiceHost(options) {
    ...
    _this = _ServiceHost.call(this, constants["Od" /* SRV_LED_PIXEL */], options) || this;
...
var matrixkeypadservicehost_MatrixKeypadServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function MatrixKeypadServiceHost(columns, rows, labels) {
    ...
    _this = _SensorServiceHost.call(this, constants["Rd" /* SRV_MATRIX_KEYPAD */], {
      readingValues: [[]]
    }) || this;
    _this.columns = _this.addRegister(constants["ac" /* MatrixKeypadReg */].Columns, [columns]);
    _this.rows = _this.addRegister(constants["ac" /* MatrixKeypadReg */].Rows, [rows]);
    _this.labels = _this.addRegister(constants["ac" /* MatrixKeypadReg */].Labels, labels ? [labels.map(function (l) {
      return [l];
    })] : undefined);
    return _this;
  }
...
var motorservicehost_MotorServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function MotorServiceHost(instanceName) {
    ...
    _this = _ServiceHost.call(this, constants["Ud" /* SRV_MOTOR */], {
      instanceName: instanceName
    }) || this;
    _this.duty = _this.addRegister(constants["ec" /* MotorReg */].Duty, [0]);
    _this.enabled = _this.addRegister(constants["ec" /* MotorReg */].Enabled, [false]);
    _this.loadTorque = _this.addRegister(constants["ec" /* MotorReg */].LoadTorque);
    _this.loadSpeed = _this.addRegister(constants["ec" /* MotorReg */].LoadSpeed);
    return _this;
  }
...
var leveldetector_LevelDetector = /*#__PURE__*/function (_JDClient) {
  ...
  _proto.reset = function reset() {
    this._state = constants["Ve" /* SystemReadingThreshold */].Neutral;
  };
  ...
  _proto.update = function update() {
    ...
    if (level === undefined) {
      this.setState(constants["Ve" /* SystemReadingThreshold */].Neutral);
      return;
    }
    ...
    if (high !== undefined && level >= high) {
      this.setState(constants["Ve" /* SystemReadingThreshold */].High);
      return;
    }
    ...
    if (low !== undefined && level <= low) {
      this.setState(constants["Ve" /* SystemReadingThreshold */].Low);
      return;
    } // neutral
  ...
  _proto.setState = function setState(state) {
    ...
    switch (state) {
      case constants["Ve" /* SystemReadingThreshold */].High:
        this.service.sendEvent(constants["Ue" /* SystemEvent */].High);
        break;

      case constants["Ve" /* SystemReadingThreshold */].Low:
        this.service.sendEvent(constants["Ue" /* SystemEvent */].Low);
        break;

      case constants["Ve" /* SystemReadingThreshold */].Neutral:
        this.service.sendEvent(constants["Ue" /* SystemEvent */].Neutral);
        break;
    }
  };
...
var analogsensorservicehost_AnalogSensorServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function AnalogSensorServiceHost(serviceClass, options) {
    ...
    if (minReading !== undefined) _this.addRegister(constants["We" /* SystemReg */].MinReading, [minReading]);
    if (maxReading !== undefined) _this.addRegister(constants["We" /* SystemReg */].MaxReading, [maxReading]);
    if (readingResolution !== undefined) _this.addRegister(constants["We" /* SystemReg */].ReadingResolution, [readingResolution]);

    if (lowThreshold !== undefined || _this.highThreshold !== undefined) {
      if (lowThreshold !== undefined) _this.lowThreshold = _this.addRegister(constants["We" /* SystemReg */].LowThreshold, [lowThreshold]);
      if (highThreshold !== undefined) _this.highThreshold = _this.addRegister(constants["We" /* SystemReg */].HighThreshold, [highThreshold]);
...
var raingaugeservicehost_RainGaugeServiceHost = /*#__PURE__*/function (_AnalogSensorServiceH) {
  ...
  function RainGaugeServiceHost(options) {
    ...
    _this = _AnalogSensorServiceH.call(this, constants["Zd" /* SRV_RAIN_GAUGE */], {
      readingValues: [0]
    }) || this;
    _this._tiltCount = 0;
    _this._level = 0;
    ...
    _this.precipitationPrecision = _this.addRegister(constants["Yc" /* RainGaugeReg */].PrecipitationPrecision, [bucketSize || 0.2794]);
    _this._level = 0;
    return _this;
  }
...
var reflectedlightservicehost_ReflectedLightServiceHost = /*#__PURE__*/function (_AnalogSensorServiceH) {
  ...
  function ReflectedLightServiceHost(options) {
    ...
    _this = _AnalogSensorServiceH.call(this, constants["be" /* SRV_REFLECTED_LIGHT */], {
      readingValues: [0]
    }) || this;
    ...
    _this.variant = _this.addRegister(constants["cd" /* ReflectedLightReg */].Variant, [variant || constants["dd" /* ReflectedLightVariant */].InfraredDigital]);
    return _this;
  }
...
var rotaryencoderservicehost_RotaryEncoderServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function RotaryEncoderServiceHost() {
    ...
    _this = _SensorServiceHost.call(this, constants["fe" /* SRV_ROTARY_ENCODER */], {
      readingValues: [0],
      streamingInterval: 50
    }) || this;
    _this.clicksPerTurn = _this.addRegister(constants["ld" /* RotaryEncoderReg */].ClicksPerTurn, [12]);
    return _this;
  }
...
var servoservicehost_ServoServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function ServoServiceHost(options) {
    ...
    _this = _ServiceHost.call(this, constants["he" /* SRV_SERVO */], options) || this;
    ...
    _this.angle = _this.addRegister(constants["Fe" /* ServoReg */].Angle, [0]);
    _this.enabled = _this.addRegister(constants["Fe" /* ServoReg */].Enabled, [false]);
    _this.minAngle = _this.addRegister(constants["Fe" /* ServoReg */].MinAngle, minAngle !== undefined ? [minAngle] : undefined);
    _this.maxAngle = _this.addRegister(constants["Fe" /* ServoReg */].MaxAngle, maxAngle !== undefined ? [maxAngle] : undefined);
    _this.offset = _this.addRegister(constants["Fe" /* ServoReg */].Offset, [0]);
    _this.responseSpeed = _this.addRegister(constants["Fe" /* ServoReg */].ResponseSpeed, responseSpeed !== undefined ? [responseSpeed] : undefined);
    _this.stallTorque = _this.addRegister(constants["Fe" /* ServoReg */].StallTorque, stallTorque !== undefined ? [stallTorque] : undefined);
    return _this;
  }
...
var settingsservicehost_SettingsServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function SettingsServiceHost(storageKey) {
    ...
    _this = _ServiceHost.call(this, constants["ie" /* SRV_SETTINGS */]) || this;
    _this.storageKey = storageKey;

    _this.addCommand(constants["Ge" /* SettingsCmd */].Get, _this.handleGet.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Ge" /* SettingsCmd */].Set, _this.handleSet.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Ge" /* SettingsCmd */].Delete, _this.handleDelete.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Ge" /* SettingsCmd */].ListKeys, _this.handleListKeys.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Ge" /* SettingsCmd */].List, _this.handleList.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Ge" /* SettingsCmd */].Clear, _this.handleClear.bind(Object(assertThisInitialized["a" /* default */])(_this)));
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              resp = packet["a" /* default */].jdpacked(constants["Ge" /* SettingsCmd */].Get, "z b", [key, payload]);
              _context.next = 5;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 3;
              return this.sendEvent(constants["He" /* SettingsEvent */].Change);
...
var speechsynthesisservicehost_SpeechSynthesisServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function SpeechSynthesisServiceHost() {
    ...
    _this = _ServiceHost.call(this, constants["pe" /* SRV_SPEECH_SYNTHESIS */]) || this;
    _this.synthesis = typeof window !== "undefined" && window.speechSynthesis;
    _this.enabled = _this.addRegister(constants["Qe" /* SpeechSynthesisReg */].Enabled, [!((_this$synthesis = _this.synthesis) !== null && _this$synthesis !== void 0 && _this$synthesis.paused)]);
    _this.pitch = _this.addRegister(constants["Qe" /* SpeechSynthesisReg */].Pitch, [1]);
    _this.rate = _this.addRegister(constants["Qe" /* SpeechSynthesisReg */].Rate, [1]);
    _this.lang = _this.addRegister(constants["Qe" /* SpeechSynthesisReg */].Lang, [""]);
    _this.volume = _this.addRegister(constants["Qe" /* SpeechSynthesisReg */].Volume, [0.5]);

    _this.addCommand(constants["Pe" /* SpeechSynthesisCmd */].Speak, _this.handleSpeak.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Pe" /* SpeechSynthesisCmd */].Cancel, _this.handleCancel.bind(Object(assertThisInitialized["a" /* default */])(_this)));
...
var switchservicehost_SwitchServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function SwitchServiceHost(options) {
    ...
    _this = _SensorServiceHost.call(this, constants["qe" /* SRV_SWITCH */], {
      readingValues: [false],
      streamingInterval: 50
    }) || this;
    ...
    _this.variant = _this.addRegister(constants["Se" /* SwitchReg */].Variant, variant !== undefined ? [variant] : undefined);
    _this.autoOffDelay = _this.addRegister(constants["Se" /* SwitchReg */].AutoOffDelay, autoOffDelay !== undefined ? [autoOffDelay] : undefined);
    return _this;
  }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              this.reading.setValues([true]);
              _context2.next = 5;
              return this.sendEvent(constants["Re" /* SwitchEvent */].On);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              this.reading.setValues([false]);
              _context3.next = 5;
              return this.sendEvent(constants["Re" /* SwitchEvent */].Off);
...
var trafficlightservicehost_TrafficLightServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function TrafficLightServiceHost() {
    ...
    _this = _ServiceHost.call(this, constants["te" /* SRV_TRAFFIC_LIGHT */]) || this;
    _this.red = _this.addRegister(constants["df" /* TrafficLightReg */].Red, [true]);
    _this.orange = _this.addRegister(constants["df" /* TrafficLightReg */].Orange, [false]);
    _this.green = _this.addRegister(constants["df" /* TrafficLightReg */].Green, [false]);
    return _this;
  }
...
var soundplayerservicehost_SoundPlayerServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function SoundPlayerServiceHost(sounds) {
    ...
    _this = _ServiceHost.call(this, constants["ne" /* SRV_SOUND_PLAYER */]) || this;
    _this.sounds = sounds;
    _this.volume = _this.addRegister(constants["Ne" /* SoundPlayerReg */].Volume, [0.5]);

    _this.addCommand(constants["Me" /* SoundPlayerCmd */].ListSounds, _this.handleListSounds.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Me" /* SoundPlayerCmd */].Play, _this.handlePlay.bind(Object(assertThisInitialized["a" /* default */])(_this)));
...
var randomnumbergeneratorservicehost_RandomNumberGeneratorServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function RandomNumberGeneratorServiceHost() {
    ...
    _this = _SensorServiceHost.call(this, constants["de" /* SRV_RNG */], {
      variant: constants["hd" /* RngVariant */].WebCrypto,
...
var compassservicehost_CompassServiceHost = /*#__PURE__*/function (_AnalogSensorServiceH) {
  ...
  function CompassServiceHost() {
    ...
    _this = _AnalogSensorServiceH.call(this, constants["Bd" /* SRV_COMPASS */], {
      readingValues: [0],
      minReading: 0,
      maxReading: 360,
      readingError: [1]
    ...
    _this.enabled.on(constants["s" /* CHANGE */], function () {
      ...
      if (status === constants["Xe" /* SystemStatusCodes */].CalibrationNeeded) {
...
var dmxservicehost_DMXServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function DMXServiceHost() {
    ...
    _this = _ServiceHost.call(this, constants["Fd" /* SRV_DMX */], {
      intensityValues: [0]
    }) || this;
...
var bitradioservicehost_BitRadioServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function BitRadioServiceHost() {
    ...
    _this = _ServiceHost.call(this, constants["vd" /* SRV_BIT_RADIO */]) || this;
...
var indoorThermometerOptions = {
  ...
  maxReading: 50,
  readingError: [0.25],
  variant: constants["cf" /* ThermometerVariant */].Indoor
};
var outdoorThermometerOptions = {
  ...
  maxReading: 120,
  readingError: [0.25],
  variant: constants["cf" /* ThermometerVariant */].Outdoor
};
var medicalThermometerOptions = {
  ...
  maxReading: 42,
  readingError: [0.5],
  variant: constants["cf" /* ThermometerVariant */].Body
};
...
var windSpeedOptions = {
  ...
  readingError: [0.5],
  registerValues: [{
    code: constants["jf" /* WindSpeedReg */].MaxWindSpeed,
    values: [55]
  }]
};
var eCO2Options = {
...
var soundLevel = {
  ...
  registerValues: [{
    code: constants["Le" /* SoundLevelReg */].MinDecibels,
    values: [-100]
  }, {
    code: constants["Le" /* SoundLevelReg */].MaxDecibels,
    values: [-30]
  }]
};
var soundSpectrum = {
  ...
  intensityValues: [false],
  registerValues: [{
    code: constants["Oe" /* SoundSpectrumReg */].FftPow2Size,
    values: [5]
  }, {
    code: constants["Oe" /* SoundSpectrumReg */].MinDecibels,
    values: [-100]
  }, {
    code: constants["Oe" /* SoundSpectrumReg */].MaxDecibels,
    values: [-30]
  }, {
    code: constants["Oe" /* SoundSpectrumReg */].SmoothingTimeConstant,
    values: [0.8]
  }]
};
var _hosts = [{
  name: "7-segment (4 segments)",
  serviceClasses: [constants["je" /* SRV_SEVEN_SEGMENT_DISPLAY */]],
  services: function services() {
    return [new servicehost["a" /* default */](constants["je" /* SRV_SEVEN_SEGMENT_DISPLAY */], {
      intensityValues: [0xffff],
      valueValues: [Object(utils["u" /* fromHex */])("ff112233")],
      registerValues: [{
        code: constants["Ie" /* SevenSegmentDisplayReg */].DigitCount,
        values: [4]
      }, {
        code: constants["Ie" /* SevenSegmentDisplayReg */].DecimalPoint,
        values: [true]
      }]
    })];
  }
  ...
  name: "accelerometer",
  serviceClasses: [constants["rd" /* SRV_ACCELEROMETER */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["rd" /* SRV_ACCELEROMETER */], {
      readingValues: [0.5, 0.5, -(1 - (0.5 * 0.5 + 0.5 * 0.5))]
    })];
  }
}, {
  name: "arcade gamepad (all buttons)",
  serviceClasses: [constants["td" /* SRV_ARCADE_GAMEPAD */]],
  services: function services() {
  ...
  name: "barometer",
  serviceClasses: [constants["ud" /* SRV_BAROMETER */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ud" /* SRV_BAROMETER */], barometerOptions)];
  }
}, {
  name: "bitradio",
  serviceClasses: [constants["vd" /* SRV_BIT_RADIO */]],
  services: function services() {
    return [new bitradioservicehost_BitRadioServiceHost()];
  }
}, {
  name: "button",
  serviceClasses: [constants["xd" /* SRV_BUTTON */]],
  services: function services() {
  ...
  name: "buzzer",
  serviceClasses: [constants["yd" /* SRV_BUZZER */]],
  services: function services() {
    return [new buzzerservicehost["a" /* default */]()];
  }
}, {
  name: "capacitive button",
  serviceClasses: [constants["sd" /* SRV_ANALOG_BUTTON */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["sd" /* SRV_ANALOG_BUTTON */], touchButton)];
  }
}, {
  ...
  services: function services() {
    return Array(6).fill(0).map(function (_, i) {
      return new analogsensorservicehost_AnalogSensorServiceHost(constants["sd" /* SRV_ANALOG_BUTTON */], _objectSpread(_objectSpread({}, touchButton), {
        instanceName: "C" + i
      }));
    });
  }
  ...
  serviceClasses: [constants["zd" /* SRV_CHARACTER_SCREEN */]],
  services: function services() {
  ...
  name: "color",
  serviceClasses: [constants["Ad" /* SRV_COLOR */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Ad" /* SRV_COLOR */], {
      readingValues: [0.5, 0, 0.5]
    })];
  }
}, {
  name: "compass",
  serviceClasses: [constants["Bd" /* SRV_COMPASS */]],
  services: function services() {
    return [new compassservicehost_CompassServiceHost()];
  }
}, {
  name: "distance (sonar)",
  serviceClasses: [constants["Ed" /* SRV_DISTANCE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Ed" /* SRV_DISTANCE */], sonarOptions)];
  }
}, {
  name: "DMX",
  serviceClasses: [constants["Fd" /* SRV_DMX */]],
  services: function services() {
    return [new dmxservicehost_DMXServiceHost()];
  }
}, {
  name: "eCO₂",
  serviceClasses: [constants["Gd" /* SRV_E_CO2 */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Gd" /* SRV_E_CO2 */], eCO2Options)];
  }
}, {
  name: "eCO₂ + TVOC",
  serviceClasses: [constants["Gd" /* SRV_E_CO2 */], constants["ue" /* SRV_TVOC */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Gd" /* SRV_E_CO2 */], eCO2Options), new analogsensorservicehost_AnalogSensorServiceHost(constants["ue" /* SRV_TVOC */], tvocOptions)];
  }
}, {
  name: "eCO₂ + humidity + thermometer",
  serviceClasses: [constants["Gd" /* SRV_E_CO2 */], constants["Jd" /* SRV_HUMIDITY */], constants["se" /* SRV_THERMOMETER */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Gd" /* SRV_E_CO2 */], CO2Options), new humidityservicehost_HumidityServiceHost(), new analogsensorservicehost_AnalogSensorServiceHost(constants["se" /* SRV_THERMOMETER */], indoorThermometerOptions)];
  }
}, {
  name: "gyroscope",
  serviceClasses: [constants["Hd" /* SRV_GYROSCOPE */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Hd" /* SRV_GYROSCOPE */], {
      readingValues: [0, 0, 0]
    })];
  }
}, {
  name: "heart rate",
  serviceClasses: [constants["Id" /* SRV_HEART_RATE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Id" /* SRV_HEART_RATE */], {
      readingValues: [80],
  ...
  name: "humidity",
  serviceClasses: [constants["Jd" /* SRV_HUMIDITY */]],
  services: function services() {
    return [new humidityservicehost_HumidityServiceHost()];
  }
}, {
  name: "humidity + temperature",
  serviceClasses: [constants["Jd" /* SRV_HUMIDITY */], constants["se" /* SRV_THERMOMETER */]],
  services: function services() {
    return [new humidityservicehost_HumidityServiceHost(), new analogsensorservicehost_AnalogSensorServiceHost(constants["se" /* SRV_THERMOMETER */], outdoorThermometerOptions)];
  }
}, {
  name: "humidity + temperature + barometer",
  serviceClasses: [constants["Jd" /* SRV_HUMIDITY */], constants["se" /* SRV_THERMOMETER */], constants["ud" /* SRV_BAROMETER */]],
  services: function services() {
    return [new humidityservicehost_HumidityServiceHost(), new analogsensorservicehost_AnalogSensorServiceHost(constants["se" /* SRV_THERMOMETER */], outdoorThermometerOptions), new analogsensorservicehost_AnalogSensorServiceHost(constants["ud" /* SRV_BAROMETER */], barometerOptions)];
  }
}, {
  name: "illuminance",
  serviceClasses: [constants["Kd" /* SRV_ILLUMINANCE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Kd" /* SRV_ILLUMINANCE */], {
      readingValues: [1]
    })];
  }
}, {
  name: "joystick (thumbstick)",
  serviceClasses: [constants["Ld" /* SRV_JOYSTICK */]],
  services: function services() {
  ...
  serviceClasses: [constants["Md" /* SRV_LED */]],
  services: function services() {
  ...
  serviceClasses: [constants["Nd" /* SRV_LED_MATRIX */]],
  services: function services() {
  ...
  serviceClasses: [constants["Od" /* SRV_LED_PIXEL */]],
  services: function services() {
  ...
  serviceClasses: [constants["Pd" /* SRV_LIGHT_LEVEL */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Pd" /* SRV_LIGHT_LEVEL */], {
      readingValues: [0.5],
  ...
  serviceClasses: [constants["be" /* SRV_REFLECTED_LIGHT */]],
  services: function services() {
  ...
  services: function services() {
    return [new reflectedlightservicehost_ReflectedLightServiceHost({
      variant: constants["dd" /* ReflectedLightVariant */].InfraredAnalog
    })];
  }
}, {
  name: "matrix keypad (3x4)",
  serviceClasses: [constants["Rd" /* SRV_MATRIX_KEYPAD */]],
  services: function services() {
  ...
  name: "motion",
  serviceClasses: [constants["Td" /* SRV_MOTION */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Td" /* SRV_MOTION */], {
      readingValues: [false]
    })];
  }
}, {
  name: "motor",
  serviceClasses: [constants["Ud" /* SRV_MOTOR */]],
  services: function services() {
    return [new motorservicehost_MotorServiceHost()];
  }
}, {
  name: "protocol test",
  serviceClasses: [constants["Xd" /* SRV_PROTO_TEST */]],
  services: function services() {
    return [new protocoltestservicehost["a" /* default */]()];
  }
}, {
  name: "pulse oxymeter",
  serviceClasses: [constants["Yd" /* SRV_PULSE_OXIMETER */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Yd" /* SRV_PULSE_OXIMETER */], {
      readingValues: [98]
    })];
  }
}, {
  name: "oxymeter + heart beat",
  serviceClasses: [constants["Yd" /* SRV_PULSE_OXIMETER */], constants["Id" /* SRV_HEART_RATE */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Yd" /* SRV_PULSE_OXIMETER */], {
      readingValues: [98]
    }), new analogsensorservicehost_AnalogSensorServiceHost(constants["Id" /* SRV_HEART_RATE */], {
      readingValues: [80],
      variant: constants["rb" /* HeartRateVariant */].Finger
    })];
  }
  ...
  serviceClasses: [constants["de" /* SRV_RNG */]],
  services: function services() {
    return [new randomnumbergeneratorservicehost_RandomNumberGeneratorServiceHost()];
  }
}, {
  name: "rain gauge",
  serviceClasses: [constants["Zd" /* SRV_RAIN_GAUGE */]],
  services: function services() {
    return [new raingaugeservicehost_RainGaugeServiceHost()];
  }
}, {
  name: "real time clock",
  serviceClasses: [constants["ae" /* SRV_REAL_TIME_CLOCK */]],
  services: function services() {
    return [new realtimeclockservicehost["a" /* default */]()];
  }
}, {
  name: "relay (EM/10A)",
  serviceClasses: [constants["ce" /* SRV_RELAY */]],
  services: function services() {
    return [new servicehost["a" /* default */](constants["ce" /* SRV_RELAY */], {
      intensityValues: [false],
      variant: constants["fd" /* RelayVariant */].Electromechanical,
      registerValues: [{
        code: constants["ed" /* RelayReg */].MaxSwitchingCurrent,
        values: [10]
      }]
    })];
  }
  ...
  services: function services() {
    return Array(4).fill(0).map(function () {
      return new servicehost["a" /* default */](constants["ce" /* SRV_RELAY */], {
        intensityValues: [false],
        variant: constants["fd" /* RelayVariant */].SolidState,
        registerValues: [{
          code: constants["ed" /* RelayReg */].MaxSwitchingCurrent,
          values: [5]
        }]
  ...
  name: "rotary encoder",
  serviceClasses: [constants["fe" /* SRV_ROTARY_ENCODER */]],
  services: function services() {
    return [new rotaryencoderservicehost_RotaryEncoderServiceHost()];
  }
}, {
  name: "rotary encoder + button",
  serviceClasses: [constants["fe" /* SRV_ROTARY_ENCODER */], constants["xd" /* SRV_BUTTON */]],
  services: function services() {
  ...
  serviceClasses: [constants["Vd" /* SRV_POTENTIOMETER */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Vd" /* SRV_POTENTIOMETER */], {
  ...
  name: "servo",
  serviceClasses: [constants["he" /* SRV_SERVO */]],
  services: function services() {
  ...
  name: "settings",
  serviceClasses: [constants["ie" /* SRV_SETTINGS */]],
  services: function services() {
  ...
  name: "soil moisture",
  serviceClasses: [constants["ke" /* SRV_SOIL_MOISTURE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ke" /* SRV_SOIL_MOISTURE */], {
      readingValues: [0.5]
    })];
  }
}, {
  name: "speech synthesis",
  serviceClasses: [constants["pe" /* SRV_SPEECH_SYNTHESIS */]],
  services: function services() {
    return [new speechsynthesisservicehost_SpeechSynthesisServiceHost()];
  }
}, {
  name: "solenoid",
  serviceClasses: [constants["le" /* SRV_SOLENOID */]],
  services: function services() {
    return [new servicehost["a" /* default */](constants["le" /* SRV_SOLENOID */], {
      intensityValues: [0]
    })];
  }
}, {
  name: "sound level",
  serviceClasses: [constants["me" /* SRV_SOUND_LEVEL */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["me" /* SRV_SOUND_LEVEL */], soundLevel)];
  }
}, {
  name: "sound spectrum",
  serviceClasses: [constants["oe" /* SRV_SOUND_SPECTRUM */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["oe" /* SRV_SOUND_SPECTRUM */], soundSpectrum)];
  }
}, {
  name: "sound player (micro:bit v2 sounds)",
  serviceClasses: [constants["ne" /* SRV_SOUND_PLAYER */]],
  services: function services() {
    return [new soundplayerservicehost_SoundPlayerServiceHost(microbitSounds)];
  }
}, {
  name: "switch (slide)",
  serviceClasses: [constants["qe" /* SRV_SWITCH */]],
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Te" /* SwitchVariant */].Slide
    })];
  }
}, {
  ...
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Te" /* SwitchVariant */].PushButton
    })];
  }
}, {
  name: "switch (toggle)",
  ...
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Te" /* SwitchVariant */].Toggle
    })];
  }
}, {
  name: "switch (tilt)",
  ...
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Te" /* SwitchVariant */].Tilt
    })];
  }
}, {
  ...
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Te" /* SwitchVariant */].Proximity,
      autoOffDelay: 30
    })];
  }
}, {
  name: "thermometer (outdoor)",
  serviceClasses: [constants["se" /* SRV_THERMOMETER */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["se" /* SRV_THERMOMETER */], outdoorThermometerOptions)];
  }
}, {
  name: "thermometer (medical)",
  serviceClasses: [constants["se" /* SRV_THERMOMETER */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["se" /* SRV_THERMOMETER */], medicalThermometerOptions)];
  }
}, {
  name: "traffic light",
  serviceClasses: [constants["te" /* SRV_TRAFFIC_LIGHT */]],
  services: function services() {
  ...
  name: "thermocouple",
  serviceClasses: [constants["re" /* SRV_THERMOCOUPLE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["re" /* SRV_THERMOCOUPLE */], {
      readingValues: [550],
      streamingInterval: 1000,
      minReading: 0,
      maxReading: 1100,
      readingError: [2.2],
      variant: constants["bf" /* ThermocoupleVariant */].TypeB
    })];
  }
}, {
  name: "TVOC",
  serviceClasses: [constants["ue" /* SRV_TVOC */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ue" /* SRV_TVOC */], tvocOptions)];
  }
}, {
  name: "UV index",
  serviceClasses: [constants["ve" /* SRV_UV_INDEX */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ve" /* SRV_UV_INDEX */], {
      readingValues: [5]
    })];
  }
}, {
  name: "water level",
  serviceClasses: [constants["xe" /* SRV_WATER_LEVEL */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["xe" /* SRV_WATER_LEVEL */], {
      readingValues: [0.5]
    })];
  }
}, {
  name: "weight scale (jewelry)",
  serviceClasses: [constants["ye" /* SRV_WEIGHT_SCALE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ye" /* SRV_WEIGHT_SCALE */], {
      readingValues: [0.001],
      variant: constants["hf" /* WeightScaleVariant */].Jewelry,
      maxReading: 0.2,
      minReading: 0.0005,
  ...
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ye" /* SRV_WEIGHT_SCALE */], {
      readingValues: [60],
      variant: constants["hf" /* WeightScaleVariant */].Body,
      maxReading: 180,
  ...
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ye" /* SRV_WEIGHT_SCALE */], {
      readingValues: [0.5],
      variant: constants["hf" /* WeightScaleVariant */].Food,
      maxReading: 6,
  ...
  name: "wind direction",
  serviceClasses: [constants["ze" /* SRV_WIND_DIRECTION */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ze" /* SRV_WIND_DIRECTION */], windDirectionOptions)];
  }
}, {
  name: "wind speed",
  serviceClasses: [constants["Ae" /* SRV_WIND_SPEED */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Ae" /* SRV_WIND_SPEED */], windSpeedOptions)];
  }
}, {
  name: "weather station (wind speed, direction, rain)",
  serviceClasses: [constants["Ae" /* SRV_WIND_SPEED */], constants["ze" /* SRV_WIND_DIRECTION */], constants["Zd" /* SRV_RAIN_GAUGE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Ae" /* SRV_WIND_SPEED */], windSpeedOptions), new analogsensorservicehost_AnalogSensorServiceHost(constants["ze" /* SRV_WIND_DIRECTION */], windDirectionOptions), new raingaugeservicehost_RainGaugeServiceHost()];
  }
}, {
  name: "vibration motor",
  serviceClasses: [constants["we" /* SRV_VIBRATION_MOTOR */]],
  services: function services() {
    return [new servicehost["a" /* default */](constants["we" /* SRV_VIBRATION_MOTOR */])];
  }
}, {
  name: "chassis (motor x 2 + sonar + light)",
  serviceClasses: [constants["Ed" /* SRV_DISTANCE */], constants["Od" /* SRV_LED_PIXEL */], constants["Ud" /* SRV_MOTOR */]],
  services: function services() {
    return [new motorservicehost_MotorServiceHost("L"), new motorservicehost_MotorServiceHost("R"), new analogsensorservicehost_AnalogSensorServiceHost(constants["Ed" /* SRV_DISTANCE */], sonarOptions), new ledpixelservicehost_LedPixelServiceHost({
      numPixels: 5,
      variant: constants["Pb" /* LedPixelVariant */].Stick
    })];
  }
  ...
  serviceClasses: [constants["te" /* SRV_TRAFFIC_LIGHT */], constants["he" /* SRV_SERVO */], constants["yd" /* SRV_BUZZER */]],
  services: function services() {
  ...
  name: "micro:bit v2",
  serviceClasses: [constants["Nd" /* SRV_LED_MATRIX */], constants["xd" /* SRV_BUTTON */], constants["rd" /* SRV_ACCELEROMETER */], constants["me" /* SRV_SOUND_LEVEL */], constants["Pd" /* SRV_LIGHT_LEVEL */], constants["yd" /* SRV_BUZZER */], constants["ne" /* SRV_SOUND_PLAYER */]],
  services: function services() {
    return [new ledmatrixservicehost["a" /* default */](5, 5), new buttonservicehost_ButtonServiceHost("A"), new buttonservicehost_ButtonServiceHost("B"), new sensorservicehost["a" /* default */](constants["rd" /* SRV_ACCELEROMETER */], {
      readingValues: [0.5, 0.5, -(1 - (0.5 * 0.5 + 0.5 * 0.5))]
    }), new analogsensorservicehost_AnalogSensorServiceHost(constants["me" /* SRV_SOUND_LEVEL */], soundLevel), new sensorservicehost["a" /* default */](constants["Pd" /* SRV_LIGHT_LEVEL */], {
      readingValues: [0.5],
...
//# sourceMappingURL=e577ed790312093c60d6f42a2eefa9c8fa2c70c1-d6ebf8ffaa97742b41df.js.map