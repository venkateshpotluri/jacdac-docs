...
function HIDEvents() {
  ...
  var handleAdd = function handleAdd(hidEvent) {
    setHIDEvents([].concat((0,toConsumableArray/* default */.Z)(hidEvents), [hidEvent]));
  };

  var handleRemoveBinding = function handleRemoveBinding(index) {
    return function () {
      setHIDEvents([].concat((0,toConsumableArray/* default */.Z)(hidEvents.slice(0, index)), (0,toConsumableArray/* default */.Z)(hidEvents.slice(index + 1))));
    };
  };
  ...
  var saveDisabled = !device;
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("h1", null, "HID Event"), /*#__PURE__*/react.createElement("h2", null, "Select hub"), /*#__PURE__*/react.createElement(SelectServiceGrid/* default */.Z, {
    onSelect: handleSelectHub,
    serviceClass: constants/* SRV_SETTINGS */.B9b
  }), /*#__PURE__*/react.createElement("h2", null, "Configure keys"), /*#__PURE__*/react.createElement(SelectHIDEvent, {
    onAdd: handleAdd
  }), /*#__PURE__*/react.createElement(Grid/* default */.Z, {
    container: true,
    spacing: 1
  }, hidEvents.map(function (_ref2, index) {
  ...
  })), /*#__PURE__*/react.createElement("h3", null, "Save configuration"), /*#__PURE__*/react.createElement(CmdButton/* default */.Z, {
    variant: "contained",
    color: "primary",
...
//# sourceMappingURL=component---src-pages-tools-hid-events-tsx-c5f1be347eea2873ac22.js.map