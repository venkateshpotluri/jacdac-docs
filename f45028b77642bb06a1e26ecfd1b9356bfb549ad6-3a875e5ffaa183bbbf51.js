...
var ignoreRegisters = [constants["af" /* SystemReg */].StatusCode, constants["af" /* SystemReg */].StreamingPreferredInterval, constants["af" /* SystemReg */].StreamingSamples, constants["af" /* SystemReg */].StreamingInterval];
var collapsedRegisters = [constants["af" /* SystemReg */].Reading, constants["af" /* SystemReg */].Value, constants["af" /* SystemReg */].Intensity];
...
var ignoredServices = [constants["Hd" /* SRV_CTRL */], constants["Ud" /* SRV_LOGGER */]];
...
function useActualAngle(service) {
  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Je" /* ServoReg */].Angle)),
      angle = _useRegisterUnpackedV[0]; // sec/60deg


  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Je" /* ServoReg */].ResponseSpeed)),
...
function DashboardServo(props) {
  var service = props.service,
      ...
      variant = props.variant;
  var enabledRegister = service.register(constants["Je" /* ServoReg */].Enabled);
  ...
  var off = !enabled;
  var angleRegister = service.register(constants["Je" /* ServoReg */].Angle);
  var angle = useActualAngle(service);

  var _useRegisterUnpackedV4 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Je" /* ServoReg */].Offset)),
...
function DashboardRotaryEncoder(props) {
  ...
  var clicksPerTurnRegister = service.register(constants["pd" /* RotaryEncoderReg */].ClicksPerTurn);
...
function DashboardSwitch(props) {
  ...
  var on = Object(useRegisterValue["a" /* useRegisterBoolValue */])(service.register(constants["We" /* SwitchReg */].Active));

  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["We" /* SwitchReg */].Variant)),
  ...
  switch (switchVariant) {
    case constants["Xe" /* SwitchVariant */].PushButton:
      return /*#__PURE__*/react_default.a.createElement(ButtonWidget["a" /* default */], {
        checked: on,
        color: color,
        label: on ? "on" : "off",
...
var serviceViews = (_serviceViews = {}, _serviceViews[constants["ie" /* SRV_ROLE_MANAGER */]] = {
  component: DashboardRoleManager
}, _serviceViews[constants["Cd" /* SRV_BUZZER */]] = {
  component: DashboardBuzzer,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["Sd" /* SRV_LED_PIXEL */]] = {
  component: DashboardLEDPixel,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["vd" /* SRV_ACCELEROMETER */]] = {
  ...
  bundled: true
}, _serviceViews[constants["le" /* SRV_SERVO */]] = {
  component: DashboardServo,
  bundled: true
}, _serviceViews[constants["ue" /* SRV_SWITCH */]] = {
  component: DashboardSwitch,
  bundled: true
}, _serviceViews[constants["xe" /* SRV_TRAFFIC_LIGHT */]] = {
  component: DashboardTrafficLight
}, _serviceViews[constants["Dd" /* SRV_CHARACTER_SCREEN */]] = {
  component: DashboardCharacterScreen,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["de" /* SRV_RAIN_GAUGE */]] = {
  component: DashboardRainGauge
}, _serviceViews[constants["Rd" /* SRV_LED_MATRIX */]] = {
  component: DashboardLEDMatrix,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["xd" /* SRV_ARCADE_GAMEPAD */]] = {
  component: DashboardArcadeGamepad,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["De" /* SRV_WIND_DIRECTION */]] = {
  component: DashboardWindDirection
}, _serviceViews[constants["Vd" /* SRV_MATRIX_KEYPAD */]] = {
  component: DashboardMatrixKeypad
}, _serviceViews[constants["fe" /* SRV_REFLECTED_LIGHT */]] = {
  component: DashboardReflectedLight
}, _serviceViews[constants["ae" /* SRV_POWER */]] = {
  component: DashboardPower
}, _serviceViews[constants["te" /* SRV_SPEECH_SYNTHESIS */]] = {
  component: DashboardSpeechSynthesis
}, _serviceViews[constants["oe" /* SRV_SOIL_MOISTURE */]] = {
  component: DashboardSoilMoisture
}, _serviceViews[constants["ee" /* SRV_REAL_TIME_CLOCK */]] = {
  component: DashboardRealTimeClock
}, _serviceViews[constants["Qd" /* SRV_LED */]] = {
  component: DashboardLED
}, _serviceViews[constants["Pd" /* SRV_JOYSTICK */]] = {
  component: DashboardJoystick
}, _serviceViews[constants["ne" /* SRV_SEVEN_SEGMENT_DISPLAY */]] = {
  component: DashboardSevenSegmentDisplay
}, _serviceViews[constants["Xd" /* SRV_MOTION */]] = {
  component: DashboardMotion
}, _serviceViews[constants["Be" /* SRV_WATER_LEVEL */]] = {
  component: DashboardWaterLevel
}, _serviceViews[constants["Ed" /* SRV_COLOR */]] = {
  component: DashboardColor,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["re" /* SRV_SOUND_PLAYER */]] = {
  component: DashboardSoundPlayer,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["wd" /* SRV_ANALOG_BUTTON */]] = {
  component: DashboardAnalogButton
}, _serviceViews[constants["qe" /* SRV_SOUND_LEVEL */]] = {
  component: DashboardSoundLevel,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["he" /* SRV_RNG */]] = {
  component: DashboardRandomNumberGenerator
}, _serviceViews[constants["Fd" /* SRV_COMPASS */]] = {
  component: DashboardCompass
}, _serviceViews[constants["Ld" /* SRV_GYROSCOPE */]] = {
  component: DashboardGyroscope,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["se" /* SRV_SOUND_SPECTRUM */]] = {
  component: DashboardSoundSpectrum,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["pe" /* SRV_SOLENOID */]] = {
...
function DefaultWidget(props) {
  ...
  if (register.specification.identifier == constants["af" /* SystemReg */].Value) {
    var intensityRegister = register.service.register(constants["af" /* SystemReg */].Intensity);
  ...
  if (register.specification.identifier === constants["af" /* SystemReg */].Intensity) return /*#__PURE__*/react_default.a.createElement(IntensityWidget, {
...
//# sourceMappingURL=f45028b77642bb06a1e26ecfd1b9356bfb549ad6-3a875e5ffaa183bbbf51.js.map