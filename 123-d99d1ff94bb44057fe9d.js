...
function BytesBarGraphWidget(props) {
  ...
  var dy = (h - 2 * m) / 0xff;
  Object(react["useEffect"])(function () {
    return visible && (register === null || register === void 0 ? void 0 : register.subscribe(constants["Zc" /* REPORT_UPDATE */], function () {
...
function HostMicrophoneButton(props) {
  var host = props.host,
      ...
      visible = props.visible;
  var enabledRegister = service.register(constants["Ue" /* SoundSpectrumReg */].Enabled);
  var enabled = Object(useRegisterValue["a" /* useRegisterBoolValue */])(enabledRegister, props);

  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ue" /* SoundSpectrumReg */].MinDecibels), props),
      minDecibels = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ue" /* SoundSpectrumReg */].MaxDecibels), props),
      maxDecibels = _useRegisterUnpackedV2[0];

  var _useRegisterUnpackedV3 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ue" /* SoundSpectrumReg */].FftPow2Size), props),
      fftPow2Size = _useRegisterUnpackedV3[0];

  var fftSize = 1 << (fftPow2Size || 5);

  var _useRegisterUnpackedV4 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ue" /* SoundSpectrumReg */].SmoothingTimeConstant), props),
  ...
  Object(react["useEffect"])(function () {
    return visible && enabled && (host === null || host === void 0 ? void 0 : host.subscribe(constants["Kc" /* REFRESH */], function () {
...
function DashboardSoundSpectrum(props) {
  var service = props.service,
      visible = props.visible;
  var frequencyBinsRegister = service.register(constants["Ue" /* SoundSpectrumReg */].FrequencyBins);
...
//# sourceMappingURL=123-d99d1ff94bb44057fe9d.js.map