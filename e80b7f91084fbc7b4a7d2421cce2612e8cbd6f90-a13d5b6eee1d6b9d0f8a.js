...
function useReadingAuxilliaryValue(register, identifier) {
  if (identifier === void 0) {
    identifier = constants["Te" /* SystemReg */].ReadingError | constants["Te" /* SystemReg */].ReadingResolution | constants["Te" /* SystemReg */].MaxReading | constants["Te" /* SystemReg */].MinReading | constants["Te" /* SystemReg */].StreamingInterval | constants["Te" /* SystemReg */].StreamingPreferredInterval;
  }

  var service = register.service,
      code = register.code;
  var reading = code === constants["Te" /* SystemReg */].Reading || code === constants["Te" /* SystemReg */].Value;
  ...
  Object(react["useEffect"])(function () {
    return auxilliaryRegister === null || auxilliaryRegister === void 0 ? void 0 : auxilliaryRegister.subscribe(constants["Tc" /* REPORT_UPDATE */], function () {
...
function RegisterInput(props) {
  ...
  var minReading = useReadingAuxilliaryValue(register, constants["Te" /* SystemReg */].MinReading);
  var maxReading = useReadingAuxilliaryValue(register, constants["Te" /* SystemReg */].MaxReading);
  var readingError = useReadingAuxilliaryValue(register, constants["Te" /* SystemReg */].ReadingError);
  var resolution = useReadingAuxilliaryValue(register, constants["Te" /* SystemReg */].ReadingResolution);
  Object(react["useEffect"])(function () {
    return register.subscribe(constants["Tc" /* REPORT_UPDATE */], function () {
...
function MemberInput(props) {
  ...
  var valueString = Object(spec["y" /* memberValueToString */])(value, specification);
  ...
  var handleChange = function handleChange(ev) {
    ...
    var r = Object(spec["K" /* tryParseMemberValue */])(newValue, specification);
...
function RegisterTrend(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    return interval ? undefined : register === null || register === void 0 ? void 0 : register.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__[/* REPORT_RECEIVE */ "Sc"], addRow);
...
//# sourceMappingURL=e80b7f91084fbc7b4a7d2421cce2612e8cbd6f90-a13d5b6eee1d6b9d0f8a.js.map