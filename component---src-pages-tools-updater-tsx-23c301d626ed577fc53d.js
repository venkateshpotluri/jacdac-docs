...
function useFirmwareRepos(showAllRepos) {
  ...
  var bootloaders = devices.filter(function (device) {
    return device === null || device === void 0 ? void 0 : device.hasService(constants["Dd" /* SRV_BOOTLOADER */]);
  });
  var registers = devices.filter(function (device) {
    return !(device !== null && device !== void 0 && device.hasService(constants["Dd" /* SRV_BOOTLOADER */]));
  }) // not a bootloader
  .map(function (device) {
    var _device$service;

    return device === null || device === void 0 ? void 0 : (_device$service = device.service(0)) === null || _device$service === void 0 ? void 0 : _device$service.register(constants["T" /* ControlReg */].FirmwareIdentifier);
  }).filter(function (reg) {
    return !!reg;
  });
...
//# sourceMappingURL=component---src-pages-tools-updater-tsx-23c301d626ed577fc53d.js.map