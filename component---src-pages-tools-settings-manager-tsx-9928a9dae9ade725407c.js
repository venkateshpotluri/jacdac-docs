      ...
      return regenerator_default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.service.sendCmdAsync(constants["Ke" /* SettingsCmd */].Clear);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.service.sendPacketAsync(inp.openCommand(constants["Ke" /* SettingsCmd */].ListKeys), true);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              inp = new pipes["a" /* InPipeReader */](this.bus);
              _context3.next = 3;
              return this.service.sendPacketAsync(inp.openCommand(constants["Ke" /* SettingsCmd */].List), true);
      ...
      return regenerator_default.a.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 6:
              pkt = packet["a" /* default */].from(constants["Ke" /* SettingsCmd */].Set, Object(pack["a" /* jdpack */])("z b", [key, Object(utils["Q" /* stringToBuffer */])(value)]));
              _context4.next = 9;
      ...
      return regenerator_default.a.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 2:
              key = key.trim();
              pkt = packet["a" /* default */].from(constants["Ke" /* SettingsCmd */].Get, Object(pack["a" /* jdpack */])("s", [key]));
              _context5.next = 6;
      ...
      return regenerator_default.a.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 2:
              key = key.trim();
              pkt = packet["a" /* default */].from(constants["Ke" /* SettingsCmd */].Delete, Object(pack["a" /* jdpack */])("s", [key]));
              _context6.next = 6;
              return this.service.sendPacketAsync(pkt);
...
function SettingsManager() {
  ...
  var services = Object(useChange["a" /* default */])(bus, function (b) {
    return b.services({
      serviceClass: constants["me" /* SRV_SETTINGS */]
    });
  });
...
//# sourceMappingURL=component---src-pages-tools-settings-manager-tsx-9928a9dae9ade725407c.js.map