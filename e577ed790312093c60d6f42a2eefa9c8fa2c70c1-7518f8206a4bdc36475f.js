...
var ProtocolTestServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function ProtocolTestServiceHost() {
    ...
    _this = _ServiceHost.call(this, _jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* SRV_PROTO_TEST */ "Vd"]) || this;
...
var LEDMatrixServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function LEDMatrixServiceHost(columns, rows) {
    ...
    _this = _ServiceHost.call(this, _jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* SRV_LED_MATRIX */ "Ld"], {
      intensityValues: [0xff >> 1]
    }) || this;
    _this.leds = _this.addRegister(_jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* LedMatrixReg */ "Mb"].Leds, [new Uint8Array(0)]);
    _this.rows = _this.addRegister(_jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* LedMatrixReg */ "Mb"].Rows, [rows]);
    _this.columns = _this.addRegister(_jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* LedMatrixReg */ "Mb"].Columns, [columns]);
    _this.brightness = _this.addRegister(_jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* LedMatrixReg */ "Mb"].Brightness, [128]);
    _this.rows.skipBoundaryCheck = true;
    _this.rows.skipErrorInjection = true; // 20fps

    _this.addRegister(_jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* SensorReg */ "Ce"].StreamingPreferredInterval, [50]);
...
var LEDServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function LEDServiceHost(options) {
    ...
    _this2 = _ServiceHost.call(this, _jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* SRV_LED */ "Kd"]) || this;

    var _ref2 = options || {},
        _ref2$ledCount = _ref2.ledCount,
        ledCount = _ref2$ledCount === void 0 ? 1 : _ref2$ledCount,
        _ref2$variant = _ref2.variant,
        variant = _ref2$variant === void 0 ? _jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* LedVariant */ "Sb"].ThroughHole : _ref2$variant,
    ...
    _this2.animation = _this2.addRegister(_jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* LedReg */ "Rb"].Animation, animation);
    _this2.brightness = _this2.addRegister(_jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* LedReg */ "Rb"].Brightness, [brightness]);
    _this2.maxPower = _this2.addRegister(_jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* LedReg */ "Rb"].MaxPower, [maxPower]);
    _this2.ledCount = _this2.addRegister(_jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* LedReg */ "Rb"].LedCount, [ledCount]);
    if (luminousIntensity !== undefined) _this2.luminousIntensity = _this2.addRegister(_jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* LedReg */ "Rb"].LuminousIntensity, [luminousIntensity]);
    if (waveLength !== undefined) _this2.waveLength = _this2.addRegister(_jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* LedReg */ "Rb"].WaveLength, [waveLength]);
    _this2.variant = _this2.addRegister(_jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* LedReg */ "Rb"].Variant, [variant]);
    return _this2;
  }
...
var BuzzerServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function BuzzerServiceHost() {
    ...
    _this = _ServiceHost.call(this, _jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* SRV_BUZZER */ "wd"]) || this;
...
var buttonservicehost_ButtonServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function ButtonServiceHost(instanceName) {
    ...
    _this = _SensorServiceHost.call(this, constants["vd" /* SRV_BUTTON */], {
    ...
    _this.on(constants["Gc" /* REFRESH */], _this.handleRefresh.bind(Object(assertThisInitialized["a" /* default */])(_this)));
...
var characterscreenservicehost_CharacterScreenServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function CharacterScreenServiceHost(options) {
    ...
    _this = _ServiceHost.call(this, constants["xd" /* SRV_CHARACTER_SCREEN */]) || this;
...
var humidityservicehost_HumidityServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function HumidityServiceHost() {
    return _SensorServiceHost.call(this, constants["Hd" /* SRV_HUMIDITY */], {
      readingValues: [40],
      readingError: [0.1],
...
var joystickservicehost_JoystickSensorServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function JoystickSensorServiceHost(variant, digital) {
    ...
    _this = _SensorServiceHost.call(this, constants["Jd" /* SRV_JOYSTICK */], {
      readingValues: [0, 0]
    }) || this;
    _this.variant = _this.addRegister(constants["Ib" /* JoystickReg */].Variant, [variant || constants["Jb" /* JoystickVariant */].Thumb]);
    _this.digital = _this.addRegister(constants["Ib" /* JoystickReg */].Digital, [digital || false]);
    return _this;
  }
...
var ledpixelservicehost_LedPixelServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function LedPixelServiceHost(options) {
    ...
    _this = _ServiceHost.call(this, constants["Md" /* SRV_LED_PIXEL */], options) || this;
    ...
    _this.brightness = _this.addRegister(constants["Pb" /* LedPixelReg */].Brightness, [15]);
    _this.actualBrightness = _this.addRegister(constants["Pb" /* LedPixelReg */].ActualBrightness, [15]);
    _this.lightType = _this.addRegister(constants["Pb" /* LedPixelReg */].LightType, [constants["Ob" /* LedPixelLightType */].WS2812B_GRB]);
    _this.numPixels = _this.addRegister(constants["Pb" /* LedPixelReg */].NumPixels, [numPixels]);
    _this.maxPower = _this.addRegister(constants["Pb" /* LedPixelReg */].MaxPower, [maxPower]);
    _this.maxPixels = _this.addRegister(constants["Pb" /* LedPixelReg */].MaxPixels, [maxPixels]);
    _this.variant = _this.addRegister(constants["Pb" /* LedPixelReg */].Variant, [constants["Qb" /* LedPixelVariant */].Strip]);
    _this.numRepeats = _this.addRegister(constants["Pb" /* LedPixelReg */].NumRepeats, [0]);
    if (numColumns !== undefined) _this.numColumns = _this.addRegister(constants["Pb" /* LedPixelReg */].NumColumns, [numColumns]);
    ...
    _this.addCommand(constants["Nb" /* LedPixelCmd */].Run, _this.handleRun.bind(Object(assertThisInitialized["a" /* default */])(_this)));
...
var matrixkeypadservicehost_MatrixKeypadServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function MatrixKeypadServiceHost(columns, rows, labels) {
    ...
    _this = _SensorServiceHost.call(this, constants["Pd" /* SRV_MATRIX_KEYPAD */], {
      readingValues: [[]]
    }) || this;
    _this.columns = _this.addRegister(constants["Zb" /* MatrixKeypadReg */].Columns, [columns]);
    _this.rows = _this.addRegister(constants["Zb" /* MatrixKeypadReg */].Rows, [rows]);
    _this.labels = _this.addRegister(constants["Zb" /* MatrixKeypadReg */].Labels, labels ? [labels.map(function (l) {
      return [l];
    })] : undefined);
    return _this;
  }
...
var motorservicehost_MotorServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function MotorServiceHost(instanceName) {
    ...
    _this = _ServiceHost.call(this, constants["Sd" /* SRV_MOTOR */], {
      instanceName: instanceName
    }) || this;
    _this.duty = _this.addRegister(constants["dc" /* MotorReg */].Duty, [0]);
    _this.enabled = _this.addRegister(constants["dc" /* MotorReg */].Enabled, [false]);
    _this.loadTorque = _this.addRegister(constants["dc" /* MotorReg */].LoadTorque);
    _this.loadSpeed = _this.addRegister(constants["dc" /* MotorReg */].LoadSpeed);
    return _this;
  }
...
var leveldetector_LevelDetector = /*#__PURE__*/function (_JDClient) {
  ...
  _proto.reset = function reset() {
    this._state = constants["Te" /* SystemReadingThreshold */].Neutral;
  };
  ...
  _proto.update = function update() {
    ...
    if (level === undefined) {
      this.setState(constants["Te" /* SystemReadingThreshold */].Neutral);
      return;
    }
    ...
    if (high !== undefined && level >= high) {
      this.setState(constants["Te" /* SystemReadingThreshold */].High);
      return;
    }
    ...
    if (low !== undefined && level <= low) {
      this.setState(constants["Te" /* SystemReadingThreshold */].Low);
      return;
    } // neutral
  ...
  _proto.setState = function setState(state) {
    ...
    switch (state) {
      case constants["Te" /* SystemReadingThreshold */].High:
        this.service.sendEvent(constants["Se" /* SystemEvent */].High);
        break;

      case constants["Te" /* SystemReadingThreshold */].Low:
        this.service.sendEvent(constants["Se" /* SystemEvent */].Low);
        break;

      case constants["Te" /* SystemReadingThreshold */].Neutral:
        this.service.sendEvent(constants["Se" /* SystemEvent */].Neutral);
        break;
    }
  };
...
var analogsensorservicehost_AnalogSensorServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function AnalogSensorServiceHost(serviceClass, options) {
    ...
    if (minReading !== undefined) _this.addRegister(constants["Ue" /* SystemReg */].MinReading, [minReading]);
    if (maxReading !== undefined) _this.addRegister(constants["Ue" /* SystemReg */].MaxReading, [maxReading]);
    if (readingResolution !== undefined) _this.addRegister(constants["Ue" /* SystemReg */].ReadingResolution, [readingResolution]);

    if (lowThreshold !== undefined || _this.highThreshold !== undefined) {
      if (lowThreshold !== undefined) _this.lowThreshold = _this.addRegister(constants["Ue" /* SystemReg */].LowThreshold, [lowThreshold]);
      if (highThreshold !== undefined) _this.highThreshold = _this.addRegister(constants["Ue" /* SystemReg */].HighThreshold, [highThreshold]);
...
var raingaugeservicehost_RainGaugeServiceHost = /*#__PURE__*/function (_AnalogSensorServiceH) {
  ...
  function RainGaugeServiceHost(options) {
    ...
    _this = _AnalogSensorServiceH.call(this, constants["Xd" /* SRV_RAIN_GAUGE */], {
      readingValues: [0]
    }) || this;
    _this._tiltCount = 0;
    _this._level = 0;
    ...
    _this.precipitationPrecision = _this.addRegister(constants["Wc" /* RainGaugeReg */].PrecipitationPrecision, [bucketSize || 0.2794]);
    _this._level = 0;
    return _this;
  }
...
var reflectedlightservicehost_ReflectedLightServiceHost = /*#__PURE__*/function (_AnalogSensorServiceH) {
  ...
  function ReflectedLightServiceHost(options) {
    ...
    _this = _AnalogSensorServiceH.call(this, constants["Zd" /* SRV_REFLECTED_LIGHT */], {
      readingValues: [0]
    }) || this;
    ...
    _this.variant = _this.addRegister(constants["ad" /* ReflectedLightReg */].Variant, [variant || constants["bd" /* ReflectedLightVariant */].InfraredDigital]);
    return _this;
  }
...
var rotaryencoderservicehost_RotaryEncoderServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function RotaryEncoderServiceHost() {
    ...
    _this = _SensorServiceHost.call(this, constants["de" /* SRV_ROTARY_ENCODER */], {
      readingValues: [0],
      streamingInterval: 50
    }) || this;
    _this.clicksPerTurn = _this.addRegister(constants["jd" /* RotaryEncoderReg */].ClicksPerTurn, [12]);
    return _this;
  }
...
var servoservicehost_ServoServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function ServoServiceHost(options) {
    ...
    _this = _ServiceHost.call(this, constants["fe" /* SRV_SERVO */], options) || this;
    ...
    _this.angle = _this.addRegister(constants["De" /* ServoReg */].Angle, [0]);
    _this.enabled = _this.addRegister(constants["De" /* ServoReg */].Enabled, [false]);
    _this.minAngle = _this.addRegister(constants["De" /* ServoReg */].MinAngle, minAngle !== undefined ? [minAngle] : undefined);
    _this.maxAngle = _this.addRegister(constants["De" /* ServoReg */].MaxAngle, maxAngle !== undefined ? [maxAngle] : undefined);
    _this.offset = _this.addRegister(constants["De" /* ServoReg */].Offset, [0]);
    _this.responseSpeed = _this.addRegister(constants["De" /* ServoReg */].ResponseSpeed, responseSpeed !== undefined ? [responseSpeed] : undefined);
    _this.stallTorque = _this.addRegister(constants["De" /* ServoReg */].StallTorque, stallTorque !== undefined ? [stallTorque] : undefined);
    return _this;
  }
...
var settingsservicehost_SettingsServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function SettingsServiceHost(storageKey) {
    ...
    _this = _ServiceHost.call(this, constants["ge" /* SRV_SETTINGS */]) || this;
    _this.storageKey = storageKey;

    _this.addCommand(constants["Ee" /* SettingsCmd */].Get, _this.handleGet.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Ee" /* SettingsCmd */].Set, _this.handleSet.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Ee" /* SettingsCmd */].Delete, _this.handleDelete.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Ee" /* SettingsCmd */].ListKeys, _this.handleListKeys.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Ee" /* SettingsCmd */].List, _this.handleList.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Ee" /* SettingsCmd */].Clear, _this.handleClear.bind(Object(assertThisInitialized["a" /* default */])(_this)));
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              resp = packet["a" /* default */].jdpacked(constants["Ee" /* SettingsCmd */].Get, "z b", [key, payload]);
              _context.next = 5;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 3;
              return this.sendEvent(constants["Fe" /* SettingsEvent */].Change);
...
var speechsynthesisservicehost_SpeechSynthesisServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function SpeechSynthesisServiceHost() {
    ...
    _this = _ServiceHost.call(this, constants["ne" /* SRV_SPEECH_SYNTHESIS */]) || this;
    _this.synthesis = typeof window !== "undefined" && window.speechSynthesis;
    _this.enabled = _this.addRegister(constants["Oe" /* SpeechSynthesisReg */].Enabled, [!((_this$synthesis = _this.synthesis) !== null && _this$synthesis !== void 0 && _this$synthesis.paused)]);
    _this.pitch = _this.addRegister(constants["Oe" /* SpeechSynthesisReg */].Pitch, [1]);
    _this.rate = _this.addRegister(constants["Oe" /* SpeechSynthesisReg */].Rate, [1]);
    _this.lang = _this.addRegister(constants["Oe" /* SpeechSynthesisReg */].Lang, [""]);
    _this.volume = _this.addRegister(constants["Oe" /* SpeechSynthesisReg */].Volume, [0.5]);

    _this.addCommand(constants["Ne" /* SpeechSynthesisCmd */].Speak, _this.handleSpeak.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Ne" /* SpeechSynthesisCmd */].Cancel, _this.handleCancel.bind(Object(assertThisInitialized["a" /* default */])(_this)));
...
var switchservicehost_SwitchServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function SwitchServiceHost(options) {
    ...
    _this = _SensorServiceHost.call(this, constants["oe" /* SRV_SWITCH */], {
      readingValues: [false],
      streamingInterval: 50
    }) || this;
    ...
    _this.variant = _this.addRegister(constants["Qe" /* SwitchReg */].Variant, variant !== undefined ? [variant] : undefined);
    _this.autoOffDelay = _this.addRegister(constants["Qe" /* SwitchReg */].AutoOffDelay, autoOffDelay !== undefined ? [autoOffDelay] : undefined);
    return _this;
  }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              this.reading.setValues([true]);
              _context2.next = 5;
              return this.sendEvent(constants["Pe" /* SwitchEvent */].On);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              this.reading.setValues([false]);
              _context3.next = 5;
              return this.sendEvent(constants["Pe" /* SwitchEvent */].Off);
...
var trafficlightservicehost_TrafficLightServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function TrafficLightServiceHost() {
    ...
    _this = _ServiceHost.call(this, constants["re" /* SRV_TRAFFIC_LIGHT */]) || this;
    _this.red = _this.addRegister(constants["bf" /* TrafficLightReg */].Red, [true]);
    _this.orange = _this.addRegister(constants["bf" /* TrafficLightReg */].Orange, [false]);
    _this.green = _this.addRegister(constants["bf" /* TrafficLightReg */].Green, [false]);
    return _this;
  }
...
var soundplayerservicehost_SoundPlayerServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function SoundPlayerServiceHost(sounds) {
    ...
    _this = _ServiceHost.call(this, constants["le" /* SRV_SOUND_PLAYER */]) || this;
    _this.sounds = sounds;
    _this.volume = _this.addRegister(constants["Le" /* SoundPlayerReg */].Volume, [0.5]);

    _this.addCommand(constants["Ke" /* SoundPlayerCmd */].ListSounds, _this.handleListSounds.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Ke" /* SoundPlayerCmd */].Play, _this.handlePlay.bind(Object(assertThisInitialized["a" /* default */])(_this)));
...
var randomnumbergeneratorservicehost_RandomNumberGeneratorServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function RandomNumberGeneratorServiceHost() {
    ...
    _this = _SensorServiceHost.call(this, constants["be" /* SRV_RNG */], {
      variant: constants["fd" /* RngVariant */].WebCrypto,
...
var compassservicehost_CompassServiceHost = /*#__PURE__*/function (_AnalogSensorServiceH) {
  ...
  function CompassServiceHost() {
    ...
    _this = _AnalogSensorServiceH.call(this, constants["zd" /* SRV_COMPASS */], {
      readingValues: [0],
      minReading: 0,
      maxReading: 360,
      readingError: [1]
    ...
    _this.enabled.on(constants["s" /* CHANGE */], function () {
      ...
      if (status === constants["Ve" /* SystemStatusCodes */].CalibrationNeeded) {
...
var dmxservicehost_DMXServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function DMXServiceHost() {
    ...
    _this = _ServiceHost.call(this, constants["Dd" /* SRV_DMX */], {
      intensityValues: [0]
    }) || this;

    _this.addCommand(constants["hb" /* DmxCmd */].Send, _this.handleSend.bind(Object(assertThisInitialized["a" /* default */])(_this)));
...
var bitradioservicehost_BitRadioServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function BitRadioServiceHost() {
    ...
    _this = _ServiceHost.call(this, constants["td" /* SRV_BIT_RADIO */]) || this;
...
var indoorThermometerOptions = {
  ...
  maxReading: 50,
  readingError: [0.25],
  variant: constants["af" /* ThermometerVariant */].Indoor
};
var outdoorThermometerOptions = {
  ...
  maxReading: 120,
  readingError: [0.25],
  variant: constants["af" /* ThermometerVariant */].Outdoor
};
var medicalThermometerOptions = {
  ...
  maxReading: 42,
  readingError: [0.5],
  variant: constants["af" /* ThermometerVariant */].Body
};
var barometerOptions = {
  readingValues: [1013]
};
var sonarOptions = {
  variant: constants["gb" /* DistanceVariant */].Ultrasonic,
  minReading: 0.02,
  maxReading: 4,
  readingValues: [1]
};
...
var windSpeedOptions = {
  ...
  readingError: [0.5],
  registerValues: [{
    code: constants["hf" /* WindSpeedReg */].MaxWindSpeed,
    values: [55]
  }]
};
var eCO2Options = {
  readingValues: [4000],
  variant: constants["ib" /* ECO2Variant */].VOC
};
var CO2Options = {
  readingValues: [4000],
  variant: constants["ib" /* ECO2Variant */].NDIR
};
var tvocOptions = {
  readingValues: [500]
};
...
var soundLevel = {
  ...
  registerValues: [{
    code: constants["Je" /* SoundLevelReg */].MinDecibels,
    values: [-100]
  }, {
    code: constants["Je" /* SoundLevelReg */].MaxDecibels,
    values: [-30]
  }]
};
var soundSpectrum = {
  ...
  intensityValues: [false],
  registerValues: [{
    code: constants["Me" /* SoundSpectrumReg */].FftPow2Size,
    values: [5]
  }, {
    code: constants["Me" /* SoundSpectrumReg */].MinDecibels,
    values: [-100]
  }, {
    code: constants["Me" /* SoundSpectrumReg */].MaxDecibels,
    values: [-30]
  }, {
    code: constants["Me" /* SoundSpectrumReg */].SmoothingTimeConstant,
    values: [0.8]
  }]
};
var _hosts = [{
  name: "7-segment (4 segments)",
  serviceClasses: [constants["he" /* SRV_SEVEN_SEGMENT_DISPLAY */]],
  services: function services() {
    return [new servicehost["a" /* default */](constants["he" /* SRV_SEVEN_SEGMENT_DISPLAY */], {
      intensityValues: [0xffff],
      valueValues: [Object(utils["u" /* fromHex */])("ff112233")],
      registerValues: [{
        code: constants["Ge" /* SevenSegmentDisplayReg */].DigitCount,
        values: [4]
      }, {
        code: constants["Ge" /* SevenSegmentDisplayReg */].DecimalPoint,
        values: [true]
      }]
    })];
  }
  ...
  name: "accelerometer",
  serviceClasses: [constants["pd" /* SRV_ACCELEROMETER */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["pd" /* SRV_ACCELEROMETER */], {
      readingValues: [0.5, 0.5, -(1 - (0.5 * 0.5 + 0.5 * 0.5))]
    })];
  }
}, {
  name: "arcade gamepad (all buttons)",
  serviceClasses: [constants["rd" /* SRV_ARCADE_GAMEPAD */]],
  services: function services() {
  ...
  name: "barometer",
  serviceClasses: [constants["sd" /* SRV_BAROMETER */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["sd" /* SRV_BAROMETER */], barometerOptions)];
  }
}, {
  name: "bitradio",
  serviceClasses: [constants["td" /* SRV_BIT_RADIO */]],
  services: function services() {
    return [new bitradioservicehost_BitRadioServiceHost()];
  }
}, {
  name: "button",
  serviceClasses: [constants["vd" /* SRV_BUTTON */]],
  services: function services() {
  ...
  name: "buzzer",
  serviceClasses: [constants["wd" /* SRV_BUZZER */]],
  services: function services() {
    return [new buzzerservicehost["a" /* default */]()];
  }
}, {
  name: "capacitive button",
  serviceClasses: [constants["qd" /* SRV_ANALOG_BUTTON */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["qd" /* SRV_ANALOG_BUTTON */], touchButton)];
  }
}, {
  ...
  services: function services() {
    return Array(6).fill(0).map(function (_, i) {
      return new analogsensorservicehost_AnalogSensorServiceHost(constants["qd" /* SRV_ANALOG_BUTTON */], _objectSpread(_objectSpread({}, touchButton), {
        instanceName: "C" + i
      }));
    });
  }
  ...
  serviceClasses: [constants["xd" /* SRV_CHARACTER_SCREEN */]],
  services: function services() {
  ...
  name: "color",
  serviceClasses: [constants["yd" /* SRV_COLOR */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["yd" /* SRV_COLOR */], {
      readingValues: [0.5, 0, 0.5]
    })];
  }
}, {
  name: "compass",
  serviceClasses: [constants["zd" /* SRV_COMPASS */]],
  services: function services() {
    return [new compassservicehost_CompassServiceHost()];
  }
}, {
  name: "distance (sonar)",
  serviceClasses: [constants["Cd" /* SRV_DISTANCE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Cd" /* SRV_DISTANCE */], sonarOptions)];
  }
}, {
  name: "DMX",
  serviceClasses: [constants["Dd" /* SRV_DMX */]],
  services: function services() {
    return [new dmxservicehost_DMXServiceHost()];
  }
}, {
  name: "eCO₂",
  serviceClasses: [constants["Ed" /* SRV_E_CO2 */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Ed" /* SRV_E_CO2 */], eCO2Options)];
  }
}, {
  name: "eCO₂ + TVOC",
  serviceClasses: [constants["Ed" /* SRV_E_CO2 */], constants["se" /* SRV_TVOC */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Ed" /* SRV_E_CO2 */], eCO2Options), new analogsensorservicehost_AnalogSensorServiceHost(constants["se" /* SRV_TVOC */], tvocOptions)];
  }
}, {
  name: "eCO₂ + humidity + thermometer",
  serviceClasses: [constants["Ed" /* SRV_E_CO2 */], constants["Hd" /* SRV_HUMIDITY */], constants["qe" /* SRV_THERMOMETER */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Ed" /* SRV_E_CO2 */], CO2Options), new humidityservicehost_HumidityServiceHost(), new analogsensorservicehost_AnalogSensorServiceHost(constants["qe" /* SRV_THERMOMETER */], indoorThermometerOptions)];
  }
}, {
  name: "gyroscope",
  serviceClasses: [constants["Fd" /* SRV_GYROSCOPE */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Fd" /* SRV_GYROSCOPE */], {
      readingValues: [0, 0, 0]
    })];
  }
}, {
  name: "heart rate",
  serviceClasses: [constants["Gd" /* SRV_HEART_RATE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Gd" /* SRV_HEART_RATE */], {
      readingValues: [80],
      variant: constants["sb" /* HeartRateVariant */].Finger
    })];
  }
}, {
  name: "humidity",
  serviceClasses: [constants["Hd" /* SRV_HUMIDITY */]],
  services: function services() {
    return [new humidityservicehost_HumidityServiceHost()];
  }
}, {
  name: "humidity + temperature",
  serviceClasses: [constants["Hd" /* SRV_HUMIDITY */], constants["qe" /* SRV_THERMOMETER */]],
  services: function services() {
    return [new humidityservicehost_HumidityServiceHost(), new analogsensorservicehost_AnalogSensorServiceHost(constants["qe" /* SRV_THERMOMETER */], outdoorThermometerOptions)];
  }
}, {
  name: "humidity + temperature + barometer",
  serviceClasses: [constants["Hd" /* SRV_HUMIDITY */], constants["qe" /* SRV_THERMOMETER */], constants["sd" /* SRV_BAROMETER */]],
  services: function services() {
    return [new humidityservicehost_HumidityServiceHost(), new analogsensorservicehost_AnalogSensorServiceHost(constants["qe" /* SRV_THERMOMETER */], outdoorThermometerOptions), new analogsensorservicehost_AnalogSensorServiceHost(constants["sd" /* SRV_BAROMETER */], barometerOptions)];
  }
}, {
  name: "illuminance",
  serviceClasses: [constants["Id" /* SRV_ILLUMINANCE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Id" /* SRV_ILLUMINANCE */], {
      readingValues: [1]
    })];
  }
}, {
  name: "joystick (thumbstick)",
  serviceClasses: [constants["Jd" /* SRV_JOYSTICK */]],
  services: function services() {
    return [new joystickservicehost_JoystickSensorServiceHost(constants["Jb" /* JoystickVariant */].Thumb)];
  }
}, {
  name: "joystick (arcade stick digital)",
  serviceClasses: [constants["Jd" /* SRV_JOYSTICK */]],
  services: function services() {
    return [new joystickservicehost_JoystickSensorServiceHost(constants["Jb" /* JoystickVariant */].ArcadeStick, true)];
  }
}, {
  name: "LED (RGB through hole)",
  serviceClasses: [constants["Kd" /* SRV_LED */]],
  services: function services() {
    return [new ledservicehost["b" /* default */]({
      variant: constants["Sb" /* LedVariant */].ThroughHole,
      ledCount: 1,
  ...
  serviceClasses: [constants["Ld" /* SRV_LED_MATRIX */]],
  services: function services() {
  ...
  serviceClasses: [constants["Md" /* SRV_LED_PIXEL */]],
  services: function services() {
    return [new ledpixelservicehost_LedPixelServiceHost({
      numPixels: 10,
      variant: constants["Qb" /* LedPixelVariant */].Ring
    })];
  }
}, {
  ...
  services: function services() {
    return [new ledpixelservicehost_LedPixelServiceHost({
      numPixels: 7,
      variant: constants["Qb" /* LedPixelVariant */].Jewel
    })];
  }
}, {
  ...
  services: function services() {
    return [new ledpixelservicehost_LedPixelServiceHost({
      numPixels: 8,
      variant: constants["Qb" /* LedPixelVariant */].Stick
    })];
  }
}, {
  ...
  services: function services() {
    return [new ledpixelservicehost_LedPixelServiceHost({
      numPixels: 60,
      maxPower: 1000,
      variant: constants["Qb" /* LedPixelVariant */].Strip
    })];
  }
}, {
  ...
  services: function services() {
    return [new ledpixelservicehost_LedPixelServiceHost({
      numPixels: 16,
      variant: constants["Qb" /* LedPixelVariant */].Matrix
    })];
  }
}, {
  ...
  serviceClasses: [constants["Nd" /* SRV_LIGHT_LEVEL */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Nd" /* SRV_LIGHT_LEVEL */], {
      readingValues: [0.5],
      variant: constants["Tb" /* LightLevelVariant */].PhotoResistor
    })];
  }
}, {
  name: "line tracker (digital)",
  serviceClasses: [constants["Zd" /* SRV_REFLECTED_LIGHT */]],
  services: function services() {
  ...
  services: function services() {
    return [new reflectedlightservicehost_ReflectedLightServiceHost({
      variant: constants["bd" /* ReflectedLightVariant */].InfraredAnalog
    })];
  }
}, {
  name: "matrix keypad (3x4)",
  serviceClasses: [constants["Pd" /* SRV_MATRIX_KEYPAD */]],
  services: function services() {
  ...
  name: "motion",
  serviceClasses: [constants["Rd" /* SRV_MOTION */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Rd" /* SRV_MOTION */], {
      readingValues: [false]
    })];
  }
}, {
  name: "motor",
  serviceClasses: [constants["Sd" /* SRV_MOTOR */]],
  services: function services() {
    return [new motorservicehost_MotorServiceHost()];
  }
}, {
  name: "protocol test",
  serviceClasses: [constants["Vd" /* SRV_PROTO_TEST */]],
  services: function services() {
    return [new protocoltestservicehost["a" /* default */]()];
  }
}, {
  name: "pulse oxymeter",
  serviceClasses: [constants["Wd" /* SRV_PULSE_OXIMETER */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Wd" /* SRV_PULSE_OXIMETER */], {
      readingValues: [98]
    })];
  }
}, {
  name: "oxymeter + heart beat",
  serviceClasses: [constants["Wd" /* SRV_PULSE_OXIMETER */], constants["Gd" /* SRV_HEART_RATE */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Wd" /* SRV_PULSE_OXIMETER */], {
      readingValues: [98]
    }), new analogsensorservicehost_AnalogSensorServiceHost(constants["Gd" /* SRV_HEART_RATE */], {
      readingValues: [80],
      variant: constants["sb" /* HeartRateVariant */].Finger
    })];
  }
  ...
  serviceClasses: [constants["be" /* SRV_RNG */]],
  services: function services() {
    return [new randomnumbergeneratorservicehost_RandomNumberGeneratorServiceHost()];
  }
}, {
  name: "rain gauge",
  serviceClasses: [constants["Xd" /* SRV_RAIN_GAUGE */]],
  services: function services() {
    return [new raingaugeservicehost_RainGaugeServiceHost()];
  }
}, {
  name: "real time clock",
  serviceClasses: [constants["Yd" /* SRV_REAL_TIME_CLOCK */]],
  services: function services() {
    return [new realtimeclockservicehost["a" /* default */]()];
  }
}, {
  name: "relay (EM/10A)",
  serviceClasses: [constants["ae" /* SRV_RELAY */]],
  services: function services() {
    return [new servicehost["a" /* default */](constants["ae" /* SRV_RELAY */], {
      intensityValues: [false],
      variant: constants["dd" /* RelayVariant */].Electromechanical,
      registerValues: [{
        code: constants["cd" /* RelayReg */].MaxSwitchingCurrent,
        values: [10]
      }]
    })];
  }
  ...
  services: function services() {
    return Array(4).fill(0).map(function () {
      return new servicehost["a" /* default */](constants["ae" /* SRV_RELAY */], {
        intensityValues: [false],
        variant: constants["dd" /* RelayVariant */].SolidState,
        registerValues: [{
          code: constants["cd" /* RelayReg */].MaxSwitchingCurrent,
          values: [5]
        }]
  ...
  name: "rotary encoder",
  serviceClasses: [constants["de" /* SRV_ROTARY_ENCODER */]],
  services: function services() {
    return [new rotaryencoderservicehost_RotaryEncoderServiceHost()];
  }
}, {
  name: "rotary encoder + button",
  serviceClasses: [constants["de" /* SRV_ROTARY_ENCODER */], constants["vd" /* SRV_BUTTON */]],
  services: function services() {
  ...
  serviceClasses: [constants["Td" /* SRV_POTENTIOMETER */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Td" /* SRV_POTENTIOMETER */], {
      variant: constants["Ac" /* PotentiometerVariant */].Rotary,
      readingValues: [0.5]
    })];
  }
}, {
  name: "servo",
  serviceClasses: [constants["fe" /* SRV_SERVO */]],
  services: function services() {
  ...
  name: "settings",
  serviceClasses: [constants["ge" /* SRV_SETTINGS */]],
  services: function services() {
  ...
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Td" /* SRV_POTENTIOMETER */], {
      variant: constants["Ac" /* PotentiometerVariant */].Slider
    })];
  }
}, {
  name: "soil moisture",
  serviceClasses: [constants["ie" /* SRV_SOIL_MOISTURE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ie" /* SRV_SOIL_MOISTURE */], {
      readingValues: [0.5]
    })];
  }
}, {
  name: "speech synthesis",
  serviceClasses: [constants["ne" /* SRV_SPEECH_SYNTHESIS */]],
  services: function services() {
    return [new speechsynthesisservicehost_SpeechSynthesisServiceHost()];
  }
}, {
  name: "solenoid",
  serviceClasses: [constants["je" /* SRV_SOLENOID */]],
  services: function services() {
    return [new servicehost["a" /* default */](constants["je" /* SRV_SOLENOID */], {
      intensityValues: [0]
    })];
  }
}, {
  name: "sound level",
  serviceClasses: [constants["ke" /* SRV_SOUND_LEVEL */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ke" /* SRV_SOUND_LEVEL */], soundLevel)];
  }
}, {
  name: "sound spectrum",
  serviceClasses: [constants["me" /* SRV_SOUND_SPECTRUM */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["me" /* SRV_SOUND_SPECTRUM */], soundSpectrum)];
  }
}, {
  name: "sound player (micro:bit v2 sounds)",
  serviceClasses: [constants["le" /* SRV_SOUND_PLAYER */]],
  services: function services() {
    return [new soundplayerservicehost_SoundPlayerServiceHost(microbitSounds)];
  }
}, {
  name: "switch (slide)",
  serviceClasses: [constants["oe" /* SRV_SWITCH */]],
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Re" /* SwitchVariant */].Slide
    })];
  }
}, {
  ...
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Re" /* SwitchVariant */].PushButton
    })];
  }
}, {
  name: "switch (toggle)",
  ...
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Re" /* SwitchVariant */].Toggle
    })];
  }
}, {
  name: "switch (tilt)",
  ...
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Re" /* SwitchVariant */].Tilt
    })];
  }
}, {
  ...
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Re" /* SwitchVariant */].Proximity,
      autoOffDelay: 30
    })];
  }
}, {
  name: "thermometer (outdoor)",
  serviceClasses: [constants["qe" /* SRV_THERMOMETER */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["qe" /* SRV_THERMOMETER */], outdoorThermometerOptions)];
  }
}, {
  name: "thermometer (medical)",
  serviceClasses: [constants["qe" /* SRV_THERMOMETER */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["qe" /* SRV_THERMOMETER */], medicalThermometerOptions)];
  }
}, {
  name: "traffic light",
  serviceClasses: [constants["re" /* SRV_TRAFFIC_LIGHT */]],
  services: function services() {
  ...
  name: "thermocouple",
  serviceClasses: [constants["pe" /* SRV_THERMOCOUPLE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["pe" /* SRV_THERMOCOUPLE */], {
      readingValues: [550],
      streamingInterval: 1000,
      minReading: 0,
      maxReading: 1100,
      readingError: [2.2],
      variant: constants["Ze" /* ThermocoupleVariant */].TypeB
    })];
  }
}, {
  name: "TVOC",
  serviceClasses: [constants["se" /* SRV_TVOC */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["se" /* SRV_TVOC */], tvocOptions)];
  }
}, {
  name: "UV index",
  serviceClasses: [constants["te" /* SRV_UV_INDEX */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["te" /* SRV_UV_INDEX */], {
      readingValues: [5]
    })];
  }
}, {
  name: "water level",
  serviceClasses: [constants["ve" /* SRV_WATER_LEVEL */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ve" /* SRV_WATER_LEVEL */], {
      readingValues: [0.5]
    })];
  }
}, {
  name: "weight scale (jewelry)",
  serviceClasses: [constants["we" /* SRV_WEIGHT_SCALE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["we" /* SRV_WEIGHT_SCALE */], {
      readingValues: [0.001],
      variant: constants["ff" /* WeightScaleVariant */].Jewelry,
      maxReading: 0.2,
      minReading: 0.0005,
  ...
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["we" /* SRV_WEIGHT_SCALE */], {
      readingValues: [60],
      variant: constants["ff" /* WeightScaleVariant */].Body,
      maxReading: 180,
  ...
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["we" /* SRV_WEIGHT_SCALE */], {
      readingValues: [0.5],
      variant: constants["ff" /* WeightScaleVariant */].Food,
      maxReading: 6,
  ...
  name: "wind direction",
  serviceClasses: [constants["xe" /* SRV_WIND_DIRECTION */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["xe" /* SRV_WIND_DIRECTION */], windDirectionOptions)];
  }
}, {
  name: "wind speed",
  serviceClasses: [constants["ye" /* SRV_WIND_SPEED */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ye" /* SRV_WIND_SPEED */], windSpeedOptions)];
  }
}, {
  name: "weather station (wind speed, direction, rain)",
  serviceClasses: [constants["ye" /* SRV_WIND_SPEED */], constants["xe" /* SRV_WIND_DIRECTION */], constants["Xd" /* SRV_RAIN_GAUGE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ye" /* SRV_WIND_SPEED */], windSpeedOptions), new analogsensorservicehost_AnalogSensorServiceHost(constants["xe" /* SRV_WIND_DIRECTION */], windDirectionOptions), new raingaugeservicehost_RainGaugeServiceHost()];
  }
}, {
  name: "vibration motor",
  serviceClasses: [constants["ue" /* SRV_VIBRATION_MOTOR */]],
  services: function services() {
    return [new servicehost["a" /* default */](constants["ue" /* SRV_VIBRATION_MOTOR */])];
  }
}, {
  name: "chassis (motor x 2 + sonar + light)",
  serviceClasses: [constants["Cd" /* SRV_DISTANCE */], constants["Md" /* SRV_LED_PIXEL */], constants["Sd" /* SRV_MOTOR */]],
  services: function services() {
    return [new motorservicehost_MotorServiceHost("L"), new motorservicehost_MotorServiceHost("R"), new analogsensorservicehost_AnalogSensorServiceHost(constants["Cd" /* SRV_DISTANCE */], sonarOptions), new ledpixelservicehost_LedPixelServiceHost({
      numPixels: 5,
      variant: constants["Qb" /* LedPixelVariant */].Stick
    })];
  }
  ...
  serviceClasses: [constants["re" /* SRV_TRAFFIC_LIGHT */], constants["fe" /* SRV_SERVO */], constants["wd" /* SRV_BUZZER */]],
  services: function services() {
  ...
  name: "micro:bit v2",
  serviceClasses: [constants["Ld" /* SRV_LED_MATRIX */], constants["vd" /* SRV_BUTTON */], constants["pd" /* SRV_ACCELEROMETER */], constants["ke" /* SRV_SOUND_LEVEL */], constants["Nd" /* SRV_LIGHT_LEVEL */], constants["wd" /* SRV_BUZZER */], constants["le" /* SRV_SOUND_PLAYER */]],
  services: function services() {
    return [new ledmatrixservicehost["a" /* default */](5, 5), new buttonservicehost_ButtonServiceHost("A"), new buttonservicehost_ButtonServiceHost("B"), new sensorservicehost["a" /* default */](constants["pd" /* SRV_ACCELEROMETER */], {
      readingValues: [0.5, 0.5, -(1 - (0.5 * 0.5 + 0.5 * 0.5))]
    }), new analogsensorservicehost_AnalogSensorServiceHost(constants["ke" /* SRV_SOUND_LEVEL */], soundLevel), new sensorservicehost["a" /* default */](constants["Nd" /* SRV_LIGHT_LEVEL */], {
      readingValues: [0.5],
      variant: constants["Tb" /* LightLevelVariant */].LEDMatrix
...
function addHost(bus, services, name) {
  var d = new devicehost["a" /* default */](services);
  var device = bus.addDeviceHost(d);
  if (name) device.name = Object(utils["ab" /* uniqueName */])(bus.devices().map(function (dev) {
    return dev.name;
  }), name);
  return d;
}
...
//# sourceMappingURL=e577ed790312093c60d6f42a2eefa9c8fa2c70c1-7518f8206a4bdc36475f.js.map