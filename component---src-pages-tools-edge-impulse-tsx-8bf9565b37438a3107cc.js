...
var EdgeImpulseClient = /*#__PURE__*/function (_JDClient) {
  ...
  _proto.handleMessage = function handleMessage(msg) {
    ...
    if (data.hello !== undefined) {
      ...
      if (!hello.hello) {
        this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* ERROR */ "kb"], hello.err);
        this.disconnect();
      } else {
  ...
  _proto.handleError = function handleError(ev) {
    this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* ERROR */ "kb"], ev);
    this.reconnect();
  };
...
function Acquisition(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_7__["useEffect"])(function () {
    return client === null || client === void 0 ? void 0 : client.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* ERROR */ "kb"], function (e) {
      return setError(e);
    });
  }, [client]); // progress
...
//# sourceMappingURL=component---src-pages-tools-edge-impulse-tsx-8bf9565b37438a3107cc.js.map