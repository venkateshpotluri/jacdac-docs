...
function useReadingAuxilliaryValue(register, identifier) {
  if (identifier === void 0) {
    identifier = constants["af" /* SystemReg */].ReadingError | constants["af" /* SystemReg */].ReadingResolution | constants["af" /* SystemReg */].MaxReading | constants["af" /* SystemReg */].MinReading | constants["af" /* SystemReg */].StreamingInterval | constants["af" /* SystemReg */].StreamingPreferredInterval;
  }

  var service = register.service,
      code = register.code;
  var reading = code === constants["af" /* SystemReg */].Reading || code === constants["af" /* SystemReg */].Value;
  ...
  Object(react["useEffect"])(function () {
    return auxilliaryRegister === null || auxilliaryRegister === void 0 ? void 0 : auxilliaryRegister.subscribe(constants["Yc" /* REPORT_UPDATE */], function () {
...
function RegisterInput(props) {
  ...
  var minReading = useReadingAuxilliaryValue(register, constants["af" /* SystemReg */].MinReading);
  var maxReading = useReadingAuxilliaryValue(register, constants["af" /* SystemReg */].MaxReading);
  var readingError = useReadingAuxilliaryValue(register, constants["af" /* SystemReg */].ReadingError);
  var resolution = useReadingAuxilliaryValue(register, constants["af" /* SystemReg */].ReadingResolution);
  Object(react["useEffect"])(function () {
    return register.subscribe(constants["Yc" /* REPORT_UPDATE */], function () {
...
function ValueWithUnitWidget(props) {
  ...
  var valueText = hasValue ? Object(utils["K" /* roundWithPrecision */])(value, precision).toLocaleString() : "--";
  var valueTextLength = Object(utils["B" /* isSet */])(min) && Object(utils["B" /* isSet */])(max) ? [min, max, min + (min + max) / 3].map(function (v) {
    return Object(utils["K" /* roundWithPrecision */])(v, precision).toLocaleString().replace(/[,.]/, '').length;
  }).reduce(function (l, r) {
    return Math.max(l, r);
...
function MemberInput(props) {
  ...
  var minValue = Object(utils["D" /* pick */])(min, typicalMin, absoluteMin, /^u/.test(type) ? 0 : undefined);
  var maxValue = Object(utils["D" /* pick */])(max, typicalMax, absoluteMax);
  var errorValue = error ? "±" + Object(utils["K" /* roundWithPrecision */])(error, 1 - Math.floor(Math.log10(error))).toLocaleString() : undefined;
  ...
  var valueLabelFormat = function valueLabelFormat(value) {
    // avoid super long floats
    return Object(utils["K" /* roundWithPrecision */])(value, 1) + (unit || "");
  };
  ...
  if (specification.type === "pipe") {
  ...
  } else if (Object(utils["B" /* isSet */])(minValue) && Object(utils["B" /* isSet */])(maxValue)) {
    var hasTypicalRange = Object(utils["B" /* isSet */])(typicalMin) && Object(utils["B" /* isSet */])(typicalMax);
    ...
    if (isWidget) // we need min/max to support a slider
      return /*#__PURE__*/react_default.a.createElement(ValueWithUnitWidget, {
        tabIndex: 0,
        value: Object(utils["K" /* roundWithPrecision */])(value, 1),
        label: specification.unit,
        color: color,
        size: widgetSize
      });
...
function RegisterTrend(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    return interval ? undefined : register === null || register === void 0 ? void 0 : register.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__[/* REPORT_RECEIVE */ "Xc"], addRow);
...
//# sourceMappingURL=bc1de39814113fdab2fbefae2ee854f0842f6be1-3dc43b5cb0cd0fc525e5.js.map