...
function useReadingAuxilliaryValue(register, identifier) {
  if (identifier === void 0) {
    identifier = constants["Se" /* SystemReg */].ReadingError | constants["Se" /* SystemReg */].ReadingResolution | constants["Se" /* SystemReg */].MaxReading | constants["Se" /* SystemReg */].MinReading | constants["Se" /* SystemReg */].StreamingInterval | constants["Se" /* SystemReg */].StreamingPreferredInterval;
  }

  var service = register.service,
      code = register.code;
  var reading = code === constants["Se" /* SystemReg */].Reading || code === constants["Se" /* SystemReg */].Value;
  ...
  Object(react["useEffect"])(function () {
    return auxilliaryRegister === null || auxilliaryRegister === void 0 ? void 0 : auxilliaryRegister.subscribe(constants["Rc" /* REPORT_UPDATE */], function () {
...
function RegisterInput(props) {
  ...
  var minReading = useReadingAuxilliaryValue(register, constants["Se" /* SystemReg */].MinReading);
  var maxReading = useReadingAuxilliaryValue(register, constants["Se" /* SystemReg */].MaxReading);
  var readingError = useReadingAuxilliaryValue(register, constants["Se" /* SystemReg */].ReadingError);
  var resolution = useReadingAuxilliaryValue(register, constants["Se" /* SystemReg */].ReadingResolution);
  Object(react["useEffect"])(function () {
    return register.subscribe(constants["Rc" /* REPORT_UPDATE */], function () {
...
function RegisterTrend(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    return interval ? undefined : register === null || register === void 0 ? void 0 : register.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__[/* REPORT_RECEIVE */ "Qc"], addRow);
...
//# sourceMappingURL=bc1de39814113fdab2fbefae2ee854f0842f6be1-b9a03a358fc1a21a800f.js.map