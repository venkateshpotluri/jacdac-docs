(self["webpackChunkjacdac_docs"] = self["webpackChunkjacdac_docs"] || []).push([[411],{
...
function usePlayTone(defaultVolume) {
  var contextRef = (0,react.useRef)();
  var volumeRef = (0,react.useRef)(); // final cleanup
  ...
  (0,react.useEffect)(function () {
    return function () {
      try {
        ...
        if (contextRef.current.state === "running") (_contextRef$current = contextRef.current) === null || _contextRef$current === void 0 ? void 0 : _contextRef$current.close();
      } catch (e) {
        console.warn(e);
      }
    };
...
function DashboardBuzzer(props) {
  ...
  var volumeRegister = service.register(constants/* BuzzerReg.Volume */.CGK.Volume);
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(Grid/* default */.Z, {
    item: true,
    xs: true
  }, /*#__PURE__*/react.createElement(PianoWidget, {
...
//# sourceMappingURL=411-b4d21f2a707a17b6ec70.js.map