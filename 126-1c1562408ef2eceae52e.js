...
function HostMicrophoneButton(props) {
  ...
  var enabledRegister = service.register(constants["Ke" /* SoundSpectrumReg */].Enabled);
  var enabled = Object(useRegisterValue["a" /* useRegisterBoolValue */])(enabledRegister);

  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ke" /* SoundSpectrumReg */].MinDecibels)),
      minDecibels = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ke" /* SoundSpectrumReg */].MaxDecibels)),
      maxDecibels = _useRegisterUnpackedV2[0];

  var _useRegisterUnpackedV3 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ke" /* SoundSpectrumReg */].FftPow2Size)),
      fftPow2Size = _useRegisterUnpackedV3[0];

  var fftSize = 1 << (fftPow2Size || 5);

  var _useRegisterUnpackedV4 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ke" /* SoundSpectrumReg */].SmoothingTimeConstant)),
  ...
  Object(react["useEffect"])(function () {
    return host === null || host === void 0 ? void 0 : host.subscribe(constants["Ec" /* REFRESH */], function () {
...
function DashboardSoundSpectrum(props) {
  ...
  var frequencyBinsRegister = service.register(constants["Ke" /* SoundSpectrumReg */].FrequencyBins);
...
//# sourceMappingURL=126-1c1562408ef2eceae52e.js.map