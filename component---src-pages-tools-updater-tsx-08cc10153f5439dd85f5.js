...
function useFirmwareRepos(showAllRepos) {
  ...
  var bootloaders = devices.filter(function (device) {
    return device === null || device === void 0 ? void 0 : device.hasService(constants["Cd" /* SRV_BOOTLOADER */]);
  });
  var registers = devices.filter(function (device) {
    return !(device !== null && device !== void 0 && device.hasService(constants["Cd" /* SRV_BOOTLOADER */]));
  }) // not a bootloader
  .map(function (device) {
    var _device$service;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 16:
              ...
              boot = bootloader.services({
                serviceClass: constants["Cd" /* SRV_BOOTLOADER */]
              })[0];
            ...
            case 34:
              if (mounted) setRepos(Object(utils["X" /* unique */])(repos));
...
function UpdateDeviceList() {
  ...
  var devices = Object(useDevices["a" /* default */])({
    ...
    return safeBoot || !dev.hasService(constants["Cd" /* SRV_BOOTLOADER */]);
  });
  ...
  Object(react["useEffect"])(function () {
    return bus.subscribe([constants["W" /* DEVICE_CHANGE */], constants["pb" /* FIRMWARE_BLOBS_CHANGE */]], function () {
      return scan();
    });
  }, []);
  return /*#__PURE__*/react_default.a.createElement(Grid["a" /* default */], {
...
function DeviceCard(props) {
  ...
  var services = Object(useChange["a" /* default */])(device, function () {
    return device.services().filter(function (service) {
      return service.serviceClass != constants["Jd" /* SRV_CTRL */] && service.serviceClass != constants["Wd" /* SRV_LOGGER */];
    });
  });
...
//# sourceMappingURL=component---src-pages-tools-updater-tsx-08cc10153f5439dd85f5.js.map