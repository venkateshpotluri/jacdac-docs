...
function ServiceRegisters(props) {
  ...
  return /*#__PURE__*/react_default.a.createElement(AutoGrid, {
    ...
    return /*#__PURE__*/react_default.a.createElement(RegisterInput["a" /* default */], {
      ...
      showTrend: showTrends && register.code === constants["df" /* SystemReg */].Reading
    });
  }));
}
...
function packArguments(info, args) {
  ...
  for (var i = 0; i < info.fields.length; ++argIdx, ++i) {
    ...
    var arg = typeof arg1 == "boolean" ? arg1 ? 1 : 0 : typeof arg1 == "string" ? Object(utils["S" /* stringToUint8Array */])(Object(utils["X" /* toUTF8 */])(arg1)) : arg1;
    ...
    if (dst >= constants["Db" /* JD_SERIAL_MAX_PAYLOAD_SIZE */]) throw new Error("jacdac packet length too large, " + dst + " > " + constants["Db" /* JD_SERIAL_MAX_PAYLOAD_SIZE */] + " bytes");
...
//# sourceMappingURL=de590f55fa2f17e49ed8680dc5a022fe834f3017-8d2ddae747e6a0372a41.js.map