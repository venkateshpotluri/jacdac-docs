...
function useFirmwareRepos(showAllRepos) {
  ...
  var devices = Object(useEventRaised["a" /* default */])(constants["W" /* DEVICE_CHANGE */], bus, function () {
    return bus.devices({
      announced: true,
      ignoreSelf: true
    });
  ...
  var bootloaders = devices.filter(function (device) {
    return device.hasService(constants["Dd" /* SRV_BOOTLOADER */]);
  });
  ...
  .map(function (device) {
    ...
    return (_device$service = device.service(0)) === null || _device$service === void 0 ? void 0 : _device$service.register(constants["T" /* ControlReg */].FirmwareIdentifier);
  }).filter(function (reg) {
    return !!reg;
  });
          ...
          switch (_context.prev = _context.next) {
            ...
            case 16:
              ...
              boot = bootloader.services({
                serviceClass: constants["Dd" /* SRV_BOOTLOADER */]
              })[0];
              bl_announce = packet["a" /* default */].onlyHeader(constants["p" /* BootloaderCmd */].Info);
              _context.prev = 20;
              _context.next = 23;
            ...
            case 34:
              if (mounted) {
                urepos = Object(utils["Y" /* unique */])(repos);
                setRepos(urepos);
              }
...
var semver = __webpack_require__("1YGl");
...
function UpdateDeviceCard(props) {
  ...
  var upgrade = update && Object(semver["a" /* semverCmp */])(blob.version, firmwareInfo.version) > 0;
  ...
  return /*#__PURE__*/react_default.a.createElement(DeviceCard["a" /* default */], {
    device: device,
    showFirmware: true,
    content: update && /*#__PURE__*/react_default.a.createElement("span", null, upgrade ? "Upgrade" : "Downgrade", " to ", blob.version) // tslint:disable-next-line: react-this-binding-issue
    ,
...
function UpdateDeviceList() {
  ...
  Object(react["useEffect"])(function () {
    return bus.subscribe([constants["W" /* DEVICE_CHANGE */], constants["qb" /* FIRMWARE_BLOBS_CHANGE */]], function () {
      return scan();
    });
  }, []);
  return /*#__PURE__*/react_default.a.createElement(Grid["a" /* default */], {
...
function DeviceDescription(props) {
  ...
  var _useRegisterUnpackedV = Object(useRegisterValue["c" /* useRegisterUnpackedValue */])(register),
...
//# sourceMappingURL=component---src-pages-tools-updater-tsx-00c542ef8cd2314b006d.js.map