...
function useFirmwareRepos(showAllRepos) {
  ...
  var bootloaders = devices.filter(function (device) {
    return device === null || device === void 0 ? void 0 : device.hasService(constants["zd" /* SRV_BOOTLOADER */]);
  });
  var registers = devices.filter(function (device) {
    return !(device !== null && device !== void 0 && device.hasService(constants["zd" /* SRV_BOOTLOADER */]));
  }) // not a bootloader
  .map(function (device) {
    var _device$service;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 16:
              ...
              boot = bootloader.services({
                serviceClass: constants["zd" /* SRV_BOOTLOADER */]
              })[0];
...
function UpdateDeviceList() {
  ...
  var devices = Object(useDevices["a" /* default */])({
    ...
    return safeBoot || !dev.hasService(constants["zd" /* SRV_BOOTLOADER */]);
  });
...
//# sourceMappingURL=component---src-pages-tools-updater-tsx-30e50c20b2001216b7cc.js.map