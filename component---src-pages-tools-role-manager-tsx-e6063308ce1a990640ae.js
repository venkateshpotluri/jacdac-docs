...
var rolemanagerclient_RoleManagerClient = /*#__PURE__*/function (_JDServiceClient) {
  ...
  function RoleManagerClient(service) {
    ...
    var changeEvent = _this.service.event(constants["od" /* RoleManagerEvent */].Change);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              _context3.next = 8;
              return this.service.sendPacketAsync(inp.openCommand(constants["nd" /* RoleManagerCmd */].ListRequiredRoles), true);
      ...
      return regenerator_default.a.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return this.service.sendCmdAsync(constants["nd" /* RoleManagerCmd */].ClearAllRoles);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 5;
              return this.service.sendPacketAsync(packet["a" /* default */].from(constants["nd" /* RoleManagerCmd */].SetRole, data), true);
...
function RoleManager(props) {
  ...
  var services = useServices({
    serviceClass: constants["je" /* SRV_ROLE_MANAGER */]
  });
...
//# sourceMappingURL=component---src-pages-tools-role-manager-tsx-e6063308ce1a990640ae.js.map