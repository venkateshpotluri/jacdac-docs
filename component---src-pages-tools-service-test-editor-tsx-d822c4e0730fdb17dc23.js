...
function Diagnostics(props) {
  ...
  var hostDefinition = Object(servers["d" /* serviceProviderDefinitionFromServiceClass */])(serviceClass);

  var handleStartSimulator = function handleStartSimulator() {
    return Object(servers["b" /* addServiceProvider */])(bus, hostDefinition);
  };
...
function ServiceTest(props) {
  ...
  Object(react["useEffect"])(function () {
    ...
    return service === null || service === void 0 ? void 0 : (_service$device = service.device) === null || _service$device === void 0 ? void 0 : _service$device.subscribe(constants["eb" /* DISCONNECT */], function () {
      setService(undefined);
    });
  }, [service]);
...
var GithubPullRequestButton = /*#__PURE__*/Object(react["lazy"])(function () {
  return Promise.all(/* import() */[__webpack_require__.e(6), __webpack_require__.e(93)]).then(__webpack_require__.bind(null, "ha5o"));
});
