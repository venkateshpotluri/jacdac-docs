...
function HostMicrophoneButton(props) {
  ...
  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Te" /* SoundSpectrumReg */].MinDecibels)),
      minDecibels = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Te" /* SoundSpectrumReg */].MaxDecibels)),
      maxDecibels = _useRegisterUnpackedV2[0];

  var _useRegisterUnpackedV3 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Te" /* SoundSpectrumReg */].FftPow2Size)),
      fftPow2Size = _useRegisterUnpackedV3[0];

  var fftSize = 1 << (fftPow2Size || 5);

  var _useRegisterUnpackedV4 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Te" /* SoundSpectrumReg */].SmoothingTimeConstant)),
...
function DashboardSoundSpectrum(props) {
  ...
  var frequencyBinsRegister = service.register(constants["Te" /* SoundSpectrumReg */].FrequencyBins);
...
//# sourceMappingURL=127-94b0e68c6c0be73862b1.js.map