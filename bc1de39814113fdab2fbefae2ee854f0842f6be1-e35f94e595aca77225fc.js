...
function useRegisterServer(register) {
  var server = Object(useServiceServer["a" /* default */])(register === null || register === void 0 ? void 0 : register.service);
...
function useReadingAuxilliaryValue(register, identifier, options) {
  if (identifier === void 0) {
    identifier = constants["df" /* SystemReg */].ReadingError | constants["df" /* SystemReg */].ReadingResolution | constants["df" /* SystemReg */].MaxReading | constants["df" /* SystemReg */].MinReading | constants["df" /* SystemReg */].StreamingInterval | constants["df" /* SystemReg */].StreamingPreferredInterval;
  }
...
function ValueWithUnitWidget(props) {
  ...
  var valueText = hasValue ? Object(utils["M" /* roundWithPrecision */])(value, precision).toLocaleString() : "--";
  var valueTextLength = Object(utils["C" /* isSet */])(min) && Object(utils["C" /* isSet */])(max) ? [min, max, min + (min + max) / 3].map(function (v) {
    return Object(utils["M" /* roundWithPrecision */])(v, precision).toLocaleString().replace(/[,.]/, '').length;
  }).reduce(function (l, r) {
    return Math.max(l, r);
...
function MemberInput(props) {
  ...
  var errorValue = error ? "±" + Object(utils["M" /* roundWithPrecision */])(error, 1 - Math.floor(Math.log10(error))).toLocaleString() : undefined;
  ...
  var valueLabelFormat = function valueLabelFormat(value) {
    // avoid super long floats
    return Object(utils["M" /* roundWithPrecision */])(value, 1) + (unit || "");
  };
  ...
  if (specification.type === "pipe") {
    ...
    if (isWidget) // we need min/max to support a slider
      return /*#__PURE__*/react_default.a.createElement(ValueWithUnitWidget, {
        tabIndex: 0,
        value: Object(utils["M" /* roundWithPrecision */])(value, 1),
        label: specification.unit,
        color: color,
        size: widgetSize
      });
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return useServiceServer; });
/* harmony import */ var _useServiceProvider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("vgWQ");

function useServiceServer(service) {
  var provider = Object(_useServiceProvider__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(service.device);
...
//# sourceMappingURL=bc1de39814113fdab2fbefae2ee854f0842f6be1-e35f94e595aca77225fc.js.map