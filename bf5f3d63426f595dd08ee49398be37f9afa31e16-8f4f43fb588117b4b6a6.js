...
var ProtocolTestServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function ProtocolTestServiceHost() {
    ...
    _this = _ServiceHost.call(this, _jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* SRV_PROTO_TEST */ "ce"]) || this;
...
var LEDMatrixServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function LEDMatrixServiceHost(columns, rows) {
    ...
    _this = _ServiceHost.call(this, _jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* SRV_LED_MATRIX */ "Sd"], {
    ...
    _this.addRegister(_jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* SensorReg */ "Je"].StreamingPreferredInterval, [50]);
...
var BuzzerServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function BuzzerServiceHost(options) {
    ...
    _this = _ServiceHost.call(this, _jdom_constants__WEBPACK_IMPORTED_MODULE_2__[/* SRV_BUZZER */ "Dd"], options) || this;
...
var buttonservicehost_ButtonServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function ButtonServiceHost(instanceName) {
    ...
    _this = _SensorServiceHost.call(this, constants["Cd" /* SRV_BUTTON */], {
...
var characterscreenservicehost_CharacterScreenServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function CharacterScreenServiceHost(options) {
    ...
    _this = _ServiceHost.call(this, constants["Ed" /* SRV_CHARACTER_SCREEN */]) || this;
...
var humidityservicehost_HumidityServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function HumidityServiceHost() {
    return _SensorServiceHost.call(this, constants["Od" /* SRV_HUMIDITY */], {
      readingValues: [40],
      readingError: [0.1],
...
var joystickservicehost_JoystickSensorServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function JoystickSensorServiceHost(variant, digital) {
    ...
    _this = _SensorServiceHost.call(this, constants["Qd" /* SRV_JOYSTICK */], {
      readingValues: [0, 0]
    }) || this;
...
var ledpixelservicehost_LedPixelServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function LedPixelServiceHost(options) {
    ...
    _this = _ServiceHost.call(this, constants["Td" /* SRV_LED_PIXEL */], options) || this;
...
var matrixkeypadservicehost_MatrixKeypadServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function MatrixKeypadServiceHost(columns, rows, labels) {
    ...
    _this = _SensorServiceHost.call(this, constants["Wd" /* SRV_MATRIX_KEYPAD */], {
      readingValues: [[]]
    }) || this;
...
var motorservicehost_MotorServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function MotorServiceHost(instanceName) {
    ...
    _this = _ServiceHost.call(this, constants["Zd" /* SRV_MOTOR */], {
      instanceName: instanceName
    }) || this;
...
var leveldetector_LevelDetector = /*#__PURE__*/function (_JDClient) {
  ...
  _proto.reset = function reset() {
    this._state = constants["af" /* SystemReadingThreshold */].Neutral;
  };
  ...
  _proto.update = function update() {
    ...
    if (level === undefined) {
      this.setState(constants["af" /* SystemReadingThreshold */].Neutral);
      return;
    }
    ...
    if (high !== undefined && level >= high) {
      this.setState(constants["af" /* SystemReadingThreshold */].High);
      return;
    }
    ...
    if (low !== undefined && level <= low) {
      this.setState(constants["af" /* SystemReadingThreshold */].Low);
      return;
    } // neutral
  ...
  _proto.setState = function setState(state) {
    ...
    switch (state) {
      case constants["af" /* SystemReadingThreshold */].High:
        this.service.sendEvent(constants["Ze" /* SystemEvent */].High);
        break;

      case constants["af" /* SystemReadingThreshold */].Low:
        this.service.sendEvent(constants["Ze" /* SystemEvent */].Low);
        break;

      case constants["af" /* SystemReadingThreshold */].Neutral:
        this.service.sendEvent(constants["Ze" /* SystemEvent */].Neutral);
        break;
    }
  };
...
var analogsensorservicehost_AnalogSensorServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function AnalogSensorServiceHost(serviceClass, options) {
    ...
    if (minReading !== undefined) _this.addRegister(constants["bf" /* SystemReg */].MinReading, [minReading]);
    if (maxReading !== undefined) _this.addRegister(constants["bf" /* SystemReg */].MaxReading, [maxReading]);
    if (readingResolution !== undefined) _this.addRegister(constants["bf" /* SystemReg */].ReadingResolution, [readingResolution]);

    if (lowThreshold !== undefined || _this.highThreshold !== undefined) {
      if (lowThreshold !== undefined) _this.lowThreshold = _this.addRegister(constants["bf" /* SystemReg */].LowThreshold, [lowThreshold]);
      if (highThreshold !== undefined) _this.highThreshold = _this.addRegister(constants["bf" /* SystemReg */].HighThreshold, [highThreshold]);
...
var raingaugeservicehost_RainGaugeServiceHost = /*#__PURE__*/function (_AnalogSensorServiceH) {
  ...
  function RainGaugeServiceHost(options) {
    ...
    _this = _AnalogSensorServiceH.call(this, constants["ee" /* SRV_RAIN_GAUGE */], {
      readingValues: [0]
    }) || this;
    _this._tiltCount = 0;
    _this._level = 0;
    ...
    _this.precipitationPrecision = _this.addRegister(constants["ed" /* RainGaugeReg */].PrecipitationPrecision, [bucketSize || 0.2794]);
    _this._level = 0;
    return _this;
  }
...
var reflectedlightservicehost_ReflectedLightServiceHost = /*#__PURE__*/function (_AnalogSensorServiceH) {
  ...
  function ReflectedLightServiceHost(options) {
    ...
    _this = _AnalogSensorServiceH.call(this, constants["ge" /* SRV_REFLECTED_LIGHT */], {
      readingValues: [0]
    }) || this;
    ...
    _this.variant = _this.addRegister(constants["id" /* ReflectedLightReg */].Variant, [variant || constants["jd" /* ReflectedLightVariant */].InfraredDigital]);
    return _this;
  }
...
var rotaryencoderservicehost_RotaryEncoderServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function RotaryEncoderServiceHost() {
    ...
    _this = _SensorServiceHost.call(this, constants["ke" /* SRV_ROTARY_ENCODER */], {
      readingValues: [0],
      streamingInterval: 50
    }) || this;
    _this.clicksPerTurn = _this.addRegister(constants["qd" /* RotaryEncoderReg */].ClicksPerTurn, [12]);
    return _this;
  }
...
var servoservicehost_ServoServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function ServoServiceHost(options) {
    ...
    _this = _ServiceHost.call(this, constants["me" /* SRV_SERVO */], options) || this;
    ...
    _this.angle = _this.addRegister(constants["Ke" /* ServoReg */].Angle, [0]);
    _this.enabled = _this.addRegister(constants["Ke" /* ServoReg */].Enabled, [false]);
    _this.minAngle = _this.addRegister(constants["Ke" /* ServoReg */].MinAngle, minAngle !== undefined ? [minAngle] : undefined);
    _this.maxAngle = _this.addRegister(constants["Ke" /* ServoReg */].MaxAngle, maxAngle !== undefined ? [maxAngle] : undefined);
    _this.offset = _this.addRegister(constants["Ke" /* ServoReg */].Offset, [0]);
    _this.responseSpeed = _this.addRegister(constants["Ke" /* ServoReg */].ResponseSpeed, responseSpeed !== undefined ? [responseSpeed] : undefined);
    _this.stallTorque = _this.addRegister(constants["Ke" /* ServoReg */].StallTorque, stallTorque !== undefined ? [stallTorque] : undefined);
    return _this;
  }
...
var settingsservicehost_SettingsServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function SettingsServiceHost(storageKey) {
    ...
    _this = _ServiceHost.call(this, constants["ne" /* SRV_SETTINGS */]) || this;
    _this.storageKey = storageKey;

    _this.addCommand(constants["Le" /* SettingsCmd */].Get, _this.handleGet.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Le" /* SettingsCmd */].Set, _this.handleSet.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Le" /* SettingsCmd */].Delete, _this.handleDelete.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Le" /* SettingsCmd */].ListKeys, _this.handleListKeys.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Le" /* SettingsCmd */].List, _this.handleList.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Le" /* SettingsCmd */].Clear, _this.handleClear.bind(Object(assertThisInitialized["a" /* default */])(_this)));
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              resp = packet["a" /* default */].jdpacked(constants["Le" /* SettingsCmd */].Get, "z b", [key, payload]);
              _context.next = 5;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 3;
              return this.sendEvent(constants["Me" /* SettingsEvent */].Change);
...
var speechsynthesisservicehost_SpeechSynthesisServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function SpeechSynthesisServiceHost() {
    ...
    _this = _ServiceHost.call(this, constants["ue" /* SRV_SPEECH_SYNTHESIS */]) || this;
    _this.synthesis = typeof window !== "undefined" && window.speechSynthesis;
    _this.enabled = _this.addRegister(constants["Ve" /* SpeechSynthesisReg */].Enabled, [!((_this$synthesis = _this.synthesis) !== null && _this$synthesis !== void 0 && _this$synthesis.paused)]);
    _this.pitch = _this.addRegister(constants["Ve" /* SpeechSynthesisReg */].Pitch, [1]);
    _this.rate = _this.addRegister(constants["Ve" /* SpeechSynthesisReg */].Rate, [1]);
    _this.lang = _this.addRegister(constants["Ve" /* SpeechSynthesisReg */].Lang, [""]);
    _this.volume = _this.addRegister(constants["Ve" /* SpeechSynthesisReg */].Volume, [0.5]);

    _this.addCommand(constants["Ue" /* SpeechSynthesisCmd */].Speak, _this.handleSpeak.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Ue" /* SpeechSynthesisCmd */].Cancel, _this.handleCancel.bind(Object(assertThisInitialized["a" /* default */])(_this)));
...
var switchservicehost_SwitchServiceHost = /*#__PURE__*/function (_SensorServiceHost) {
  ...
  function SwitchServiceHost(options) {
    ...
    _this = _SensorServiceHost.call(this, constants["ve" /* SRV_SWITCH */], {
      readingValues: [false],
      streamingInterval: 50
    }) || this;
    ...
    _this.variant = _this.addRegister(constants["Xe" /* SwitchReg */].Variant, variant !== undefined ? [variant] : undefined);
    _this.autoOffDelay = _this.addRegister(constants["Xe" /* SwitchReg */].AutoOffDelay, autoOffDelay !== undefined ? [autoOffDelay] : undefined);
    return _this;
  }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              this.reading.setValues([true]);
              _context2.next = 5;
              return this.sendEvent(constants["We" /* SwitchEvent */].On);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              this.reading.setValues([false]);
              _context3.next = 5;
              return this.sendEvent(constants["We" /* SwitchEvent */].Off);
...
var trafficlightservicehost_TrafficLightServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function TrafficLightServiceHost(options) {
    ...
    _this = _ServiceHost.call(this, constants["ye" /* SRV_TRAFFIC_LIGHT */], options) || this;
    _this.red = _this.addRegister(constants["if" /* TrafficLightReg */].Red, [true]);
    _this.orange = _this.addRegister(constants["if" /* TrafficLightReg */].Orange, [false]);
    _this.green = _this.addRegister(constants["if" /* TrafficLightReg */].Green, [false]);
    return _this;
  }
...
var soundplayerservicehost_SoundPlayerServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function SoundPlayerServiceHost(sounds) {
    ...
    _this = _ServiceHost.call(this, constants["se" /* SRV_SOUND_PLAYER */]) || this;
    _this.sounds = sounds;
    _this.volume = _this.addRegister(constants["Se" /* SoundPlayerReg */].Volume, [0.5]);

    _this.addCommand(constants["Re" /* SoundPlayerCmd */].ListSounds, _this.handleListSounds.bind(Object(assertThisInitialized["a" /* default */])(_this)));

    _this.addCommand(constants["Re" /* SoundPlayerCmd */].Play, _this.handlePlay.bind(Object(assertThisInitialized["a" /* default */])(_this)));
...
var randomnumbergeneratorservicehost_RandomNumberGeneratorServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function RandomNumberGeneratorServiceHost() {
    ...
    _this = _ServiceHost.call(this, constants["ie" /* SRV_RNG */], {
      variant: constants["nd" /* RngVariant */].WebCrypto
    }) || this;
    _this.reading = _this.addRegister(constants["md" /* RngReg */].Random, [new Uint8Array(64)]);

    _this.reading.on(constants["Qc" /* REGISTER_PRE_GET */], _this.handleRefresh.bind(Object(assertThisInitialized["a" /* default */])(_this)));
...
var compassservicehost_CompassServiceHost = /*#__PURE__*/function (_AnalogSensorServiceH) {
  ...
  function CompassServiceHost() {
    ...
    _this = _AnalogSensorServiceH.call(this, constants["Gd" /* SRV_COMPASS */], {
      readingValues: [0],
      minReading: 0,
      maxReading: 360,
      readingError: [1]
    ...
    _this.enabled.on(constants["v" /* CHANGE */], function () {
      ...
      if (status === constants["cf" /* SystemStatusCodes */].CalibrationNeeded) {
...
var dmxservicehost_DMXServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function DMXServiceHost() {
    ...
    _this = _ServiceHost.call(this, constants["Kd" /* SRV_DMX */], {
      intensityValues: [0]
    }) || this;
...
var bitradioservicehost_BitRadioServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function BitRadioServiceHost() {
    ...
    _this = _ServiceHost.call(this, constants["Ad" /* SRV_BIT_RADIO */]) || this;
...
var indoorThermometerOptions = {
  ...
  maxReading: 50,
  readingError: [0.25],
  variant: constants["hf" /* ThermometerVariant */].Indoor
};
var outdoorThermometerOptions = {
  ...
  maxReading: 120,
  readingError: [0.25],
  variant: constants["hf" /* ThermometerVariant */].Outdoor
};
var medicalThermometerOptions = {
  ...
  maxReading: 42,
  readingError: [0.5],
  variant: constants["hf" /* ThermometerVariant */].Body
};
...
var windSpeedOptions = {
  ...
  readingError: [0.5],
  registerValues: [{
    code: constants["of" /* WindSpeedReg */].MaxWindSpeed,
    values: [55]
  }]
};
var eCO2Options = {
...
var soundLevel = {
  ...
  registerValues: [{
    code: constants["Qe" /* SoundLevelReg */].MinDecibels,
    values: [-100]
  }, {
    code: constants["Qe" /* SoundLevelReg */].MaxDecibels,
    values: [-30]
  }]
};
var soundSpectrum = {
  ...
  intensityValues: [false],
  registerValues: [{
    code: constants["Te" /* SoundSpectrumReg */].FftPow2Size,
    values: [5]
  }, {
    code: constants["Te" /* SoundSpectrumReg */].MinDecibels,
    values: [-100]
  }, {
    code: constants["Te" /* SoundSpectrumReg */].MaxDecibels,
    values: [-30]
  }, {
    code: constants["Te" /* SoundSpectrumReg */].SmoothingTimeConstant,
    values: [0.8]
  }]
};
var _hosts = [{
  name: "7-segment (4 segments)",
  serviceClasses: [constants["oe" /* SRV_SEVEN_SEGMENT_DISPLAY */]],
  services: function services() {
    return [new servicehost["a" /* default */](constants["oe" /* SRV_SEVEN_SEGMENT_DISPLAY */], {
      intensityValues: [0xffff],
      valueValues: [Object(utils["u" /* fromHex */])("ff112233")],
      registerValues: [{
        code: constants["Ne" /* SevenSegmentDisplayReg */].DigitCount,
        values: [4]
      }, {
        code: constants["Ne" /* SevenSegmentDisplayReg */].DecimalPoint,
        values: [true]
      }]
    })];
  }
  ...
  name: "accelerometer",
  serviceClasses: [constants["wd" /* SRV_ACCELEROMETER */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["wd" /* SRV_ACCELEROMETER */], {
      readingValues: [0.5, 0.5, -(1 - (0.5 * 0.5 + 0.5 * 0.5))]
    })];
  }
}, {
  name: "arcade gamepad (all buttons)",
  serviceClasses: [constants["yd" /* SRV_ARCADE_GAMEPAD */]],
  services: function services() {
  ...
  name: "barometer",
  serviceClasses: [constants["zd" /* SRV_BAROMETER */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["zd" /* SRV_BAROMETER */], barometerOptions)];
  }
}, {
  name: "bitradio",
  serviceClasses: [constants["Ad" /* SRV_BIT_RADIO */]],
  services: function services() {
    return [new bitradioservicehost_BitRadioServiceHost()];
  }
}, {
  name: "button",
  serviceClasses: [constants["Cd" /* SRV_BUTTON */]],
  services: function services() {
  ...
  name: "buzzer",
  serviceClasses: [constants["Dd" /* SRV_BUZZER */]],
  services: function services() {
    return [new buzzerservicehost["a" /* default */]()];
  }
}, {
  name: "capacitive button",
  serviceClasses: [constants["xd" /* SRV_ANALOG_BUTTON */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["xd" /* SRV_ANALOG_BUTTON */], touchButton)];
  }
}, {
  ...
  services: function services() {
    return Array(6).fill(0).map(function (_, i) {
      return new analogsensorservicehost_AnalogSensorServiceHost(constants["xd" /* SRV_ANALOG_BUTTON */], _objectSpread(_objectSpread({}, touchButton), {
        instanceName: "C" + i
      }));
    });
  }
  ...
  serviceClasses: [constants["Ed" /* SRV_CHARACTER_SCREEN */]],
  services: function services() {
  ...
  name: "color",
  serviceClasses: [constants["Fd" /* SRV_COLOR */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Fd" /* SRV_COLOR */], {
      readingValues: [0.5, 0, 0.5]
    })];
  }
}, {
  name: "compass",
  serviceClasses: [constants["Gd" /* SRV_COMPASS */]],
  services: function services() {
    return [new compassservicehost_CompassServiceHost()];
  }
}, {
  name: "distance (sonar)",
  serviceClasses: [constants["Jd" /* SRV_DISTANCE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Jd" /* SRV_DISTANCE */], sonarOptions)];
  }
}, {
  name: "DMX",
  serviceClasses: [constants["Kd" /* SRV_DMX */]],
  services: function services() {
    return [new dmxservicehost_DMXServiceHost()];
  }
}, {
  name: "eCO₂",
  serviceClasses: [constants["Ld" /* SRV_E_CO2 */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Ld" /* SRV_E_CO2 */], eCO2Options)];
  }
}, {
  name: "eCO₂ + TVOC",
  serviceClasses: [constants["Ld" /* SRV_E_CO2 */], constants["ze" /* SRV_TVOC */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Ld" /* SRV_E_CO2 */], eCO2Options), new analogsensorservicehost_AnalogSensorServiceHost(constants["ze" /* SRV_TVOC */], tvocOptions)];
  }
}, {
  name: "eCO₂ + humidity + thermometer",
  serviceClasses: [constants["Ld" /* SRV_E_CO2 */], constants["Od" /* SRV_HUMIDITY */], constants["xe" /* SRV_THERMOMETER */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Ld" /* SRV_E_CO2 */], CO2Options), new humidityservicehost_HumidityServiceHost(), new analogsensorservicehost_AnalogSensorServiceHost(constants["xe" /* SRV_THERMOMETER */], indoorThermometerOptions)];
  }
}, {
  name: "gyroscope",
  serviceClasses: [constants["Md" /* SRV_GYROSCOPE */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Md" /* SRV_GYROSCOPE */], {
      readingValues: [0, 0, 0]
    })];
  }
}, {
  name: "heart rate",
  serviceClasses: [constants["Nd" /* SRV_HEART_RATE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Nd" /* SRV_HEART_RATE */], {
      readingValues: [80],
  ...
  name: "humidity",
  serviceClasses: [constants["Od" /* SRV_HUMIDITY */]],
  services: function services() {
    return [new humidityservicehost_HumidityServiceHost()];
  }
}, {
  name: "humidity + temperature",
  serviceClasses: [constants["Od" /* SRV_HUMIDITY */], constants["xe" /* SRV_THERMOMETER */]],
  services: function services() {
    return [new humidityservicehost_HumidityServiceHost(), new analogsensorservicehost_AnalogSensorServiceHost(constants["xe" /* SRV_THERMOMETER */], outdoorThermometerOptions)];
  }
}, {
  name: "humidity + temperature + barometer",
  serviceClasses: [constants["Od" /* SRV_HUMIDITY */], constants["xe" /* SRV_THERMOMETER */], constants["zd" /* SRV_BAROMETER */]],
  services: function services() {
    return [new humidityservicehost_HumidityServiceHost(), new analogsensorservicehost_AnalogSensorServiceHost(constants["xe" /* SRV_THERMOMETER */], outdoorThermometerOptions), new analogsensorservicehost_AnalogSensorServiceHost(constants["zd" /* SRV_BAROMETER */], barometerOptions)];
  }
}, {
  name: "illuminance",
  serviceClasses: [constants["Pd" /* SRV_ILLUMINANCE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Pd" /* SRV_ILLUMINANCE */], {
      readingValues: [1]
    })];
  }
}, {
  name: "joystick (thumbstick)",
  serviceClasses: [constants["Qd" /* SRV_JOYSTICK */]],
  services: function services() {
  ...
  serviceClasses: [constants["Sd" /* SRV_LED_MATRIX */]],
  services: function services() {
  ...
  serviceClasses: [constants["Td" /* SRV_LED_PIXEL */]],
  services: function services() {
  ...
  serviceClasses: [constants["Ud" /* SRV_LIGHT_LEVEL */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Ud" /* SRV_LIGHT_LEVEL */], {
      readingValues: [0.5],
  ...
  serviceClasses: [constants["ge" /* SRV_REFLECTED_LIGHT */]],
  services: function services() {
  ...
  services: function services() {
    return [new reflectedlightservicehost_ReflectedLightServiceHost({
      variant: constants["jd" /* ReflectedLightVariant */].InfraredAnalog
    })];
  }
}, {
  name: "matrix keypad (3x4)",
  serviceClasses: [constants["Wd" /* SRV_MATRIX_KEYPAD */]],
  services: function services() {
  ...
  name: "motion",
  serviceClasses: [constants["Yd" /* SRV_MOTION */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["Yd" /* SRV_MOTION */], {
      readingValues: [false]
    })];
  }
}, {
  name: "motor",
  serviceClasses: [constants["Zd" /* SRV_MOTOR */]],
  services: function services() {
    return [new motorservicehost_MotorServiceHost()];
  }
}, {
  name: "protocol test",
  serviceClasses: [constants["ce" /* SRV_PROTO_TEST */]],
  services: function services() {
    return [new protocoltestservicehost["a" /* default */]()];
  }
}, {
  name: "pulse oxymeter",
  serviceClasses: [constants["de" /* SRV_PULSE_OXIMETER */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["de" /* SRV_PULSE_OXIMETER */], {
      readingValues: [98]
    })];
  }
}, {
  name: "oxymeter + heart beat",
  serviceClasses: [constants["de" /* SRV_PULSE_OXIMETER */], constants["Nd" /* SRV_HEART_RATE */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["de" /* SRV_PULSE_OXIMETER */], {
      readingValues: [98]
    }), new analogsensorservicehost_AnalogSensorServiceHost(constants["Nd" /* SRV_HEART_RATE */], {
      readingValues: [80],
      variant: constants["ub" /* HeartRateVariant */].Finger
    })];
  }
  ...
  serviceClasses: [constants["ie" /* SRV_RNG */]],
  services: function services() {
    return [new randomnumbergeneratorservicehost_RandomNumberGeneratorServiceHost()];
  }
}, {
  name: "rain gauge",
  serviceClasses: [constants["ee" /* SRV_RAIN_GAUGE */]],
  services: function services() {
    return [new raingaugeservicehost_RainGaugeServiceHost()];
  }
}, {
  name: "real time clock",
  serviceClasses: [constants["fe" /* SRV_REAL_TIME_CLOCK */]],
  services: function services() {
    return [new realtimeclockservicehost["a" /* default */]()];
  }
}, {
  name: "relay (EM/10A)",
  serviceClasses: [constants["he" /* SRV_RELAY */]],
  services: function services() {
    return [new servicehost["a" /* default */](constants["he" /* SRV_RELAY */], {
      intensityValues: [false],
      variant: constants["ld" /* RelayVariant */].Electromechanical,
      registerValues: [{
        code: constants["kd" /* RelayReg */].MaxSwitchingCurrent,
        values: [10]
      }]
    })];
  }
  ...
  services: function services() {
    return Array(4).fill(0).map(function () {
      return new servicehost["a" /* default */](constants["he" /* SRV_RELAY */], {
        intensityValues: [false],
        variant: constants["ld" /* RelayVariant */].SolidState,
        registerValues: [{
          code: constants["kd" /* RelayReg */].MaxSwitchingCurrent,
          values: [5]
        }]
  ...
  name: "rotary encoder",
  serviceClasses: [constants["ke" /* SRV_ROTARY_ENCODER */]],
  services: function services() {
    return [new rotaryencoderservicehost_RotaryEncoderServiceHost()];
  }
}, {
  name: "rotary encoder + button",
  serviceClasses: [constants["ke" /* SRV_ROTARY_ENCODER */], constants["Cd" /* SRV_BUTTON */]],
  services: function services() {
  ...
  serviceClasses: [constants["ae" /* SRV_POTENTIOMETER */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ae" /* SRV_POTENTIOMETER */], {
  ...
  name: "servo",
  serviceClasses: [constants["me" /* SRV_SERVO */]],
  services: function services() {
  ...
  name: "settings",
  serviceClasses: [constants["ne" /* SRV_SETTINGS */]],
  services: function services() {
  ...
  name: "soil moisture",
  serviceClasses: [constants["pe" /* SRV_SOIL_MOISTURE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["pe" /* SRV_SOIL_MOISTURE */], {
      readingValues: [0.5]
    })];
  }
}, {
  name: "speech synthesis",
  serviceClasses: [constants["ue" /* SRV_SPEECH_SYNTHESIS */]],
  services: function services() {
    return [new speechsynthesisservicehost_SpeechSynthesisServiceHost()];
  }
}, {
  name: "solenoid",
  serviceClasses: [constants["qe" /* SRV_SOLENOID */]],
  services: function services() {
    return [new servicehost["a" /* default */](constants["qe" /* SRV_SOLENOID */], {
      intensityValues: [0]
    })];
  }
}, {
  name: "sound level",
  serviceClasses: [constants["re" /* SRV_SOUND_LEVEL */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["re" /* SRV_SOUND_LEVEL */], soundLevel)];
  }
}, {
  name: "sound spectrum",
  serviceClasses: [constants["te" /* SRV_SOUND_SPECTRUM */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["te" /* SRV_SOUND_SPECTRUM */], soundSpectrum)];
  }
}, {
  name: "sound player (micro:bit v2 sounds)",
  serviceClasses: [constants["se" /* SRV_SOUND_PLAYER */]],
  services: function services() {
    return [new soundplayerservicehost_SoundPlayerServiceHost(microbitSounds)];
  }
}, {
  name: "switch (slide)",
  serviceClasses: [constants["ve" /* SRV_SWITCH */]],
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Ye" /* SwitchVariant */].Slide
    })];
  }
}, {
  ...
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Ye" /* SwitchVariant */].PushButton
    })];
  }
}, {
  name: "switch (toggle)",
  ...
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Ye" /* SwitchVariant */].Toggle
    })];
  }
}, {
  name: "switch (tilt)",
  ...
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Ye" /* SwitchVariant */].Tilt
    })];
  }
}, {
  ...
  services: function services() {
    return [new switchservicehost_SwitchServiceHost({
      variant: constants["Ye" /* SwitchVariant */].Proximity,
      autoOffDelay: 30
    })];
  }
}, {
  name: "thermometer (outdoor)",
  serviceClasses: [constants["xe" /* SRV_THERMOMETER */]],
  services: function services() {
    return [new sensorservicehost["a" /* default */](constants["xe" /* SRV_THERMOMETER */], outdoorThermometerOptions)];
  }
}, {
  name: "thermometer (medical)",
  serviceClasses: [constants["xe" /* SRV_THERMOMETER */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["xe" /* SRV_THERMOMETER */], medicalThermometerOptions)];
  }
}, {
  name: "traffic light",
  serviceClasses: [constants["ye" /* SRV_TRAFFIC_LIGHT */]],
  services: function services() {
  ...
  name: "thermocouple",
  serviceClasses: [constants["we" /* SRV_THERMOCOUPLE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["we" /* SRV_THERMOCOUPLE */], {
      readingValues: [550],
      streamingInterval: 1000,
      minReading: 0,
      maxReading: 1100,
      readingError: [2.2],
      variant: constants["gf" /* ThermocoupleVariant */].TypeB
    })];
  }
}, {
  name: "TVOC",
  serviceClasses: [constants["ze" /* SRV_TVOC */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["ze" /* SRV_TVOC */], tvocOptions)];
  }
}, {
  name: "UV index",
  serviceClasses: [constants["Ae" /* SRV_UV_INDEX */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Ae" /* SRV_UV_INDEX */], {
      readingValues: [5]
    })];
  }
}, {
  name: "water level",
  serviceClasses: [constants["Ce" /* SRV_WATER_LEVEL */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Ce" /* SRV_WATER_LEVEL */], {
      readingValues: [0.5]
    })];
  }
}, {
  name: "weight scale (jewelry)",
  serviceClasses: [constants["De" /* SRV_WEIGHT_SCALE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["De" /* SRV_WEIGHT_SCALE */], {
      readingValues: [0.001],
      variant: constants["mf" /* WeightScaleVariant */].Jewelry,
      maxReading: 0.2,
      minReading: 0.0005,
  ...
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["De" /* SRV_WEIGHT_SCALE */], {
      readingValues: [60],
      variant: constants["mf" /* WeightScaleVariant */].Body,
      maxReading: 180,
  ...
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["De" /* SRV_WEIGHT_SCALE */], {
      readingValues: [0.5],
      variant: constants["mf" /* WeightScaleVariant */].Food,
      maxReading: 6,
  ...
  name: "wind direction",
  serviceClasses: [constants["Ee" /* SRV_WIND_DIRECTION */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Ee" /* SRV_WIND_DIRECTION */], windDirectionOptions)];
  }
}, {
  name: "wind speed",
  serviceClasses: [constants["Fe" /* SRV_WIND_SPEED */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Fe" /* SRV_WIND_SPEED */], windSpeedOptions)];
  }
}, {
  name: "weather station (wind speed, direction, rain)",
  serviceClasses: [constants["Fe" /* SRV_WIND_SPEED */], constants["Ee" /* SRV_WIND_DIRECTION */], constants["ee" /* SRV_RAIN_GAUGE */]],
  services: function services() {
    return [new analogsensorservicehost_AnalogSensorServiceHost(constants["Fe" /* SRV_WIND_SPEED */], windSpeedOptions), new analogsensorservicehost_AnalogSensorServiceHost(constants["Ee" /* SRV_WIND_DIRECTION */], windDirectionOptions), new raingaugeservicehost_RainGaugeServiceHost()];
  }
}, {
  name: "vibration motor",
  serviceClasses: [constants["Be" /* SRV_VIBRATION_MOTOR */]],
  services: function services() {
    return [new servicehost["a" /* default */](constants["Be" /* SRV_VIBRATION_MOTOR */])];
  }
}, {
  name: "chassis (motor x 2 + sonar + light)",
  serviceClasses: [constants["Jd" /* SRV_DISTANCE */], constants["Td" /* SRV_LED_PIXEL */], constants["Zd" /* SRV_MOTOR */]],
  services: function services() {
    return [new motorservicehost_MotorServiceHost("L"), new motorservicehost_MotorServiceHost("R"), new analogsensorservicehost_AnalogSensorServiceHost(constants["Jd" /* SRV_DISTANCE */], sonarOptions), new ledpixelservicehost_LedPixelServiceHost({
      numPixels: 5,
      variant: constants["Sb" /* LedPixelVariant */].Stick,
      instanceName: "lights"
    })];
  ...
  serviceClasses: [constants["ye" /* SRV_TRAFFIC_LIGHT */], constants["me" /* SRV_SERVO */], constants["Dd" /* SRV_BUZZER */]],
  services: function services() {
    return [new trafficlightservicehost_TrafficLightServiceHost({
  ...
  name: "micro:bit v2",
  serviceClasses: [constants["Sd" /* SRV_LED_MATRIX */], constants["Cd" /* SRV_BUTTON */], constants["wd" /* SRV_ACCELEROMETER */], constants["re" /* SRV_SOUND_LEVEL */], constants["Ud" /* SRV_LIGHT_LEVEL */], constants["Dd" /* SRV_BUZZER */], constants["se" /* SRV_SOUND_PLAYER */]],
  services: function services() {
    return [new ledmatrixservicehost["a" /* default */](5, 5), new buttonservicehost_ButtonServiceHost("A"), new buttonservicehost_ButtonServiceHost("B"), new sensorservicehost["a" /* default */](constants["wd" /* SRV_ACCELEROMETER */], {
      readingValues: [0.5, 0.5, -(1 - (0.5 * 0.5 + 0.5 * 0.5))]
    }), new analogsensorservicehost_AnalogSensorServiceHost(constants["re" /* SRV_SOUND_LEVEL */], soundLevel), new sensorservicehost["a" /* default */](constants["Ud" /* SRV_LIGHT_LEVEL */], {
      readingValues: [0.5],
...
//# sourceMappingURL=bf5f3d63426f595dd08ee49398be37f9afa31e16-8f4f43fb588117b4b6a6.js.map