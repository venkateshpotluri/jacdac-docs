...
var buttonLabels = (_buttonLabels = {}, _buttonLabels[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"].Left] = "\u25C0", _buttonLabels[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"].Up] = "\u25B2", _buttonLabels[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"].Down] = "\u25BC", _buttonLabels[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"].Right] = "\u25B6", _buttonLabels);
...
function ArcadeButton(props) {
  ...
  var title = _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"][button];
  ...
  var buttonProps = Object(_hooks_useSvgButtonProps__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"])(title, handleDown, handleUp);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("g", {
    ...
    r: ro,
    fill: background
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("circle", Object.assign({
    cx: 0,
    cy: 0,
    r: ri,
    fill: checked ? active : controlBackground
  }, buttonProps), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("title", null, title)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("text", Object.assign({
    cx: 0,
    cy: 0,
    fontSize: ri
  }, textProps), label));
...
function DashboardArcadeGamepad(props) {
  ...
  var _useRegisterUnpackedV = Object(_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_5__[/* useRegisterUnpackedValue */ "e"])(service.register(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadReg */ "h"].AvailableButtons)),
      available = _useRegisterUnpackedV[0];

  var pressedRegister = service.register(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadReg */ "h"].Buttons);

  var _useRegisterUnpackedV2 = Object(_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_5__[/* useRegisterUnpackedValue */ "e"])(pressedRegister),
  ...
  var _useWidgetTheme2 = Object(_widgets_useWidgetTheme__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(color),
      background = _useWidgetTheme2.background;

  if (!(available !== null && available !== void 0 && available.length)) return null;
  var w = 256;
  var h = 128;
  var cw = w / 12;
  var ch = h / 4;
  ...
  var sri = sro - 2;
  var scy = sro;
  var pos = (_pos = {}, _pos[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"].Left] = {
    cx: cw * 1.5,
    cy: 2 * ch,
    small: false
  }, _pos[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"].Up] = {
    cx: cw * 3,
    cy: ch,
    small: false
  }, _pos[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"].Right] = {
    cx: cw * 4.5,
    cy: 2 * ch,
    small: false
  }, _pos[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"].Down] = {
    cx: cw * 3,
    cy: 3 * ch,
    small: false
  }, _pos[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"].A] = {
    cx: cw * 10.5,
    cy: ch * 1.25,
    small: false
  }, _pos[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"].B] = {
    cx: cw * 9.5,
    cy: ch * 2.75,
    small: false
  }, _pos[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"].Menu] = {
    cx: cw * 7,
    cy: scy,
    small: true
  }, _pos[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"].Select] = {
    cx: cw * 6,
    cy: scy,
    small: true
  }, _pos[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"].Exit] = {
    cx: cw * 8,
    cy: scy,
    small: true
  }, _pos[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* ArcadeGamepadButton */ "g"].Reset] = {
    cx: cw * 9,
    cy: scy,
    small: true
  }, _pos);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_widgets_SvgWidget__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], {
    ...
    var button = _ref2.button,
        pos = _ref2.pos;
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(ArcadeButton, {
      key: button,
      cx: pos.cx,
      cy: pos.cy,
      ro: pos.small ? sro : ro,
...
//# sourceMappingURL=65-4c5402c05369193433d1.js.map