...
function WorkspaceProvider(props) {
  ...
  (0,react.useEffect)(function () {
    ...
    return roleManager === null || roleManager === void 0 ? void 0 : roleManager.subscribe(constants/* CHANGE */.Ver, function () {
              ...
              case "register_set":
                {
                  ...
                  command = {
                    type: "CallExpression",
                    arguments: [(0,ir/* toMemberExpression */.vf)(role, register.name), val],
