...
function useFirmwareRepos(showAllRepos) {
  ...
  var bootloaders = devices.filter(function (device) {
    return device === null || device === void 0 ? void 0 : device.hasService(constants["ud" /* SRV_BOOTLOADER */]);
  });
  var registers = devices.filter(function (device) {
    return !(device !== null && device !== void 0 && device.hasService(constants["ud" /* SRV_BOOTLOADER */]));
  }) // not a bootloader
  .map(function (device) {
    var _device$service;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 16:
              ...
              boot = bootloader.services({
                serviceClass: constants["ud" /* SRV_BOOTLOADER */]
              })[0];
...
function UpdateDeviceList() {
  ...
  var devices = Object(useDevices["a" /* default */])({
    ...
    return safeBoot || !dev.hasService(constants["ud" /* SRV_BOOTLOADER */]);
  });
...
//# sourceMappingURL=component---src-pages-tools-updater-tsx-54d3850e376ee4c8a4b2.js.map