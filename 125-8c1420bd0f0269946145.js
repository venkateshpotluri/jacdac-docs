...
function DashboardSolenoid(props) {
  ...
  var pulledRegister = service.register(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* SolenoidReg */ "Oe"].Pulled);
  ...
  var onToggle = function onToggle(ev) {
    ...
    host === null || host === void 0 ? void 0 : (_host$register = host.register(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* SolenoidReg */ "Oe"].Pulled)) === null || _host$register === void 0 ? void 0 : _host$register.setValues([!pulled ? 1 : 0]);
...
//# sourceMappingURL=125-8c1420bd0f0269946145.js.map