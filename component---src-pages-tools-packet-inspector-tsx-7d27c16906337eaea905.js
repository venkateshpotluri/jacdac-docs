...
function PacketListItem(props) {
  ...
  var logMessage = packet.serviceClass === _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_13__[/* SRV_LOGGER */ "Qd"] && packet.isReport && packet.isEvent;
  var pipePackets = packet.meta[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_13__[/* META_PIPE */ "Zb"]];
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], {
    ...
    action: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, hostDefinition && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], {
      ...
      avatar: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_KindIcon__WEBPACK_IMPORTED_MODULE_14__[/* default */ "b"], {
        kind: _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_15__[/* VIRTUAL_DEVICE_NODE_NAME */ "ff"]
      }),
...
function PacketBadge(props) {
  ...
  var failedAck = !!packet.meta[constants["Xb" /* META_ACK_FAILED */]];
  var receivedAck = !failedAck && !!packet.meta[constants["Wb" /* META_ACK */]];
  var getPacket = !!packet.meta[constants["Yb" /* META_GET */]];
...
function PacketHeaderLayout(props) {
  ...
  var slots = [{
    ...
    size: 1,
    name: 'service_number',
    know: (_know = {}, _know[constants["Gb" /* JD_SERVICE_INDEX_PIPE */].toString(16)] = "pipe", _know[constants["Cb" /* JD_SERVICE_INDEX_CRC_ACK */].toString(16)] = "crc ack", _know),
  ...
  var flags = [{
    position: 1,
    flag: constants["yb" /* JD_FRAME_FLAG_COMMAND */],
    name: "COMMAND",
    ...
    position: 2,
    flag: constants["xb" /* JD_FRAME_FLAG_ACK_REQUESTED */],
    name: "ACK_REQUESTED",
    ...
    position: 4,
    flag: constants["zb" /* JD_FRAME_FLAG_IDENTIFIER_IS_SERVICE_CLASS */],
...
function PacketInspector() {
  ...
  var decoded = packet.decoded;
  var info = decoded === null || decoded === void 0 ? void 0 : decoded.info;
  var ack = packet.meta[constants["Wb" /* META_ACK */]];
  var pipePackets = packet.meta[constants["Zb" /* META_PIPE */]];
  var get = packet.meta[constants["Yb" /* META_GET */]];
...
//# sourceMappingURL=component---src-pages-tools-packet-inspector-tsx-7d27c16906337eaea905.js.map