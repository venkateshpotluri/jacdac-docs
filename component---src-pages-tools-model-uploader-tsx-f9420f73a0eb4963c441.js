      ...
      return regenerator_default.a.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 4:
              _context4.next = 6;
              return Object(utils["J" /* readBlobToUint8Array */])(blob);
    ...
    return regenerator_default.a.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 4:
            _context5.next = 6;
            return Object(utils["I" /* readBlobToText */])(blob);
...
function isMLModelSupported(model, formatRegValue) {
  return utils["H" /* read32 */](model, 0) == formatRegValue || utils["H" /* read32 */](model, 4) == formatRegValue;
}
function getMLModelFormatName(model) {
  var map = Object(spec["D" /* serviceSpecificationFromClassIdentifier */])(constants["Yd" /* SRV_MODEL_RUNNER */]).enums["ModelFormat"].members;
  var m0 = utils["H" /* read32 */](model, 0);
  var m1 = utils["H" /* read32 */](model, 4);
  ...
  return "0x" + utils["U" /* toHex */](model.slice(0, 8));
}
var modelrunner_ModelRunnerClient = /*#__PURE__*/function (_JDServiceClient) {
    ...
    var _isModelSupported = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee(model) {
      ...
      return regenerator_default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              reg = this.service.register(constants["gc" /* ModelRunnerReg */].Format);
              _context.next = 3;
              return reg.refresh();
  ...
  _proto.subscribeResults = function subscribeResults(handler) {
    var reg = this.service.register(constants["gc" /* ModelRunnerReg */].Outputs);
    return reg.subscribe(constants["Yc" /* REPORT_RECEIVE */], function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.service.sendCmdAwaitResponseAsync(packet["a" /* default */].jdpacked(constants["fc" /* ModelRunnerCmd */].SetModel, "u32", [model.length]), 3000);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return this.service.register(constants["gc" /* ModelRunnerReg */].AutoInvokeEvery).sendSetPackedAsync("u16", [everySamples]);
      ...
      return regenerator_default.a.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              info = {
                "modelSize": this.getReg(constants["gc" /* ModelRunnerReg */].ModelSize, function (r) {
                  return r.intValue;
                }),
                "arenaSize": this.getReg(constants["gc" /* ModelRunnerReg */].AllocatedArenaSize, function (r) {
                  return r.intValue;
                }),
                "inputShape": this.getReg(constants["gc" /* ModelRunnerReg */].InputShape, function (r) {
                  return Object(buffer["b" /* bufferToArray */])(r.data, buffer["a" /* NumberFormat */].UInt16LE);
                }),
                "outputShape": this.getReg(constants["gc" /* ModelRunnerReg */].OutputShape, function (r) {
                  return Object(buffer["b" /* bufferToArray */])(r.data, buffer["a" /* NumberFormat */].UInt16LE);
                }),
                "lastError": this.getReg(constants["gc" /* ModelRunnerReg */].LastError, function (r) {
                  return utils["W" /* uint8ArrayToString */](r.data);
                })
              };
...
var ImportButton = /*#__PURE__*/Object(react["lazy"])(function () {
  return Promise.all(/* import() */[__webpack_require__.e(15), __webpack_require__.e(26)]).then(__webpack_require__.bind(null, "/MSm"));
});
function ModelContent(props) {
  var service = props.service;
  var modelSize = Object(useRegisterValue["c" /* useRegisterIntValue */])(service.register(constants["gc" /* ModelRunnerReg */].ModelSize));
  var lastError = Object(useRegisterValue["d" /* useRegisterStringValue */])(service.register(constants["gc" /* ModelRunnerReg */].LastError));
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, lastError && /*#__PURE__*/react_default.a.createElement(Alert["a" /* default */], {
    ...
    register: service.register(constants["gc" /* ModelRunnerReg */].AutoInvokeEvery)
  }), /*#__PURE__*/react_default.a.createElement(RegisterTrend["a" /* default */], {
    showName: true,
    register: service.register(constants["gc" /* ModelRunnerReg */].Outputs),
    mini: true
  }));
}
...
function ModelUploader() {
  ...
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement("h1", null, "Model uploader"), /*#__PURE__*/react_default.a.createElement("p", null, "Upload Machine Learning Models (like TensorFlow Lite) into your ", /*#__PURE__*/react_default.a.createElement(Link, {
    ...
    serviceClass: constants["Yd" /* SRV_MODEL_RUNNER */]
    ...
    actions: function actions(service) {
      ...
      return /*#__PURE__*/react_default.a.createElement(ModelActions, {
        ...
        sensorAggregatorService: service === null || service === void 0 ? void 0 : (_service$device$servi = service.device.services({
          serviceClass: constants["me" /* SRV_SENSOR_AGGREGATOR */]
...
//# sourceMappingURL=component---src-pages-tools-model-uploader-tsx-f9420f73a0eb4963c441.js.map