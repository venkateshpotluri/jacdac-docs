(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[54,93],{
...
/* harmony import */ var _components_devices_useDeviceName__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__("mAuX");
...
var EdgeImpulseClient = /*#__PURE__*/function (_JDClient) {
  ...
  function EdgeImpulseClient(apiKey, aggregator, inputRegisters, palette) {
    ...
    _this.connectionState = _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* DISCONNECT */ "gb"];
  ...
  _proto.disconnect = function disconnect() {
    ...
    if (this._ws) {
      ...
      try {
        ...
        this.setConnectionState(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* DISCONNECT */ "gb"]);
      }
    }
  };
  ...
  _proto.setConnectionState = function setConnectionState(state) {
    if (this.connectionState !== state) {
      ...
      this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* CONNECTION_STATE */ "J"], this.connectionState);
  ...
  _proto.setSamplingState = function setSamplingState(state) {
    if (this.samplingState !== state) {
      ...
      this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* CHANGE */ "v"]);
  ...
  _proto.handleMessage = function handleMessage(msg) {
    ...
    if (data.hello !== undefined) {
      ...
      if (!hello.hello) {
        this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* ERROR */ "lb"], hello.err);
        this.disconnect();
      } else {
        this.setConnectionState(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* CONNECT */ "H"]);
      }
    } else if (data.sample) {
  ...
  _proto.handleReport = function handleReport(row) {
    ...
    if (this.samplingState == SAMPLING) {
      var ds = this.dataSet;
      ds.addRow(row);
      this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* REPORT_RECEIVE */ "Yc"]); // debounced progress update

      if (timestamp - this._sample.lastProgressTimestamp > 100) {
        this._sample.lastProgressTimestamp = timestamp;
        this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* PROGRESS */ "Dc"], this.progress);
      }
      ...
      if (timestamp - this._sample.startTimestamp >= this._sample.length) {
        ...
        this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* PROGRESS */ "Dc"], this.progress); // and upload...
  ...
  _proto.handleError = function handleError(ev) {
    this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* ERROR */ "lb"], ev);
    this.reconnect();
  };
  ...
  _proto.connect = function connect() {
    ...
    this.setConnectionState(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* CONNECTING */ "I"]);
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(EdgeImpulseClient, [{
    ...
    key: "connected",
    get: function get() {
      return this.connectionState === _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* CONNECT */ "H"];
    }
  }, {
    key: "sampling",
    get: function get() {
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            ...
            case 8:
              res = _context10.sent;
              _context10.next = 11;
              return Object(_jacdac_ts_src_jdom_utils__WEBPACK_IMPORTED_MODULE_37__[/* readBlobToUint8Array */ "J"])(res);
...
function Acquisition(props) {
  ...
  var _useState6 = Object(react__WEBPACK_IMPORTED_MODULE_7__["useState"])(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* DISCONNECT */ "gb"]),
  ...
  var deviceName = Object(_components_devices_useDeviceName__WEBPACK_IMPORTED_MODULE_38__[/* default */ "a"])(device, false);
  ...
  var connected = connectionState === _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* CONNECT */ "H"];
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_7__["useEffect"])(function () {
    return client === null || client === void 0 ? void 0 : client.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* CONNECTION_STATE */ "J"], function (v) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_7__["useEffect"])(function () {
    return client === null || client === void 0 ? void 0 : client.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* ERROR */ "lb"], function (e) {
      return setError(e);
    });
  }, [client]); // progress

  Object(react__WEBPACK_IMPORTED_MODULE_7__["useEffect"])(function () {
    return client === null || client === void 0 ? void 0 : client.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* PROGRESS */ "Dc"], function (p) {
...
function EdgeImpulse() {
  ...
  var aggregators = Object(_jacdac_useChange__WEBPACK_IMPORTED_MODULE_23__[/* default */ "a"])(bus, function (bus) {
    return bus.services({
      serviceClass: _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* SRV_SENSOR_AGGREGATOR */ "me"]
    });
  });
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_7___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("h1", null, "Edge Impulse"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("p", null, "Use Jacdac to inject data and download models into", " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(gatsby_theme_material_ui__WEBPACK_IMPORTED_MODULE_20__["Link"], {
    ...
    serviceClass: _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* SRV_MODEL_RUNNER */ "Yd"],
...
//# sourceMappingURL=component---src-pages-tools-edge-impulse-tsx-0c3d3313209ac92962ba.js.map