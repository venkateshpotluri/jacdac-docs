...
function PacketListItem(props) {
  ...
  var pipePackets = packet.meta[_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_13__[/* META_PIPE */ "cc"]];
...
/* harmony import */ var _jacdac_ts_src_servers_servers__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("qOLY");
...
function ServiceSpecificationCard(props) {
  ...
  var hostDefinition = Object(_jacdac_ts_src_servers_servers__WEBPACK_IMPORTED_MODULE_12__[/* serviceProviderDefinitionFromServiceClass */ "d"])(sc);

  var handleSimulatorClick = function handleSimulatorClick() {
    Object(_jacdac_ts_src_servers_servers__WEBPACK_IMPORTED_MODULE_12__[/* addServiceProvider */ "b"])(bus, hostDefinition);
...
function PacketBadge(props) {
  ...
  var failedAck = !!packet.meta[constants["ac" /* META_ACK_FAILED */]];
...
function PacketHeaderLayout(props) {
  ...
  var slots = [{
    ...
    size: 1,
    name: "service_number",
    know: (_know = {}, _know[constants["Ib" /* JD_SERVICE_INDEX_PIPE */].toString(16)] = "pipe", _know[constants["Eb" /* JD_SERVICE_INDEX_CRC_ACK */].toString(16)] = "crc ack", _know),
  ...
  var flags = [{
    position: 1,
    flag: constants["Ab" /* JD_FRAME_FLAG_COMMAND */],
    name: "COMMAND",
    ...
    position: 2,
    flag: constants["zb" /* JD_FRAME_FLAG_ACK_REQUESTED */],
    name: "ACK_REQUESTED",
    ...
    position: 4,
    flag: constants["Bb" /* JD_FRAME_FLAG_IDENTIFIER_IS_SERVICE_CLASS */],
  ...
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement(PaperBox["a" /* default */], {
    ...
    return /*#__PURE__*/react_default.a.createElement(Box["a" /* default */], {
      ...
      title: slot.name
    }, /*#__PURE__*/react_default.a.createElement("span", null, Object(utils["W" /* toHex */])(header.slice(slot.offset, slot.offset + slot.size)))));
...
function PacketDataLayout(props) {
  ...
  }, /*#__PURE__*/react_default.a.createElement("pre", null, Object(utils["W" /* toHex */])(data)))), showDecoded && !!(decoded !== null && decoded !== void 0 && decoded.decoded.length) && /*#__PURE__*/react_default.a.createElement(PaperBox["a" /* default */], null, /*#__PURE__*/react_default.a.createElement(TableContainer["a" /* default */], null, /*#__PURE__*/react_default.a.createElement(Table["a" /* default */], {
    size: "small"
...
function PacketInspector() {
  ...
  var decoded = packet.decoded;
  var info = decoded === null || decoded === void 0 ? void 0 : decoded.info;
  var ack = packet.meta[constants["Zb" /* META_ACK */]];
  var pipePackets = packet.meta[constants["cc" /* META_PIPE */]];
  var get = packet.meta[constants["bc" /* META_GET */]];
...
//# sourceMappingURL=component---src-pages-tools-packet-inspector-tsx-3dab4b699373da295aaa.js.map