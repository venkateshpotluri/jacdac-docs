...
/* harmony import */ var _hooks_useServiceHost__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("asyI");
/* harmony import */ var _widgets_useWidgetSize__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("soIx");
/* harmony import */ var _hooks_useSvgButtonProps__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("jwKE");
/* harmony import */ var _hooks_useKeyboardNavigationProps__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("DbiO");
...
function TrafficLight(props) {
  var cx = props.cx,
      ...
      label = props.label,
      onDown = props.onDown;
  var buttonProps = Object(_hooks_useSvgButtonProps__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(label, onDown);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("circle", {
    cx: cx,
    cy: cy,
    r: r,
    fill: background,
...
function DashboardTrafficLight(props) {
  ...
  var widgetRef = Object(react__WEBPACK_IMPORTED_MODULE_3__["useRef"])();

  var _useRegisterUnpackedV = Object(_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_5__[/* useRegisterUnpackedValue */ "e"])(service.register(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* TrafficLightReg */ "af"].Red)),
      red = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_5__[/* useRegisterUnpackedValue */ "e"])(service.register(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* TrafficLightReg */ "af"].Orange)),
      orange = _useRegisterUnpackedV2[0];

  var _useRegisterUnpackedV3 = Object(_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_5__[/* useRegisterUnpackedValue */ "e"])(service.register(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* TrafficLightReg */ "af"].Green)),
      green = _useRegisterUnpackedV3[0];

  var lightRegs = [_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* TrafficLightReg */ "af"].Red, _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* TrafficLightReg */ "af"].Orange, _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* TrafficLightReg */ "af"].Green];
  var lights = [red, orange, green];
  var host = Object(_hooks_useServiceHost__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(service);
  ...
  var widgetSize = Object(_widgets_useWidgetSize__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"])(variant, services.length);
  var cy = 0;
  var names = ["red", "yellow", "green"];
  var colors = ["red", "orange", "green"];
  var navProps = Object(_hooks_useKeyboardNavigationProps__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(widgetRef.current);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_widgets_SvgWidget__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], {
    ...
    height: h,
    size: widgetSize
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("g", Object.assign({
    ref: widgetRef
  }, navProps), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("rect", {
    x: 0,
    y: 0,
    width: w,
    height: h,
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(TrafficLight, {
      key: i,
      cx: cx,
      cy: cy,
...
//# sourceMappingURL=62-cefd6b8cbbce21773b35.js.map