...
var rolemanagerclient_RoleManagerClient = /*#__PURE__*/function (_JDServiceClient) {
  ...
  function RoleManagerClient(service) {
    ...
    _this.mount(_this.bus.subscribe(constants["W" /* DEVICE_CHANGE */], Object(utils["q" /* debounceAsync */])( /*#__PURE__*/Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee2() {
    ...
    var changeEvent = _this.service.event(constants["md" /* RoleManagerEvent */].Change);

    _this.mount(changeEvent.subscribe(constants["mb" /* EVENT */], dscan));
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              _context3.next = 8;
              return this.service.sendPacketAsync(inp.openCommand(constants["ld" /* RoleManagerCmd */].ListRequiredRoles), true);
            ...
            case 8:
              ...
              _loop = function _loop() {
                ...
                var devid = Object(utils["V" /* toHex */])(devidbuf); //console.log({ devidbuf, role, serviceClass })
            ...
            case 21:
              ...
              if (rdevs.length !== ordevs.length || rdevs.some(function (dev, i) {
                ...
                this.emit(constants["v" /* CHANGE */], this.requestedRoles);
            ...
            case 25:
              ...
              this.emit(constants["lb" /* ERROR */], _context3.t2);
      ...
      return regenerator_default.a.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return this.service.sendCmdAsync(constants["ld" /* RoleManagerCmd */].ClearAllRoles);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 5;
              return this.service.sendPacketAsync(packet["a" /* default */].from(constants["ld" /* RoleManagerCmd */].SetRole, data), true);
...
function RequestedRoleView(props) {
  ...
  var handleStartClick = function handleStartClick() {
    Object(hosts["b" /* addHost */])(bus, hostDefinition.services());
  };
...
function RoleManager(props) {
  ...
  var services = useServices({
    serviceClass: constants["he" /* SRV_ROLE_MANAGER */]
  });
...
//# sourceMappingURL=component---src-pages-tools-role-manager-tsx-63ac90ebb56af7d90767.js.map