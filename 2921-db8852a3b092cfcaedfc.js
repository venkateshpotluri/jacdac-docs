...
function HostMicrophoneButton(props) {
  ...
  var enabledRegister = service.register(constants/* SoundLevelReg.Enabled */.lSs.Enabled);
  var enabled = (0,useRegisterValue/* useRegisterBoolValue */.I8)(enabledRegister, props);

  var _useRegisterUnpackedV = (0,useRegisterValue/* useRegisterUnpackedValue */.Pf)(service.register(constants/* SoundLevelReg.MinDecibels */.lSs.MinDecibels), props),
      minDecibels = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = (0,useRegisterValue/* useRegisterUnpackedValue */.Pf)(service.register(constants/* SoundLevelReg.MaxDecibels */.lSs.MaxDecibels), props),
...
function DashboardSoundLevel(props) {
  var visible = props.visible,
      service = props.service;
  var soundLevelRegister = service.register(constants/* SoundLevelReg.SoundLevel */.lSs.SoundLevel);
...
//# sourceMappingURL=2921-db8852a3b092cfcaedfc.js.map