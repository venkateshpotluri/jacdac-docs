...
var ignoreRegisters = [constants["Ue" /* SystemReg */].StatusCode, constants["Ue" /* SystemReg */].StreamingPreferredInterval, constants["Ue" /* SystemReg */].StreamingSamples, constants["Ue" /* SystemReg */].StreamingInterval];
var collapsedRegisters = [constants["Ue" /* SystemReg */].Reading, constants["Ue" /* SystemReg */].Value, constants["Ue" /* SystemReg */].Intensity];
...
var ignoredServices = [constants["Bd" /* SRV_CTRL */], constants["Od" /* SRV_LOGGER */]];
...
function useActualAngle(service) {
  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["De" /* ServoReg */].Angle)),
      angle = _useRegisterUnpackedV[0]; // sec/60deg


  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["De" /* ServoReg */].ResponseSpeed)),
...
function DashboardServo(props) {
  var service = props.service,
      ...
      variant = props.variant;
  var enabledRegister = service.register(constants["De" /* ServoReg */].Enabled);
  ...
  var off = !enabled;
  var angleRegister = service.register(constants["De" /* ServoReg */].Angle);
  var angle = useActualAngle(service);

  var _useRegisterUnpackedV4 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["De" /* ServoReg */].Offset)),
...
function DashboardSwitch(props) {
  ...
  var on = Object(useRegisterValue["a" /* useRegisterBoolValue */])(service.register(constants["Qe" /* SwitchReg */].Active));

  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Qe" /* SwitchReg */].Variant)),
  ...
  switch (switchVariant) {
    case constants["Re" /* SwitchVariant */].PushButton:
      return /*#__PURE__*/react_default.a.createElement(ButtonWidget["a" /* default */], {
        checked: on,
        color: color,
        label: on ? "on" : "off",
...
var serviceViews = (_serviceViews = {}, _serviceViews[constants["ce" /* SRV_ROLE_MANAGER */]] = {
  component: DashboardRoleManager
}, _serviceViews[constants["wd" /* SRV_BUZZER */]] = {
  component: DashboardBuzzer,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["Md" /* SRV_LED_PIXEL */]] = {
  component: DashboardLEDPixel,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["pd" /* SRV_ACCELEROMETER */]] = {
  component: DashboardAccelerometer,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["de" /* SRV_ROTARY_ENCODER */]] = {
  component: DashboardRotaryEncoder,
  bundled: true
}, _serviceViews[constants["vd" /* SRV_BUTTON */]] = {
  component: DashboardButton,
  bundled: true
}, _serviceViews[constants["fe" /* SRV_SERVO */]] = {
  component: DashboardServo,
  bundled: true
}, _serviceViews[constants["oe" /* SRV_SWITCH */]] = {
  component: DashboardSwitch,
  bundled: true
}, _serviceViews[constants["re" /* SRV_TRAFFIC_LIGHT */]] = {
  component: DashboardTrafficLight
}, _serviceViews[constants["xd" /* SRV_CHARACTER_SCREEN */]] = {
  component: DashboardCharacterScreen,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["Xd" /* SRV_RAIN_GAUGE */]] = {
  component: DashboardRainGauge
}, _serviceViews[constants["Ld" /* SRV_LED_MATRIX */]] = {
  component: DashboardLEDMatrix,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["rd" /* SRV_ARCADE_GAMEPAD */]] = {
  component: DashboardArcadeGamepad,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["xe" /* SRV_WIND_DIRECTION */]] = {
  component: DashboardWindDirection
}, _serviceViews[constants["Pd" /* SRV_MATRIX_KEYPAD */]] = {
  component: DashboardMatrixKeypad
}, _serviceViews[constants["Zd" /* SRV_REFLECTED_LIGHT */]] = {
  component: DashboardReflectedLight
}, _serviceViews[constants["Ud" /* SRV_POWER */]] = {
  component: DashboardPower
}, _serviceViews[constants["ne" /* SRV_SPEECH_SYNTHESIS */]] = {
  component: DashboardSpeechSynthesis
}, _serviceViews[constants["ie" /* SRV_SOIL_MOISTURE */]] = {
  component: DashboardSoilMoisture
}, _serviceViews[constants["Yd" /* SRV_REAL_TIME_CLOCK */]] = {
  component: DashboardRealTimeClock
}, _serviceViews[constants["Kd" /* SRV_LED */]] = {
  component: DashboardLED
}, _serviceViews[constants["Jd" /* SRV_JOYSTICK */]] = {
  component: DashboardJoystick
}, _serviceViews[constants["he" /* SRV_SEVEN_SEGMENT_DISPLAY */]] = {
  component: DashboardSevenSegmentDisplay
}, _serviceViews[constants["Rd" /* SRV_MOTION */]] = {
  component: DashboardMotion
}, _serviceViews[constants["ve" /* SRV_WATER_LEVEL */]] = {
  component: DashboardWaterLevel
}, _serviceViews[constants["yd" /* SRV_COLOR */]] = {
  component: DashboardColor,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["le" /* SRV_SOUND_PLAYER */]] = {
  component: DashboardSoundPlayer,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["qd" /* SRV_ANALOG_BUTTON */]] = {
  component: DashboardAnalogButton
}, _serviceViews[constants["ke" /* SRV_SOUND_LEVEL */]] = {
  component: DashboardSoundLevel,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["be" /* SRV_RNG */]] = {
  component: DashboardRandomNumberGenerator
}, _serviceViews[constants["zd" /* SRV_COMPASS */]] = {
  component: DashboardCompass
}, _serviceViews[constants["Fd" /* SRV_GYROSCOPE */]] = {
  component: DashboardGyroscope,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["me" /* SRV_SOUND_SPECTRUM */]] = {
  component: DashboardSoundSpectrum,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["je" /* SRV_SOLENOID */]] = {
...
function DefaultWidget(props) {
  ...
  if (register.specification.identifier == constants["Ue" /* SystemReg */].Value) {
    var intensityRegister = register.service.register(constants["Ue" /* SystemReg */].Intensity);
  ...
  if (register.specification.identifier === constants["Ue" /* SystemReg */].Intensity) return /*#__PURE__*/react_default.a.createElement(IntensityWidget, {
...
//# sourceMappingURL=f45028b77642bb06a1e26ecfd1b9356bfb549ad6-fd06277016c25071366e.js.map