...
function packArguments(info, args) {
  ...
  for (var i = 0; i < info.fields.length; ++argIdx, ++i) {
    ...
    if (dst >= constants["Fb" /* JD_SERIAL_MAX_PAYLOAD_SIZE */]) throw new Error("jacdac packet length too large, " + dst + " > " + constants["Fb" /* JD_SERIAL_MAX_PAYLOAD_SIZE */] + " bytes");
...
//# sourceMappingURL=de590f55fa2f17e49ed8680dc5a022fe834f3017-796f02332b732638f4aa.js.map