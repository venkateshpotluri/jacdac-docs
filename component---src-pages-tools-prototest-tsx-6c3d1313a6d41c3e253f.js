(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[63,96],{
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              toValue = function toValue(msg) {
                if (msg === undefined || msg === null) return "";else if (typeof msg === "string") return msg;else if (msg instanceof Uint8Array) return Object(utils["U" /* toHex */])(msg);else if (Array.isArray(msg)) return msg.map(toValue);else return JSON.stringify(msg);
              };
...
function randomFieldPayload(field) {
  ...
  switch (specification.type) {
    ...
    case "u32":
      {
        ...
        var min = Object(utils["D" /* pick */])(specification.typicalMin, specification.absoluteMin, unsigned ? 0 : -((1 << n - 1) - 1));
        var max = Object(utils["D" /* pick */])(specification.typicalMax, specification.absoluteMax, unsigned ? (1 << n) - 1 : (1 << n - 1) - 1);
        r = Object(utils["E" /* randomRange */])(min, max);
        break;
      }
    ...
    case "bytes":
      {
        // maxBytes?
        var a = Object(utils["o" /* cryptoRandomUint32 */])(Object(utils["E" /* randomRange */])(1, 3));
    ...
    case "string0":
      {
        ...
        var _n = Object(utils["E" /* randomRange */])(4, 10);

        var s = "";

        for (var i = 0; i < _n; ++i) {
          s += String.fromCharCode(Object(utils["E" /* randomRange */])(ch_a, ch_z));
        }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              log({
                data: Object(utils["U" /* toHex */])(data)
            ...
            case 13:
              // check read
              log({
                rwdata: Object(utils["U" /* toHex */])(rw.data)
              });
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              rw = service.register(constants["Ic" /* ProtoTestReg */].RwBytes);
              _randomPayload = randomPayload("b", rw.fields), data = _randomPayload[0];
              log("data: " + Object(utils["U" /* toHex */])(data)); // send over cmd packet
            ...
            case 10:
              log("data recv: " + Object(utils["U" /* toHex */])(rw.data));
              ...
              throw new Error("rw write failed, expected " + Object(utils["U" /* toHex */])(data) + ", got " + Object(utils["U" /* toHex */])(rw.data));

            case 13:
              _context5.next = 15;
              return service.receiveWithInPipe(constants["Gc" /* ProtoTestCmd */].CReportPipe, "u8");
            ...
            case 15:
              ...
              log("received " + Object(utils["U" /* toHex */])(recvu));
              ...
              throw new Error("expected " + Object(utils["U" /* toHex */])(data) + ", got " + Object(utils["U" /* toHex */])(recv.map(function (buf) {
                return buf[0];
              })));
...
function ProtocolTest() {
  ...
  var services = Object(useChange["a" /* default */])(bus, function (b) {
    return b.services({
      serviceClass: constants["de" /* SRV_PROTO_TEST */]
    });
  });
...
//# sourceMappingURL=component---src-pages-tools-prototest-tsx-6c3d1313a6d41c3e253f.js.map