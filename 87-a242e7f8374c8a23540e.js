...
function LightStripWidget(props) {
  ...
  var isJewel = lightVariant === constants["Pb" /* LedPixelVariant */].Jewel;
  var isRing = lightVariant === constants["Pb" /* LedPixelVariant */].Ring; // paint svg via dom
  ...
  if (lightVariant === constants["Pb" /* LedPixelVariant */].Stick) {
    var dx = neoradius * 3;
    d = "M 0 " + dx;
    ...
    width = numPixels * dx;
    height = 2 * dx;
  } else if (lightVariant === constants["Pb" /* LedPixelVariant */].Strip) {
...
function LightWidget(props) {
  ...
  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ob" /* LedPixelReg */].NumPixels)),
      numPixels = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ob" /* LedPixelReg */].Variant)),
      lightVariant = _useRegisterUnpackedV2[0];

  var _useRegisterUnpackedV3 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ob" /* LedPixelReg */].ActualBrightness)),
      actualBrightness = _useRegisterUnpackedV3[0];

  var _useRegisterUnpackedV4 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ob" /* LedPixelReg */].NumColumns)),
  ...
  if (lightVariant === constants["Pb" /* LedPixelVariant */].Matrix) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              setSending(true);
              _context.next = 6;
              return service.sendCmdAsync(constants["Mb" /* LedPixelCmd */].Run, encoded);
...
//# sourceMappingURL=87-a242e7f8374c8a23540e.js.map