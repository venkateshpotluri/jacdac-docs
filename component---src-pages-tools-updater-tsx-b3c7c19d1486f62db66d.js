...
function useFirmwareRepos(showAllRepos) {
  ...
  var bootloaders = devices.filter(function (device) {
    return device === null || device === void 0 ? void 0 : device.hasService(constants["Ad" /* SRV_BOOTLOADER */]);
  });
  var registers = devices.filter(function (device) {
    return !(device !== null && device !== void 0 && device.hasService(constants["Ad" /* SRV_BOOTLOADER */]));
  }) // not a bootloader
  .map(function (device) {
    var _device$service;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 16:
              ...
              boot = bootloader.services({
                serviceClass: constants["Ad" /* SRV_BOOTLOADER */]
              })[0];
...
function UpdateDeviceList() {
  ...
  var devices = Object(useDevices["a" /* default */])({
    ...
    return safeBoot || !dev.hasService(constants["Ad" /* SRV_BOOTLOADER */]);
  });
...
function DeviceCard(props) {
  ...
  var services = Object(useChange["a" /* default */])(device, function () {
    return device.services().filter(function (service) {
      return service.serviceClass != constants["Hd" /* SRV_CTRL */] && service.serviceClass != constants["Ud" /* SRV_LOGGER */];
    });
  });
...
//# sourceMappingURL=component---src-pages-tools-updater-tsx-b3c7c19d1486f62db66d.js.map