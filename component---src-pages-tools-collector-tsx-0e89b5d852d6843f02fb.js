...
var InputLabel = __webpack_require__(11592);
...
function EventSelect(props) {
  ...
  var classes = useStyles();
  var events = (0,useChange/* default */.Z)(bus, function () {
    return (0,utils/* arrayConcatMany */.ue)((0,utils/* arrayConcatMany */.ue)(bus.devices().map(function (device) {
  ...
  return /*#__PURE__*/react.createElement(FormControl/* default */.Z, {
    variant: "outlined",
    className: (0,clsx_m/* default */.Z)(className, classes.formControl)
  }, /*#__PURE__*/react.createElement(InputLabel/* default */.Z, {
    key: "label"
  }, label), /*#__PURE__*/react.createElement(Select/* default */.Z, {
    key: "select",
    ...
    key: "none",
    value: ""
  }, /*#__PURE__*/react.createElement("em", null, "None")), events.map(function (ev) {
...
var collector_useStyles = (0,makeStyles/* default */.Z)(function (theme) {
  return (0,createStyles/* default */.Z)({
    root: {
...
function Collector() {
  ...
  }), /*#__PURE__*/react.createElement(EventSelect, {
    className: classes.field,
...
//# sourceMappingURL=component---src-pages-tools-collector-tsx-0e89b5d852d6843f02fb.js.map