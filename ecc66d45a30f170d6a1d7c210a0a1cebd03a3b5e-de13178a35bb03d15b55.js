...
var FieldDataSet = /*#__PURE__*/function (_JDEventSource) {
  ...
  _proto2.addExample = function addExample(timestamp, data) {
    ...
    this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_3__[/* CHANGE */ "s"]);
  };
...
function Trend(props) {
  var dataSet = props.dataSet,
      mini = props.mini;
  var classes = useStyles();
  var units = Object(_jacdac_ts_src_jdom_utils__WEBPACK_IMPORTED_MODULE_1__[/* unique */ "Y"])(dataSet.units.map(function (unit) {
    return unit || "/";
  }));
...
//# sourceMappingURL=ecc66d45a30f170d6a1d7c210a0a1cebd03a3b5e-de13178a35bb03d15b55.js.map