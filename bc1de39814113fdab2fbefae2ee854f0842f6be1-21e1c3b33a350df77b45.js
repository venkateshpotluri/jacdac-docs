...
function useReadingAuxilliaryValue(register, identifier) {
  if (identifier === void 0) {
    identifier = constants["Ze" /* SystemReg */].ReadingError | constants["Ze" /* SystemReg */].ReadingResolution | constants["Ze" /* SystemReg */].MaxReading | constants["Ze" /* SystemReg */].MinReading | constants["Ze" /* SystemReg */].StreamingInterval | constants["Ze" /* SystemReg */].StreamingPreferredInterval;
  }

  var service = register.service,
      code = register.code;
  var reading = code === constants["Ze" /* SystemReg */].Reading || code === constants["Ze" /* SystemReg */].Value;
  ...
  Object(react["useEffect"])(function () {
    return auxilliaryRegister === null || auxilliaryRegister === void 0 ? void 0 : auxilliaryRegister.subscribe(constants["Wc" /* REPORT_UPDATE */], function () {
...
function RegisterInput(props) {
  ...
  var minReading = useReadingAuxilliaryValue(register, constants["Ze" /* SystemReg */].MinReading);
  var maxReading = useReadingAuxilliaryValue(register, constants["Ze" /* SystemReg */].MaxReading);
  var readingError = useReadingAuxilliaryValue(register, constants["Ze" /* SystemReg */].ReadingError);
  var resolution = useReadingAuxilliaryValue(register, constants["Ze" /* SystemReg */].ReadingResolution);
  Object(react["useEffect"])(function () {
    return register.subscribe(constants["Wc" /* REPORT_UPDATE */], function () {
...
function RegisterTrend(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    return interval ? undefined : register === null || register === void 0 ? void 0 : register.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__[/* REPORT_RECEIVE */ "Vc"], addRow);
...
//# sourceMappingURL=bc1de39814113fdab2fbefae2ee854f0842f6be1-21e1c3b33a350df77b45.js.map