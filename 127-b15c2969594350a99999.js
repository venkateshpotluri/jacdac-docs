...
function HostMicrophoneButton(props) {
  ...
  var enabledRegister = service.register(constants["Oe" /* SoundSpectrumReg */].Enabled);
  var enabled = Object(useRegisterValue["a" /* useRegisterBoolValue */])(enabledRegister);

  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Oe" /* SoundSpectrumReg */].MinDecibels)),
      minDecibels = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Oe" /* SoundSpectrumReg */].MaxDecibels)),
      maxDecibels = _useRegisterUnpackedV2[0];

  var _useRegisterUnpackedV3 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Oe" /* SoundSpectrumReg */].FftPow2Size)),
      fftPow2Size = _useRegisterUnpackedV3[0];

  var fftSize = 1 << (fftPow2Size || 5);

  var _useRegisterUnpackedV4 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Oe" /* SoundSpectrumReg */].SmoothingTimeConstant)),
...
function DashboardSoundSpectrum(props) {
  ...
  var frequencyBinsRegister = service.register(constants["Oe" /* SoundSpectrumReg */].FrequencyBins);
...
//# sourceMappingURL=127-b15c2969594350a99999.js.map