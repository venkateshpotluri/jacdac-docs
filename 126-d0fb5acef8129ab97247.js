...
function HostMicrophoneButton(props) {
  ...
  var enabledRegister = service.register(constants["Me" /* SoundSpectrumReg */].Enabled);
  var enabled = Object(useRegisterValue["a" /* useRegisterBoolValue */])(enabledRegister);

  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Me" /* SoundSpectrumReg */].MinDecibels)),
      minDecibels = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Me" /* SoundSpectrumReg */].MaxDecibels)),
      maxDecibels = _useRegisterUnpackedV2[0];

  var _useRegisterUnpackedV3 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Me" /* SoundSpectrumReg */].FftPow2Size)),
      fftPow2Size = _useRegisterUnpackedV3[0];

  var fftSize = 1 << (fftPow2Size || 5);

  var _useRegisterUnpackedV4 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Me" /* SoundSpectrumReg */].SmoothingTimeConstant)),
...
function DashboardSoundSpectrum(props) {
  ...
  var frequencyBinsRegister = service.register(constants["Me" /* SoundSpectrumReg */].FrequencyBins);
...
//# sourceMappingURL=126-d0fb5acef8129ab97247.js.map