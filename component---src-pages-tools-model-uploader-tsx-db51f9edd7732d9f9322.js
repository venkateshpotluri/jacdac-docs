...
function DeviceLostAlert(props) {
  ...
  var lost = Object(_jacdac_useEventRaised__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])([_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__[/* LOST */ "Mb"], _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__[/* FOUND */ "qb"]], device, function (dev) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (totalSampleSize > _constants__WEBPACK_IMPORTED_MODULE_5__[/* JD_SERIAL_MAX_PAYLOAD_SIZE */ "Db"]) error("samples won't fit in packet"); // u32 is x[4]
      ...
      return regenerator_default.a.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 4:
              _context4.next = 6;
              return Object(utils["L" /* readBlobToUint8Array */])(blob);
    ...
    return regenerator_default.a.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 4:
            _context5.next = 6;
            return Object(utils["K" /* readBlobToText */])(blob);
...
function isMLModelSupported(model, formatRegValue) {
  return utils["J" /* read32 */](model, 0) == formatRegValue || utils["J" /* read32 */](model, 4) == formatRegValue;
}
function getMLModelFormatName(model) {
  var map = Object(spec["D" /* serviceSpecificationFromClassIdentifier */])(constants["Zd" /* SRV_MODEL_RUNNER */]).enums["ModelFormat"].members;
  var m0 = utils["J" /* read32 */](model, 0);
  var m1 = utils["J" /* read32 */](model, 4);
  ...
  return "0x" + utils["W" /* toHex */](model.slice(0, 8));
}
var modelrunner_ModelRunnerClient = /*#__PURE__*/function (_JDServiceClient) {
    ...
    var _isModelSupported = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee(model) {
      ...
      return regenerator_default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              reg = this.service.register(constants["fc" /* ModelRunnerReg */].Format);
              _context.next = 3;
              return reg.refresh();
  ...
  _proto.subscribeResults = function subscribeResults(handler) {
    var reg = this.service.register(constants["fc" /* ModelRunnerReg */].Outputs);
    return reg.subscribe(constants["Xc" /* REPORT_RECEIVE */], function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.service.sendCmdAwaitResponseAsync(packet["a" /* default */].jdpacked(constants["ec" /* ModelRunnerCmd */].SetModel, "u32", [model.length]), 3000);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return this.service.register(constants["fc" /* ModelRunnerReg */].AutoInvokeEvery).sendSetPackedAsync("u16", [everySamples]);
      ...
      return regenerator_default.a.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              info = {
                "modelSize": this.getReg(constants["fc" /* ModelRunnerReg */].ModelSize, function (r) {
                  return r.intValue;
                }),
                "arenaSize": this.getReg(constants["fc" /* ModelRunnerReg */].AllocatedArenaSize, function (r) {
                  return r.intValue;
                }),
                "inputShape": this.getReg(constants["fc" /* ModelRunnerReg */].InputShape, function (r) {
                  return Object(buffer["b" /* bufferToArray */])(r.data, buffer["a" /* NumberFormat */].UInt16LE);
                }),
                "outputShape": this.getReg(constants["fc" /* ModelRunnerReg */].OutputShape, function (r) {
                  return Object(buffer["b" /* bufferToArray */])(r.data, buffer["a" /* NumberFormat */].UInt16LE);
                }),
                "lastError": this.getReg(constants["fc" /* ModelRunnerReg */].LastError, function (r) {
                  return utils["Y" /* uint8ArrayToString */](r.data);
                })
              };
...
var ImportButton = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 6).then(__webpack_require__.bind(null, "/MSm"));
});
function ModelContent(props) {
  var service = props.service;

  var _useRegisterUnpackedV = Object(useRegisterValue["c" /* useRegisterUnpackedValue */])(service.register(constants["fc" /* ModelRunnerReg */].ModelSize)),
      modelSize = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(useRegisterValue["c" /* useRegisterUnpackedValue */])(service.register(constants["fc" /* ModelRunnerReg */].LastError)),
  ...
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, lastError && /*#__PURE__*/react_default.a.createElement(Alert["a" /* default */], {
    ...
    register: service.register(constants["fc" /* ModelRunnerReg */].AutoInvokeEvery)
  }), /*#__PURE__*/react_default.a.createElement(RegisterTrend["a" /* default */], {
    showName: true,
    register: service.register(constants["fc" /* ModelRunnerReg */].Outputs),
    mini: true
  }));
}
...
function ModelUploader() {
  ...
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement("h1", null, "Model uploader"), /*#__PURE__*/react_default.a.createElement("p", null, "Upload Machine Learning Models (like TensorFlow Lite) into your ", /*#__PURE__*/react_default.a.createElement(Link, {
    ...
    serviceClass: constants["Zd" /* SRV_MODEL_RUNNER */]
