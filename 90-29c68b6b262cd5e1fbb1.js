...
function LightStripWidget(props) {
  ...
  var isJewel = lightVariant === constants["Sb" /* LedPixelVariant */].Jewel;
  var isRing = lightVariant === constants["Sb" /* LedPixelVariant */].Ring; // paint svg via dom
  ...
  Object(react["useEffect"])(function () {
    return server === null || server === void 0 ? void 0 : server.subscribe(constants["Vc" /* RENDER */], paint);
  }, [server]);
  var width;
  var height;
  var d = "";

  if (lightVariant === constants["Sb" /* LedPixelVariant */].Stick) {
    var dx = neoradius * 3;
    d = "M 0 " + dx;
    ...
    width = numPixels * dx;
    height = 2 * dx;
  } else if (lightVariant === constants["Sb" /* LedPixelVariant */].Strip) {
...
function LightWidget(props) {
  ...
  var _useRegisterUnpackedV = Object(useRegisterValue["c" /* useRegisterUnpackedValue */])(service.register(constants["Rb" /* LedPixelReg */].NumPixels), props),
      numPixels = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(useRegisterValue["c" /* useRegisterUnpackedValue */])(service.register(constants["Rb" /* LedPixelReg */].Variant), props),
      lightVariant = _useRegisterUnpackedV2[0];

  var _useRegisterUnpackedV3 = Object(useRegisterValue["c" /* useRegisterUnpackedValue */])(service.register(constants["Rb" /* LedPixelReg */].ActualBrightness), props),
      actualBrightness = _useRegisterUnpackedV3[0];

  var _useRegisterUnpackedV4 = Object(useRegisterValue["c" /* useRegisterUnpackedValue */])(service.register(constants["Rb" /* LedPixelReg */].NumColumns), props),
  ...
  if (lightVariant === constants["Sb" /* LedPixelVariant */].Matrix) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              setSending(true);
              _context.next = 6;
              return service.sendCmdAsync(constants["Pb" /* LedPixelCmd */].Run, encoded);
...
function DashboardLEDPixel(props) {
  ...
  var server = Object(useServiceServer["a" /* default */])(service);
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, server && /*#__PURE__*/react_default.a.createElement(LightWidget, Object.assign({
...
//# sourceMappingURL=90-29c68b6b262cd5e1fbb1.js.map