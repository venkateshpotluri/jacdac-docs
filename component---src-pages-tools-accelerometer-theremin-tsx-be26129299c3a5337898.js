...
function AccelerometerTheremin() {
  ...
  var _useContext2 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(_components_ui_WebAudioContext__WEBPACK_IMPORTED_MODULE_14__/* .default */ .ZP),
      ...
      activated = _useContext2.activated; // listen for playTone commands from the buzzer
  ...
  }, [buzzerServer]); // make sure to clean out buzzer server
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _accelService$reading = accelService.readingRegister.unpackedValue, x = _accelService$reading[0];
              _context2.next = 3;
