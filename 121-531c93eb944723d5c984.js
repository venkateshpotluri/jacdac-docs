...
function HostMicrophoneButton(props) {
  ...
  var enabledRegister = service.register(constants["Re" /* SoundLevelReg */].Enabled);
  var enabled = Object(useRegisterValue["a" /* useRegisterBoolValue */])(enabledRegister, props);

  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Re" /* SoundLevelReg */].MinDecibels), props),
      minDecibels = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Re" /* SoundLevelReg */].MaxDecibels), props),
  ...
  Object(react["useEffect"])(function () {
    return visible && (host === null || host === void 0 ? void 0 : host.subscribe(constants["Kc" /* REFRESH */], function () {
...
function DashboardSoundLevel(props) {
  var visible = props.visible,
      service = props.service;
  var soundLevelRegister = service.register(constants["Re" /* SoundLevelReg */].SoundLevel);
...
//# sourceMappingURL=121-531c93eb944723d5c984.js.map