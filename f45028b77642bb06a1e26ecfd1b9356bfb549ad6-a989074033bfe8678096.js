...
function useRoleManager() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    return bus.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__[/* ROLE_MANAGER_CHANGE */ "cd"], function () {
...
function useServiceRole(service) {
  ...
  Object(react["useEffect"])(function () {
    return service === null || service === void 0 ? void 0 : service.subscribe(constants["bd" /* ROLE_CHANGE */], function () {
...
function DashboardServiceWidgetItem(props) {
  var service = props.service;
  var instanceName = Object(useRegisterValue["d" /* useRegisterStringValue */])(service.register(constants["bf" /* SystemReg */].InstanceName), props);
...
var ignoreRegisters = [constants["bf" /* SystemReg */].StatusCode, constants["bf" /* SystemReg */].StreamingPreferredInterval, constants["bf" /* SystemReg */].StreamingSamples, constants["bf" /* SystemReg */].StreamingInterval];
var collapsedRegisters = [constants["bf" /* SystemReg */].Reading, constants["bf" /* SystemReg */].Value, constants["bf" /* SystemReg */].Intensity];
...
var ignoredServices = [constants["Id" /* SRV_CTRL */], constants["Vd" /* SRV_LOGGER */]];
...
function DashboardButton(props) {
  ...
  Object(react["useEffect"])(function () {
    return visible && (pressedRegister === null || pressedRegister === void 0 ? void 0 : pressedRegister.subscribe(constants["Yc" /* REPORT_UPDATE */], function () {
...
function useActualAngle(service, visible) {
  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ke" /* ServoReg */].Angle), {
    visible: visible
  }),
      angle = _useRegisterUnpackedV[0]; // sec/60deg


  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ke" /* ServoReg */].ResponseSpeed), {
    visible: visible
  }),
...
function DashboardServo(props) {
  var service = props.service,
      visible = props.visible;
  var enabledRegister = service.register(constants["Ke" /* ServoReg */].Enabled);
  ...
  var off = !enabled;
  var angleRegister = service.register(constants["Ke" /* ServoReg */].Angle);
  var angle = useActualAngle(service, visible);

  var _useRegisterUnpackedV4 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Ke" /* ServoReg */].Offset)),
...
function DashboardRotaryEncoder(props) {
  var service = props.service;
  var positionRegister = service.register(constants["qd" /* RotaryEncoderReg */].Position);
  ...
  var clicksPerTurnRegister = service.register(constants["qd" /* RotaryEncoderReg */].ClicksPerTurn, props);
...
function DashboardSwitch(props) {
  ...
  var on = Object(useRegisterValue["a" /* useRegisterBoolValue */])(service.register(constants["Xe" /* SwitchReg */].Active), props);

  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Xe" /* SwitchReg */].Variant), props),
  ...
  switch (switchVariant) {
    case constants["Ye" /* SwitchVariant */].PushButton:
      return /*#__PURE__*/react_default.a.createElement(ButtonWidget["a" /* default */], {
        checked: on,
        color: color,
        label: on ? "on" : "off",
...
var DashboardAccelerometer = /*#__PURE__*/Object(react["lazy"])(function () {
  return Promise.all(/* import() */[__webpack_require__.e(14), __webpack_require__.e(108)]).then(__webpack_require__.bind(null, "BuIi"));
});
var DashboardBuzzer = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 103).then(__webpack_require__.bind(null, "R+TK"));
});
var DashboardLEDPixel = /*#__PURE__*/Object(react["lazy"])(function () {
  return Promise.all(/* import() */[__webpack_require__.e(13), __webpack_require__.e(87)]).then(__webpack_require__.bind(null, "6t+h"));
});
var DashboardRoleManager = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 122).then(__webpack_require__.bind(null, "W5Co"));
});
var DashboardTrafficLight = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 106).then(__webpack_require__.bind(null, "3zc7"));
});
var DashboardCharacterScreen = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 111).then(__webpack_require__.bind(null, "n8kx"));
});
var DashboardRainGauge = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 118).then(__webpack_require__.bind(null, "Ps5K"));
});
var DashboardLEDMatrix = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 104).then(__webpack_require__.bind(null, "pp1O"));
});
var DashboardArcadeGamepad = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 110).then(__webpack_require__.bind(null, "35Ra"));
});
var DashboardWindDirection = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 129).then(__webpack_require__.bind(null, "ns0S"));
});
var DashboardMatrixKeypad = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 105).then(__webpack_require__.bind(null, "7Zf3"));
});
var DashboardReflectedLight = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 121).then(__webpack_require__.bind(null, "dJYX"));
});
var DashboardPower = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 117).then(__webpack_require__.bind(null, "jSS8"));
});
var DashboardSpeechSynthesis = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 101).then(__webpack_require__.bind(null, "QRI8"));
});
var DashboardSoilMoisture = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 124).then(__webpack_require__.bind(null, "0HhB"));
});
var DashboardRealTimeClock = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 120).then(__webpack_require__.bind(null, "eCSt"));
});
var DashboardLED = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 115).then(__webpack_require__.bind(null, "HqAP"));
});
var DashboardJoystick = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 114).then(__webpack_require__.bind(null, "VuK9"));
});
var DashboardSevenSegmentDisplay = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 123).then(__webpack_require__.bind(null, "hXyX"));
});
var DashboardMotion = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 116).then(__webpack_require__.bind(null, "ummP"));
});
var DashboardWaterLevel = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 128).then(__webpack_require__.bind(null, "zMc1"));
});
var DashboardColor = /*#__PURE__*/Object(react["lazy"])(function () {
  return Promise.all(/* import() */[__webpack_require__.e(13), __webpack_require__.e(112)]).then(__webpack_require__.bind(null, "a9ED"));
});
var DashboardSoundPlayer = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 102).then(__webpack_require__.bind(null, "Lz8i"));
});
var DashboardAnalogButton = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 109).then(__webpack_require__.bind(null, "SmDE"));
});
var DashboardSoundLevel = /*#__PURE__*/Object(react["lazy"])(function () {
  return Promise.all(/* import() */[__webpack_require__.e(14), __webpack_require__.e(126)]).then(__webpack_require__.bind(null, "iPqf"));
});
var DashboardSoundSpectrum = /*#__PURE__*/Object(react["lazy"])(function () {
  return Promise.all(/* import() */[__webpack_require__.e(14), __webpack_require__.e(127)]).then(__webpack_require__.bind(null, "wvcQ"));
});
var DashboardRandomNumberGenerator = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 119).then(__webpack_require__.bind(null, "2rwa"));
});
var DashboardCompass = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 113).then(__webpack_require__.bind(null, "w0oc"));
});
...
var serviceViews = (_serviceViews = {}, _serviceViews[constants["je" /* SRV_ROLE_MANAGER */]] = {
  component: DashboardRoleManager
}, _serviceViews[constants["Dd" /* SRV_BUZZER */]] = {
  component: DashboardBuzzer,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["Td" /* SRV_LED_PIXEL */]] = {
  component: DashboardLEDPixel,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["wd" /* SRV_ACCELEROMETER */]] = {
  component: DashboardAccelerometer,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["ke" /* SRV_ROTARY_ENCODER */]] = {
  component: DashboardRotaryEncoder,
  bundled: true,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["Cd" /* SRV_BUTTON */]] = {
  component: DashboardButton,
  bundled: true
}, _serviceViews[constants["me" /* SRV_SERVO */]] = {
  component: DashboardServo,
  bundled: true
}, _serviceViews[constants["ve" /* SRV_SWITCH */]] = {
  component: DashboardSwitch,
  bundled: true
}, _serviceViews[constants["ye" /* SRV_TRAFFIC_LIGHT */]] = {
  component: DashboardTrafficLight
}, _serviceViews[constants["Ed" /* SRV_CHARACTER_SCREEN */]] = {
  component: DashboardCharacterScreen,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["ee" /* SRV_RAIN_GAUGE */]] = {
  component: DashboardRainGauge
}, _serviceViews[constants["Sd" /* SRV_LED_MATRIX */]] = {
  component: DashboardLEDMatrix,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["yd" /* SRV_ARCADE_GAMEPAD */]] = {
  component: DashboardArcadeGamepad,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["Ee" /* SRV_WIND_DIRECTION */]] = {
  component: DashboardWindDirection
}, _serviceViews[constants["Wd" /* SRV_MATRIX_KEYPAD */]] = {
  component: DashboardMatrixKeypad
}, _serviceViews[constants["ge" /* SRV_REFLECTED_LIGHT */]] = {
  component: DashboardReflectedLight
}, _serviceViews[constants["be" /* SRV_POWER */]] = {
  component: DashboardPower
}, _serviceViews[constants["ue" /* SRV_SPEECH_SYNTHESIS */]] = {
  component: DashboardSpeechSynthesis
}, _serviceViews[constants["pe" /* SRV_SOIL_MOISTURE */]] = {
  component: DashboardSoilMoisture
}, _serviceViews[constants["fe" /* SRV_REAL_TIME_CLOCK */]] = {
  component: DashboardRealTimeClock
}, _serviceViews[constants["Rd" /* SRV_LED */]] = {
  component: DashboardLED
}, _serviceViews[constants["Qd" /* SRV_JOYSTICK */]] = {
  component: DashboardJoystick
}, _serviceViews[constants["oe" /* SRV_SEVEN_SEGMENT_DISPLAY */]] = {
  component: DashboardSevenSegmentDisplay
}, _serviceViews[constants["Yd" /* SRV_MOTION */]] = {
  component: DashboardMotion
}, _serviceViews[constants["Ce" /* SRV_WATER_LEVEL */]] = {
  component: DashboardWaterLevel
}, _serviceViews[constants["Fd" /* SRV_COLOR */]] = {
  component: DashboardColor,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["se" /* SRV_SOUND_PLAYER */]] = {
  component: DashboardSoundPlayer,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["xd" /* SRV_ANALOG_BUTTON */]] = {
  component: DashboardAnalogButton
}, _serviceViews[constants["re" /* SRV_SOUND_LEVEL */]] = {
  component: DashboardSoundLevel,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["ie" /* SRV_RNG */]] = {
  component: DashboardRandomNumberGenerator
}, _serviceViews[constants["Gd" /* SRV_COMPASS */]] = {
  component: DashboardCompass
}, _serviceViews[constants["Md" /* SRV_GYROSCOPE */]] = {
  component: DashboardGyroscope,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["te" /* SRV_SOUND_SPECTRUM */]] = {
  component: DashboardSoundSpectrum,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["qe" /* SRV_SOLENOID */]] = {
...
function DefaultWidget(props) {
  ...
  if (register.specification.identifier == constants["bf" /* SystemReg */].Value) {
    var intensityRegister = register.service.register(constants["bf" /* SystemReg */].Intensity);
  ...
  if (register.specification.identifier === constants["bf" /* SystemReg */].Intensity) return /*#__PURE__*/react_default.a.createElement(IntensityWidget, Object.assign({
...
//# sourceMappingURL=f45028b77642bb06a1e26ecfd1b9356bfb549ad6-a989074033bfe8678096.js.map