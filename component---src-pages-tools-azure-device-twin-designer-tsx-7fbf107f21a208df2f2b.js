...
function ComponentRow(props) {
  ...
  var handleSetService = function handleSetService(serviceClass) {
    component.service = Object(_jacdac_ts_src_jdom_spec__WEBPACK_IMPORTED_MODULE_6__[/* serviceSpecificationFromClassIdentifier */ "D"])(serviceClass);
    onUpdate();
  };
...
function AzureDeviceTwinDesigner() {
  ...
  var handleAddService = function handleAddService(service) {
    ...
    twin.components.push({
      name: Object(_jacdac_ts_src_jdom_utils__WEBPACK_IMPORTED_MODULE_3__[/* uniqueName */ "bb"])(names, service.shortId),
      service: service
    });
    update();
  };
...
//# sourceMappingURL=component---src-pages-tools-azure-device-twin-designer-tsx-7fbf107f21a208df2f2b.js.map