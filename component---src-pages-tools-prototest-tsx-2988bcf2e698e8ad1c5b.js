(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[65,97],{
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              toValue = function toValue(msg) {
                if (msg === undefined || msg === null) return "";else if (typeof msg === "string") return msg;else if (msg instanceof Uint8Array) return Object(utils["W" /* toHex */])(msg);else if (Array.isArray(msg)) return msg.map(toValue);else return JSON.stringify(msg);
              };
...
var serviceprovider = __webpack_require__("TV+i");

// EXTERNAL MODULE: ./jacdac-ts/src/jdom/protocoltestserver.ts
var protocoltestserver = __webpack_require__("7Y1t");
...
function randomFieldPayload(field) {
  ...
  switch (specification.type) {
    ...
    case "u32":
      {
        ...
        r = Object(utils["G" /* randomRange */])(min, max);
        break;
      }
    ...
    case "bytes":
      {
        // maxBytes?
        var a = Object(utils["o" /* cryptoRandomUint32 */])(Object(utils["G" /* randomRange */])(1, 3));
    ...
    case "string0":
      {
        ...
        var _n = Object(utils["G" /* randomRange */])(4, 10);

        var s = "";

        for (var i = 0; i < _n; ++i) {
          s += String.fromCharCode(Object(utils["G" /* randomRange */])(ch_a, ch_z));
        }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              log({
                data: Object(utils["W" /* toHex */])(data)
            ...
            case 13:
              // check read
              log({
                rwdata: Object(utils["W" /* toHex */])(rw.data)
              });
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              log("data: " + Object(utils["W" /* toHex */])(data)); // send over cmd packet
            ...
            case 10:
              log("data recv: " + Object(utils["W" /* toHex */])(rw.data));
              ...
              throw new Error("rw write failed, expected " + Object(utils["W" /* toHex */])(data) + ", got " + Object(utils["W" /* toHex */])(rw.data));
            ...
            case 15:
              ...
              log("received " + Object(utils["W" /* toHex */])(recvu));
              ...
              throw new Error("expected " + Object(utils["W" /* toHex */])(data) + ", got " + Object(utils["W" /* toHex */])(recv.map(function (buf) {
                return buf[0];
              })));
...
function ProtocolTest() {
  ...
  var services = Object(useChange["a" /* default */])(bus, function (b) {
    return b.services({
      serviceClass: constants["ee" /* SRV_PROTO_TEST */]
    });
  });
  ...
  Object(react["useEffect"])(function () {
    ...
    var d = new serviceprovider["a" /* default */]([new protocoltestserver["a" /* default */]()]);
...
//# sourceMappingURL=component---src-pages-tools-prototest-tsx-2988bcf2e698e8ad1c5b.js.map