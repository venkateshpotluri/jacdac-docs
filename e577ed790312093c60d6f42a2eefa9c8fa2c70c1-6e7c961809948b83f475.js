...
var raingaugeservicehost_RainGaugeServiceHost = /*#__PURE__*/function (_AnalogSensorServiceH) {
  ...
  function RainGaugeServiceHost(options) {
    ...
    _this.precipitationPrecision = _this.addRegister(constants["dd" /* RainGaugeReg */].PrecipitationPrecision, [bucketSize || 0.2794]);
    _this._level = 0;
    return _this;
  }
...
var reflectedlightservicehost_ReflectedLightServiceHost = /*#__PURE__*/function (_AnalogSensorServiceH) {
  ...
  function ReflectedLightServiceHost(options) {
    ...
    _this.variant = _this.addRegister(constants["hd" /* ReflectedLightReg */].Variant, [variant || constants["id" /* ReflectedLightVariant */].InfraredDigital]);
    return _this;
  }
...
var randomnumbergeneratorservicehost_RandomNumberGeneratorServiceHost = /*#__PURE__*/function (_ServiceHost) {
  ...
  function RandomNumberGeneratorServiceHost() {
    ...
    _this = _ServiceHost.call(this, constants["ie" /* SRV_RNG */], {
      variant: constants["md" /* RngVariant */].WebCrypto
    }) || this;
    _this.reading = _this.addRegister(constants["ld" /* RngReg */].Random, [new Uint8Array(64)]);
...
var _hosts = [{
  ...
  services: function services() {
    return [new reflectedlightservicehost_ReflectedLightServiceHost({
      variant: constants["id" /* ReflectedLightVariant */].InfraredAnalog
    })];
  }
}, {
  ...
  services: function services() {
    return [new servicehost["a" /* default */](constants["he" /* SRV_RELAY */], {
      intensityValues: [false],
      variant: constants["kd" /* RelayVariant */].Electromechanical,
      registerValues: [{
        code: constants["jd" /* RelayReg */].MaxSwitchingCurrent,
        values: [10]
      }]
    })];
  }
  ...
  services: function services() {
    return Array(4).fill(0).map(function () {
      return new servicehost["a" /* default */](constants["he" /* SRV_RELAY */], {
        intensityValues: [false],
        variant: constants["kd" /* RelayVariant */].SolidState,
        registerValues: [{
          code: constants["jd" /* RelayReg */].MaxSwitchingCurrent,
          values: [5]
        }]
...
//# sourceMappingURL=e577ed790312093c60d6f42a2eefa9c8fa2c70c1-6e7c961809948b83f475.js.map