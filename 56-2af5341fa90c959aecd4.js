...
// EXTERNAL MODULE: ./node_modules/react-color/es/index.js + 209 modules
...
function LightStripWidget(props) {
  ...
  var isJewel = lightVariant === constants["Qb" /* LedPixelVariant */].Jewel;
  var isRing = lightVariant === constants["Qb" /* LedPixelVariant */].Ring; // paint svg via dom
  ...
  Object(react["useEffect"])(function () {
    return host === null || host === void 0 ? void 0 : host.subscribe(constants["Qc" /* RENDER */], paint);
  }, [host]);
  var width;
  var height;
  var d = "";

  if (lightVariant === constants["Qb" /* LedPixelVariant */].Stick) {
    var dx = neoradius * 3;
    d = "M 0 " + dx;
    ...
    width = numPixels * dx;
    height = 2 * dx;
  } else if (lightVariant === constants["Qb" /* LedPixelVariant */].Strip) {
...
function LightWidget(props) {
  ...
  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Pb" /* LedPixelReg */].NumPixels)),
      numPixels = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Pb" /* LedPixelReg */].Variant)),
      lightVariant = _useRegisterUnpackedV2[0];

  var _useRegisterUnpackedV3 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Pb" /* LedPixelReg */].ActualBrightness)),
      actualBrightness = _useRegisterUnpackedV3[0];

  var _useRegisterUnpackedV4 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Pb" /* LedPixelReg */].NumColumns)),
      numColumns = _useRegisterUnpackedV4[0];

  var host = Object(useServiceHost["a" /* default */])(service);
  if (!numPixels) return null; // nothing to render

  if (lightVariant === constants["Qb" /* LedPixelVariant */].Matrix) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              setSending(true);
              _context.next = 6;
              return service.sendCmdAsync(constants["Nb" /* LedPixelCmd */].Run, encoded);
...
//# sourceMappingURL=56-2af5341fa90c959aecd4.js.map