...
var testrunner_JDCommandEvaluator = /*#__PURE__*/function () {
  ...
  _proto2.createPrompt = function createPrompt() {
    ...
    var replaceVal = this.command.call.arguments.map(function (a, i) {
      ...
      return ["{" + (i + 1) + ":val}", aStart && aStart.v ? Object(utils["M" /* roundWithPrecision */])(aStart.v, 3).toString() : unparse(a)];
    });
  ...
  _proto2.evaluate = function evaluate() {
    ...
    function pretify(v) {
      return Object(utils["M" /* roundWithPrecision */])(v, 3);
    }
  };
    ...
    _this6.testSpec.tests.forEach(function (t) {
      t.events.forEach(function (eventName) {
        if (!_this6.events[eventName]) {
          ...
          _this6.mount(event.subscribe(constants["lb" /* EVENT */], function () {
...
//# sourceMappingURL=859a83de993caea7524bf57c2975f3be6812c8c3-be76a0de1651a9fd9a18.js.map