...
function useRoleManager() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    return bus.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__[/* ROLE_MANAGER_CHANGE */ "Xc"], function () {
...
var ignoreRegisters = [constants["We" /* SystemReg */].StatusCode, constants["We" /* SystemReg */].StreamingPreferredInterval, constants["We" /* SystemReg */].StreamingSamples, constants["We" /* SystemReg */].StreamingInterval];
var collapsedRegisters = [constants["We" /* SystemReg */].Reading, constants["We" /* SystemReg */].Value, constants["We" /* SystemReg */].Intensity];
...
var ignoredServices = [constants["Dd" /* SRV_CTRL */], constants["Qd" /* SRV_LOGGER */]];
...
function useActualAngle(service) {
  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Fe" /* ServoReg */].Angle)),
      angle = _useRegisterUnpackedV[0]; // sec/60deg


  var _useRegisterUnpackedV2 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Fe" /* ServoReg */].ResponseSpeed)),
...
function DashboardServo(props) {
  var service = props.service,
      ...
      variant = props.variant;
  var enabledRegister = service.register(constants["Fe" /* ServoReg */].Enabled);
  ...
  var off = !enabled;
  var angleRegister = service.register(constants["Fe" /* ServoReg */].Angle);
  var angle = useActualAngle(service);

  var _useRegisterUnpackedV4 = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Fe" /* ServoReg */].Offset)),
...
function DashboardRotaryEncoder(props) {
  var service = props.service,
      services = props.services,
      variant = props.variant;
  var positionRegister = service.register(constants["ld" /* RotaryEncoderReg */].Position);
  ...
  var clicksPerTurnRegister = service.register(constants["ld" /* RotaryEncoderReg */].ClicksPerTurn);
...
function DashboardSwitch(props) {
  ...
  var on = Object(useRegisterValue["a" /* useRegisterBoolValue */])(service.register(constants["Se" /* SwitchReg */].Active));

  var _useRegisterUnpackedV = Object(useRegisterValue["e" /* useRegisterUnpackedValue */])(service.register(constants["Se" /* SwitchReg */].Variant)),
  ...
  switch (switchVariant) {
    case constants["Te" /* SwitchVariant */].PushButton:
      return /*#__PURE__*/react_default.a.createElement(ButtonWidget["a" /* default */], {
        checked: on,
        color: color,
        label: on ? "on" : "off",
...
var serviceViews = (_serviceViews = {}, _serviceViews[constants["ee" /* SRV_ROLE_MANAGER */]] = {
  component: DashboardRoleManager
}, _serviceViews[constants["yd" /* SRV_BUZZER */]] = {
  component: DashboardBuzzer,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["Od" /* SRV_LED_PIXEL */]] = {
  component: DashboardLEDPixel,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["rd" /* SRV_ACCELEROMETER */]] = {
  component: DashboardAccelerometer,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["fe" /* SRV_ROTARY_ENCODER */]] = {
  component: DashboardRotaryEncoder,
  bundled: true
}, _serviceViews[constants["xd" /* SRV_BUTTON */]] = {
  component: DashboardButton,
  bundled: true
}, _serviceViews[constants["he" /* SRV_SERVO */]] = {
  component: DashboardServo,
  bundled: true
}, _serviceViews[constants["qe" /* SRV_SWITCH */]] = {
  component: DashboardSwitch,
  bundled: true
}, _serviceViews[constants["te" /* SRV_TRAFFIC_LIGHT */]] = {
  component: DashboardTrafficLight
}, _serviceViews[constants["zd" /* SRV_CHARACTER_SCREEN */]] = {
  component: DashboardCharacterScreen,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["Zd" /* SRV_RAIN_GAUGE */]] = {
  component: DashboardRainGauge
}, _serviceViews[constants["Nd" /* SRV_LED_MATRIX */]] = {
  component: DashboardLEDMatrix,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["td" /* SRV_ARCADE_GAMEPAD */]] = {
  component: DashboardArcadeGamepad,
  weight: function weight() {
    return 3;
  }
}, _serviceViews[constants["ze" /* SRV_WIND_DIRECTION */]] = {
  component: DashboardWindDirection
}, _serviceViews[constants["Rd" /* SRV_MATRIX_KEYPAD */]] = {
  component: DashboardMatrixKeypad
}, _serviceViews[constants["be" /* SRV_REFLECTED_LIGHT */]] = {
  component: DashboardReflectedLight
}, _serviceViews[constants["Wd" /* SRV_POWER */]] = {
  component: DashboardPower
}, _serviceViews[constants["pe" /* SRV_SPEECH_SYNTHESIS */]] = {
  component: DashboardSpeechSynthesis
}, _serviceViews[constants["ke" /* SRV_SOIL_MOISTURE */]] = {
  component: DashboardSoilMoisture
}, _serviceViews[constants["ae" /* SRV_REAL_TIME_CLOCK */]] = {
  component: DashboardRealTimeClock
}, _serviceViews[constants["Md" /* SRV_LED */]] = {
  component: DashboardLED
}, _serviceViews[constants["Ld" /* SRV_JOYSTICK */]] = {
  component: DashboardJoystick
}, _serviceViews[constants["je" /* SRV_SEVEN_SEGMENT_DISPLAY */]] = {
  component: DashboardSevenSegmentDisplay
}, _serviceViews[constants["Td" /* SRV_MOTION */]] = {
  component: DashboardMotion
}, _serviceViews[constants["xe" /* SRV_WATER_LEVEL */]] = {
  component: DashboardWaterLevel
}, _serviceViews[constants["Ad" /* SRV_COLOR */]] = {
  component: DashboardColor,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["ne" /* SRV_SOUND_PLAYER */]] = {
  component: DashboardSoundPlayer,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["sd" /* SRV_ANALOG_BUTTON */]] = {
  component: DashboardAnalogButton
}, _serviceViews[constants["me" /* SRV_SOUND_LEVEL */]] = {
  component: DashboardSoundLevel,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["de" /* SRV_RNG */]] = {
  component: DashboardRandomNumberGenerator
}, _serviceViews[constants["Bd" /* SRV_COMPASS */]] = {
  component: DashboardCompass
}, _serviceViews[constants["Hd" /* SRV_GYROSCOPE */]] = {
  component: DashboardGyroscope,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["oe" /* SRV_SOUND_SPECTRUM */]] = {
  component: DashboardSoundSpectrum,
  weight: function weight() {
    return 2;
  }
}, _serviceViews[constants["le" /* SRV_SOLENOID */]] = {
...
function DefaultWidget(props) {
  ...
  if (register.specification.identifier == constants["We" /* SystemReg */].Value) {
    var intensityRegister = register.service.register(constants["We" /* SystemReg */].Intensity);
  ...
  if (register.specification.identifier === constants["We" /* SystemReg */].Intensity) return /*#__PURE__*/react_default.a.createElement(IntensityWidget, {
