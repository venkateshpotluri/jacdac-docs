...
var EdgeImpulseClient = /*#__PURE__*/function (_JDClient) {
  ...
  function EdgeImpulseClient(apiKey, aggregator, inputRegisters, palette) {
    ...
    _this.connectionState = _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* DISCONNECT */ "db"];
  ...
  _proto.disconnect = function disconnect() {
    ...
    if (this._ws) {
      ...
      try {
        ...
        this.setConnectionState(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* DISCONNECT */ "db"]);
      }
    }
  };
  ...
  _proto.handleMessage = function handleMessage(msg) {
    ...
    if (data.hello !== undefined) {
      ...
      if (!hello.hello) {
        this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* ERROR */ "ib"], hello.err);
        this.disconnect();
      } else {
  ...
  _proto.handleReport = function handleReport(row) {
    ...
    if (this.samplingState == SAMPLING) {
      var ds = this.dataSet;
      ds.addRow(row);
      this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* REPORT_RECEIVE */ "Qc"]); // debounced progress update

      if (timestamp - this._sample.lastProgressTimestamp > 100) {
        this._sample.lastProgressTimestamp = timestamp;
        this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* PROGRESS */ "xc"], this.progress);
      }
      ...
      if (timestamp - this._sample.startTimestamp >= this._sample.length) {
        ...
        this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* PROGRESS */ "xc"], this.progress); // and upload...
  ...
  _proto.handleError = function handleError(ev) {
    this.emit(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* ERROR */ "ib"], ev);
    this.reconnect();
  };
...
function Acquisition(props) {
  ...
  var _useState6 = Object(react__WEBPACK_IMPORTED_MODULE_7__["useState"])(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* DISCONNECT */ "db"]),
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_7__["useEffect"])(function () {
    return client === null || client === void 0 ? void 0 : client.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* ERROR */ "ib"], function (e) {
      return setError(e);
    });
  }, [client]); // progress

  Object(react__WEBPACK_IMPORTED_MODULE_7__["useEffect"])(function () {
    return client === null || client === void 0 ? void 0 : client.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* PROGRESS */ "xc"], function (p) {
...
function EdgeImpulse() {
  ...
  var aggregators = Object(_jacdac_useChange__WEBPACK_IMPORTED_MODULE_23__[/* default */ "a"])(bus, function (bus) {
    return bus.services({
      serviceClass: _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* SRV_SENSOR_AGGREGATOR */ "ce"]
    });
  });
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_7___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("h1", null, "Edge Impulse"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("p", null, "Use Jacdac to inject data and download models into", " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(gatsby_theme_material_ui__WEBPACK_IMPORTED_MODULE_20__["Link"], {
    ...
    serviceClass: _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_29__[/* SRV_MODEL_RUNNER */ "Od"],
...
//# sourceMappingURL=component---src-pages-tools-edge-impulse-tsx-8e4766154c4a4451951b.js.map