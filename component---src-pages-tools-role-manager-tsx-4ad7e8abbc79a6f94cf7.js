...
var rolemanagerclient_RoleManagerClient = /*#__PURE__*/function (_JDServiceClient) {
  ...
  function RoleManagerClient(service) {
    ...
    var changeEvent = _this.service.event(constants["jd" /* RoleManagerEvent */].Change);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              _context3.next = 8;
              return this.service.sendPacketAsync(inp.openCommand(constants["id" /* RoleManagerCmd */].ListRequiredRoles), true);
      ...
      return regenerator_default.a.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return this.service.sendCmdAsync(constants["id" /* RoleManagerCmd */].ClearAllRoles);
...
function RoleManager(props) {
  ...
  var services = useServices({
    serviceClass: constants["ee" /* SRV_ROLE_MANAGER */]
  });
...
//# sourceMappingURL=component---src-pages-tools-role-manager-tsx-4ad7e8abbc79a6f94cf7.js.map