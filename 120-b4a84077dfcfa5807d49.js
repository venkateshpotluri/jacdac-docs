...
function DashboardSolenoid(props) {
  ...
  var pulledRegister = service.register(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* SolenoidReg */ "Qe"].Pulled);

  var _useRegisterUnpackedV = Object(_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_1__[/* useRegisterUnpackedValue */ "e"])(pulledRegister, props),
  ...
  var onToggle = function onToggle(ev) {
    ...
    host === null || host === void 0 ? void 0 : (_host$register = host.register(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_4__[/* SolenoidReg */ "Qe"].Pulled)) === null || _host$register === void 0 ? void 0 : _host$register.setValues([!pulled ? 1 : 0]);
...
//# sourceMappingURL=120-b4a84077dfcfa5807d49.js.map