...
function DeviceLostAlert(props) {
  ...
  var lost = Object(_jacdac_useEventRaised__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])([_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__[/* LOST */ "Ob"], _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__[/* FOUND */ "sb"]], device, function (dev) {
...
var modelrunner_ModelRunnerClient = /*#__PURE__*/function (_JDServiceClient) {
    ...
    var _isModelSupported = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee(model) {
      ...
      return regenerator_default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              reg = this.service.register(constants["hc" /* ModelRunnerReg */].Format);
              _context.next = 3;
              return reg.refresh();
  ...
  _proto.subscribeResults = function subscribeResults(handler) {
    var reg = this.service.register(constants["hc" /* ModelRunnerReg */].Outputs);
    return reg.subscribe(constants["Zc" /* REPORT_RECEIVE */], function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.service.sendCmdAwaitResponseAsync(packet["a" /* default */].jdpacked(constants["gc" /* ModelRunnerCmd */].SetModel, "u32", [model.length]), 3000);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return this.service.register(constants["hc" /* ModelRunnerReg */].AutoInvokeEvery).sendSetPackedAsync("u16", [everySamples]);
      ...
      return regenerator_default.a.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              info = {
                "modelSize": this.getReg(constants["hc" /* ModelRunnerReg */].ModelSize, function (r) {
                  return r.intValue;
                }),
                "arenaSize": this.getReg(constants["hc" /* ModelRunnerReg */].AllocatedArenaSize, function (r) {
                  return r.intValue;
                }),
                "inputShape": this.getReg(constants["hc" /* ModelRunnerReg */].InputShape, function (r) {
                  return Object(buffer["b" /* bufferToArray */])(r.data, buffer["a" /* NumberFormat */].UInt16LE);
                }),
                "outputShape": this.getReg(constants["hc" /* ModelRunnerReg */].OutputShape, function (r) {
                  return Object(buffer["b" /* bufferToArray */])(r.data, buffer["a" /* NumberFormat */].UInt16LE);
                }),
                "lastError": this.getReg(constants["hc" /* ModelRunnerReg */].LastError, function (r) {
...
function ModelContent(props) {
  ...
  var _useRegisterUnpackedV = Object(useRegisterValue["c" /* useRegisterUnpackedValue */])(service.register(constants["hc" /* ModelRunnerReg */].ModelSize)),
      modelSize = _useRegisterUnpackedV[0];

  var _useRegisterUnpackedV2 = Object(useRegisterValue["c" /* useRegisterUnpackedValue */])(service.register(constants["hc" /* ModelRunnerReg */].LastError)),
  ...
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, lastError && /*#__PURE__*/react_default.a.createElement(Alert["a" /* default */], {
    ...
    register: service.register(constants["hc" /* ModelRunnerReg */].AutoInvokeEvery)
  }), /*#__PURE__*/react_default.a.createElement(RegisterTrend["a" /* default */], {
    showName: true,
    register: service.register(constants["hc" /* ModelRunnerReg */].Outputs),
    mini: true
  }));
}
...
//# sourceMappingURL=component---src-pages-tools-model-uploader-tsx-81512fa8712bf5a75f8a.js.map