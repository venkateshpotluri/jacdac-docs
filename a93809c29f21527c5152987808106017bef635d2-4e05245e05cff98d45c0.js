...
function parseMakeCodeSnippet(source) {
  ...
  meta.dependencies = Object(utils["Z" /* unique */])(meta.dependencies);
  return {
    code: code,
    ghost: ghost,
    meta: meta
...
function MakeCodeSimulator(props) {
  ...
  Object(react["useEffect"])(function () {
    return bus.subscribe([constants["wc" /* PACKET_SEND */], constants["sc" /* PACKET_PROCESS */]], function (pkt) {
...
var TraceSnippet = /*#__PURE__*/Object(react["lazy"])(function () {
  return __webpack_require__.e(/* import() */ 80).then(__webpack_require__.bind(null, "0U36"));
});
...
//# sourceMappingURL=a93809c29f21527c5152987808106017bef635d2-4e05245e05cff98d45c0.js.map