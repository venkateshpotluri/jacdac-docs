...
function getMLModelFormatName(model) {
  var map = Object(spec["D" /* serviceSpecificationFromClassIdentifier */])(constants["Sd" /* SRV_MODEL_RUNNER */]).enums["ModelFormat"].members;
...
var modelrunner_ModelRunnerClient = /*#__PURE__*/function (_JDServiceClient) {
    ...
    var _isModelSupported = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee(model) {
      ...
      return regenerator_default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              reg = this.service.register(constants["cc" /* ModelRunnerReg */].Format);
              _context.next = 3;
              return reg.refresh();
  ...
  _proto.subscribeResults = function subscribeResults(handler) {
    var reg = this.service.register(constants["cc" /* ModelRunnerReg */].Outputs);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.service.sendCmdAwaitResponseAsync(packet["a" /* default */].jdpacked(constants["bc" /* ModelRunnerCmd */].SetModel, "u32", [model.length]), 3000);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return this.service.register(constants["cc" /* ModelRunnerReg */].AutoInvokeEvery).sendSetPackedAsync("u16", [everySamples]);
      ...
      return regenerator_default.a.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              info = {
                "modelSize": this.getReg(constants["cc" /* ModelRunnerReg */].ModelSize, function (r) {
                  return r.intValue;
                }),
                "arenaSize": this.getReg(constants["cc" /* ModelRunnerReg */].AllocatedArenaSize, function (r) {
                  return r.intValue;
                }),
                "inputShape": this.getReg(constants["cc" /* ModelRunnerReg */].InputShape, function (r) {
                  return Object(buffer["b" /* bufferToArray */])(r.data, buffer["a" /* NumberFormat */].UInt16LE);
                }),
                "outputShape": this.getReg(constants["cc" /* ModelRunnerReg */].OutputShape, function (r) {
                  return Object(buffer["b" /* bufferToArray */])(r.data, buffer["a" /* NumberFormat */].UInt16LE);
                }),
                "lastError": this.getReg(constants["cc" /* ModelRunnerReg */].LastError, function (r) {
...
function ModelContent(props) {
  var service = props.service;
  var modelSize = Object(useRegisterValue["c" /* useRegisterIntValue */])(service.register(constants["cc" /* ModelRunnerReg */].ModelSize));
  var lastError = Object(useRegisterValue["d" /* useRegisterStringValue */])(service.register(constants["cc" /* ModelRunnerReg */].LastError));
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, lastError && /*#__PURE__*/react_default.a.createElement(Alert["a" /* default */], {
    ...
    register: service.register(constants["cc" /* ModelRunnerReg */].AutoInvokeEvery)
  }), /*#__PURE__*/react_default.a.createElement(RegisterTrend["a" /* default */], {
    showName: true,
    register: service.register(constants["cc" /* ModelRunnerReg */].Outputs),
    mini: true
  }));
}
...
function ModelUploader() {
  ...
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement("h1", null, "Model uploader"), /*#__PURE__*/react_default.a.createElement("p", null, "Upload Machine Learning Models (like TensorFlow Lite) into your ", /*#__PURE__*/react_default.a.createElement(Link, {
    ...
    serviceClass: constants["Sd" /* SRV_MODEL_RUNNER */]
    ...
    actions: function actions(service) {
      ...
      return /*#__PURE__*/react_default.a.createElement(ModelActions, {
        ...
        sensorAggregatorService: service === null || service === void 0 ? void 0 : (_service$device$servi = service.device.services({
          serviceClass: constants["ge" /* SRV_SENSOR_AGGREGATOR */]
...
//# sourceMappingURL=component---src-pages-tools-model-uploader-tsx-8aa96d2ee5a9508327cd.js.map